...
#
# Time of this snapshot: 20170504-1330
#
...
git checkout 7fc0879c64aa731a90777de66c769560e750ff54
...
git checkout 32e78d8e12c8a8896fbf5d8ec1713f0aa1838288
...
git checkout 0d515a7065f7c0327d2ec45314d22da1f1fc8ea7
...
git checkout 3bcfe76b73c967e027b47ba73e3a79d152c2e467
...
git checkout 07999804c7bf5bc92841ef37a08a45e795eb8375
...
git checkout 4730417d9ab1a98fa46b3691961d0ff5b0c8ea0a
...
git checkout 0dc36735f2df081a6af9d1ddf5867390e48ccc45
...
git checkout ea7f5be7beae152b133d85bf223dece0f05d89f5
...
git checkout 6af13d095a77cbe9ad8feb6335f19d370734b359
...
git checkout c6893fbdbc06f67549fce86ab055e24983607465
...
git checkout 8221c48c15ca1512db60e1f498a7736ded7e90c1

cd $ANDROID_BUILD_TOP/device/xiaomi/kenzo/
git checkout 24ca749018670298c82b27e9d4c315f5025fb690

cd $ANDROID_BUILD_TOP/device/xiaomi/mido/
git checkout bbb06b927812d3965253073c88fbc2b930c75966

cd $ANDROID_BUILD_TOP/device/xiaomi/msm8956-common/
git checkout d10c67af90df2a863731cf6c6917224aa945a83d

cd $ANDROID_BUILD_TOP/device/xiaomi/msm8996-common/
git checkout 6b62c6b801fe5f80aea3018b71f7e43ac9fef659
...
git checkout bcfc7124f6ef9f1ec128fb2e90de774a5b33d199
...
git checkout 8c1433c32e2caaff08ebc1983881337a1b31cf07
...
git checkout 438b8f5f25522acb20adb304a6ac04359c65d8ad
...
git checkout d17952eb6c1303530d0f52d10875b33f19b8cf4a
...
git checkout 8920be7d43985aa35f92fcb77445b4ace901b011
...
git checkout 046afae75db1f7c91c15c9247fd9a6b04a5e4bd1
...
git checkout 300dd2d21ba2533771fd8016c1359bfab3a3fbbb
...
git checkout 79c2ab9bdbf285b32c72290794afe84bab74ad8d
...
git checkout d14a16b623b718e2bea613d5a7ca504f783e8e78
...
git checkout 91c230a33b82d954647ae4943cda78dac1ed86ba
...
git checkout 810cbea8b993f9f03d920bc968039cd1d61c561a

cd $ANDROID_BUILD_TOP/kernel/motorola/msm8952/
git checkout 5f3e6a3fb25e9274f3d6be1f271558e514eeaa4c
...
git checkout 8b10c304619f161dd4dd258a98deb9ea444f256b
...
git checkout 092d3347e7ba6c8a91cdb3be70e0d76b1b7478ed

cd $ANDROID_BUILD_TOP/kernel/xiaomi/msm8996/
git checkout cbd1dbbfebd460350e64a17219a2880ec4fa4072
...
git checkout e784183567b6ae83517e3beccf74bc3dafe43719
...
git checkout 5a2f1833eec8143b3ab2eb68e6723689fefbb172
...
git checkout b7d1a8b5382ba92bfed6c889602a963b7606d83a
...
git checkout 00080538e1de858152fcf75fe1df7b9fe1150ba6
...
git checkout d5707ff9beb99f366e81f7ab6ea46c309229d4dc
...
git checkout 10ca8aba8c83452a2c31457374c2451e671751e8
...
git checkout a2a33576deedb7f3240f279bc34b05669f652ce2

cd $ANDROID_BUILD_TOP/packages/apps/Gallery2/
git checkout ed6763f137043a3ff2547feb5e73627fd5cac676
...
git checkout 20067749ec3305028afd711369aa585e9a7e5bbd
...
git checkout dc570e9dd8fc1ab6723ad28781ccab27a63f438e
...
git checkout 9b9c5c92810fc08d4b9dc4b8a3753033828d2c5d
...
git checkout ae6aee6e4884ad1c31ccc285f85e74c30a804524

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout 1d0e136c0b781548bda4235d0e15b422876678ff
...
git checkout 40e3809cd9bdbaa52878cc6226d1b86574067a30
...
git checkout 55faa1d099f071a5989da85d138a5c6c0adef2d3
...
git checkout 85d4e422039f7506387631a65a3de394a19a872c
...
git checkout 7e1082f680fe8be18b1a838a8fa00dd38e07eb49
...
git checkout 722d7ddd8b0a0e681ff3b057bdfe21dae233a3fc
...
git checkout 5de40fe35de6495525a42132aa2aef44b340b802
...
git checkout 84b19358b028989263d6513cd625a3adf80314b7
...
git checkout 741e71073d7f806ec578720e74b8f7a1380b9857

cd $ANDROID_BUILD_TOP/vendor/motorola/
git checkout 9b1020784b91ae20eeeb9dc06e1ebb8cfb2965cf
...
git checkout fcc01f6ae98565d28228fbf435a45928a941fe17

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 0561e39bfc4c3b594dfb047ec1ac8df224c056dc

cd $ANDROID_BUILD_TOP/vendor/to/product/
git checkout 87aa8ccbf8de28f334ee2388b1b19324070ce354

cd $ANDROID_BUILD_TOP/vendor/xiaomi/
git checkout 7542fe3f45e3f7bdbe941b2a9626433b49f05d08
