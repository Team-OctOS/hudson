...
#
# Time of this snapshot: 20170518-0655
#
...
git checkout 80dc8bd51f31506f36d413cfc0497d902653957d
...
git checkout 1c18f266b8bf5a56ae1515f29b76097fc5af59a5
...
git checkout 68491c53876b54ad8e7646bc016f61f2883bae7b
...
git checkout 21a19dbba08ff87cb019c01a0127176dee05e81f
...
git checkout ff5220579642b69f98f2b92d28ed40451d7a546b
...
git checkout 55190d1c58356aa6473a088d4f83868f36688550
...
git checkout fc40c59ed71969efcdc5b2943d8a8301e7766382
...
git checkout dece504507e3aa3b7df52fe535db25bc5001c733
...
git checkout 833fb1002e3c67a8a7ed52eb11e329f29f7f2f70
...
git checkout 486d126f1445c4586f88060bbd34c658e0249fbe
...
git checkout caa0267c64dad5716b269caa2f66d68e55f41394
...
git checkout 4cc87dcc586270031e8360dd5bec525fd9577eaa
...
git checkout b544e4829196736b92ea0a015546abfe4282b4e1
...
git checkout 9b96d3f30b3fb067a88f9de9c94f1e5e1d1901a5
...
git checkout f3b3ca90819a374330552a1476aba6179066aad7
...
git checkout 332f57a2b0bfab4caec5017698987a39147a965a
...
git checkout fabe4f999a52f0776390f7463d72282a7b51c0d6

cd $ANDROID_BUILD_TOP/kernel/asus/msm8916/
git checkout abccd672634a5f1b4b495f92d443d9fae44e40a7
...
git checkout c35ffc1ed3b55d83121eba42692d57640b33e9af
...
git checkout c7266b41335c9d0f99ee4f8f67854b0b7f78e3ef

cd $ANDROID_BUILD_TOP/kernel/oneplus/msm8974/
git checkout 219f6fcfed505aa4bd5cb0d4e6bf781b19de1c86
...
git checkout e66c96bd7a1968a5e18067ecf2c3a8a78ca88235

cd $ANDROID_BUILD_TOP/kernel/samsung/msm8930-common/
git checkout f07d74c4bf97c7940a70f9164a873b3747d859be
...
git checkout d56e6d59750c12e2261e27b320b4b90b3c13fcf6
...
git checkout bbe002f63631e3c2fe5cae95fd69ab4385191544
...
git checkout 5a12d7045c55919e31bd7ee0250d8e0b93a04619
...
git checkout e696bf059f11a83e5a0b5690515fbd8808b1b4a4
...
git checkout a6f192fac8cde536cbb1c727466939fb187052d7
...
git checkout 3f87ce610667e222d3e1ed6de38e45b9df66b6df
...
git checkout eab04da14d0ffee5bdd82591959b5d9f0f3a1008
...
git checkout e567be8717a57134674775eed320efb57c6c49f6

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout 31499ecf2c9b9e7ded2848261206b9c6bbe4f5b2
...
git checkout c3e4e936fa101106a047693fd6d3616e835f7086
...
git checkout 0721b601b70a022e34c828eb2055e0de181f01a5
...
git checkout a7c1b4d5c54e49f72fbe6c23868ea72188e836c9
...
git checkout cb09714869f64e5fd791a2833d9d7934c5cdf589

cd $ANDROID_BUILD_TOP/vendor/nxp-nfc/opensource/frameworks/
git checkout 6933f27b0797f1d003a95475c05d703e3e7f917f

cd $ANDROID_BUILD_TOP/vendor/nxp-nfc/opensource/libnfc-nci/
git checkout e2d0d62288abbcb5b2875d1baa1b6cf5bf8e65f9
...
git checkout 7e1c50efc85a08ad155ff7c0fb591baf4c68ac0c
...
git checkout 6f0e018b9e5c5c969e4628ddff61f13a9e756e20
