...
#
# Time of this snapshot: 20170210-1640
#
...
git checkout 91b06f97680cfceabba61c1b7859de18d1709312

cd $ANDROID_BUILD_TOP/bootable/recovery/
git checkout 1ffe1c28e7fd7cfad8841fdbc21da79ff546d549

cd $ANDROID_BUILD_TOP/build/
git checkout 998673e819199c567838fea610ef4ab11d77943c
...
git checkout 4ad994d6d43829db1fd6bc96e59c4a4e33bc8edc

cd $ANDROID_BUILD_TOP/device/asus/msm8916-common/
git checkout b27823ac2ad0b73a4283c650f7934f7809ea96a9
...
git checkout 1c77004356015ca8e05f023c13b3a2dbb4871d97
...
git checkout 03c7d06ff7237ee60b7c7456b42b08cb3c0d2a0f

cd $ANDROID_BUILD_TOP/device/lge/bullhead/
git checkout 4d4177f90a7abd1fb20adee0a8f88ed5d3a08973
...
git checkout 67ab412e8f90f134c3e4ed9c13608ca5c9d600e8

cd $ANDROID_BUILD_TOP/device/motorola/athene/
git checkout d82ac35e00e7ff04929c209042822aeb76eadf89
...
git checkout 452b445d32c578e3bec07d7585475ead908469ea

cd $ANDROID_BUILD_TOP/device/qcom/common/
git checkout b136210349932bdd423fe9f1a43b3bae890cee51
...
git checkout 624e9cb91788e2f5c7bbe441d30721f3814c1a7e
...
git checkout 974bac7b56face910a2b6b77cc5288ec784e6add
...
git checkout df221ce72e9675c0dd0e0e9937711d438d83523a
...
git checkout 554db26903fa88a56c4b3f3ba41b90dff80a6c55
...
git checkout 1407a53e3c5b3fe4503376854549b9edddcebf4e
...
git checkout e690119930488c8cd363dfa764e8bff514724fba

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout b657408ae2cfd8050084001d69c8ba8f50fa5eaa
...
git checkout dbef7cce0b82ac8ddcd5ea54f40c6563a180db63
...
git checkout aae108c019dfb8a950ebbe9a09128fcb72443f53
...
git checkout f29cb1fd95ee6e5b371d2d6a85c1aeac708b19a6

cd $ANDROID_BUILD_TOP/hardware/libhardware_legacy/
git checkout 68203c876deddd1764fe9bc09cab4e80f2169fbe
...
git checkout 06fba05376c3364c8dc47e49abd8302a87c68ee7
...
git checkout 2b5386c22578553e12ff9791195575fd6362c78c
...
git checkout 38aa763fd9d8b97b27a2fd01e81829e75a78a0e4
...
git checkout bdb5534c3bba00f3b2a04a83fd2b965e748e5930

cd $ANDROID_BUILD_TOP/hardware/samsung/
git checkout 759368fbc09c9ebbed0678b5fbc8a6bd142312c1
...
git checkout 50b1c95a530cd334e11d5ab7e79f6fe2d994859d
...
git checkout 6b8cc9afd65f0457c0904841225ed32e77d24c17
...
git checkout 7124f9b1533c6df5178bbc7211b13af92f675aae
...
git checkout efd6a5bdb38990a85d022f6da269964c56a22402
...
git checkout 30d2aeb37e9ddc6a04271b9559da13b081b54b37
...
git checkout 0d12073b6ef2b361deb6b2faf0a830ae58c520cf

cd $ANDROID_BUILD_TOP/packages/apps/Browser/
git checkout 866b0bfb276f8db0591fcae5c1b480ae1d5e3313

cd $ANDROID_BUILD_TOP/packages/apps/CMBugReport/
git checkout 4fcd796a9d769ddef23789f6a69d1f094d0a7adb

cd $ANDROID_BUILD_TOP/packages/apps/CMFileManager/
git checkout 71b49b8dccfa68e625dc49dabca8aa952ef9823b

cd $ANDROID_BUILD_TOP/packages/apps/CMParts/
git checkout d41b41e6baef110d2b082a9d15a339dd75ebe5ff

cd $ANDROID_BUILD_TOP/packages/apps/Calendar/
git checkout 573612e897cfe55775334d9d26d8a552c58467f2
...
git checkout a187c4ab4551f03781719f900819fff3ea0d597f
...
git checkout 466c21fccf3ffd5bcef14ae04c0583c605e3f9fe

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout 40265a8fdad7526b00fd3e30ce4bf99fcee75dd2
...
git checkout 29c1d2d63f3ca3d0531ae7583c442255d71cf617

cd $ANDROID_BUILD_TOP/packages/apps/Dialer/
git checkout e9b2a206611607a20686750a18b72e82cf770e72

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout ee30de99653f44e19c67d9437effd04761c3a912

cd $ANDROID_BUILD_TOP/packages/apps/Email/
git checkout 20cdcda5a3227b7999c2d8c4e05642365df221db
...
git checkout 2ace2cd8f787a0fe5f274c2f13eff4870fa7920c

cd $ANDROID_BUILD_TOP/packages/apps/Gallery2/
git checkout 747c1484ceb2b90d4306ec4e6727b09f6507b7cb
...
git checkout 2ccf116085353cdecf9446271230789f003f4efa

cd $ANDROID_BUILD_TOP/packages/apps/ManagedProvisioning/
git checkout bb7951740bcd76379eadc2caf605ea110fef5631

cd $ANDROID_BUILD_TOP/packages/apps/Messaging/
git checkout a86b0136b0bfdf729aa3516413b3bcd3cf004b2c
...
git checkout 878926af52de644a06c555eda9e06a56c0678066
...
git checkout 11eeb5d96e640abc6415d9e12b583b991b325d6d

cd $ANDROID_BUILD_TOP/packages/apps/PhoneCommon/
git checkout a4413e1f14799e170d432d25455e60ab388f1f76

cd $ANDROID_BUILD_TOP/packages/apps/Profiles/
git checkout e900fa789315ec76fe0c06cfc06995198e888759
...
git checkout ef8d286ebdcbc90c7d3149ad0539ce6e2194846d
...
git checkout e0f1ded5718f2ca1e05615c625620fa207ccddde

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout 678971d123ba3255e47f6f5a7911fef6d69e3821
...
git checkout eeb6d425cf81d0736e8f7e0e1ffc4525f3c7cb03

cd $ANDROID_BUILD_TOP/packages/apps/Terminal/
git checkout 068eaa3657a05f79842694d863120983c8807de8
...
git checkout 36c1213e93355413185ff582d557f1350f4feff3

cd $ANDROID_BUILD_TOP/packages/apps/TvSettings/
git checkout b9b921583e4573052c2b62fba749c4f8a4978f39

cd $ANDROID_BUILD_TOP/packages/apps/UnifiedEmail/
git checkout 0bdbeb6eff74050464d1ad5d15b107d741ba635d

cd $ANDROID_BUILD_TOP/packages/apps/WallpaperPicker/
git checkout d1bc43f59491cf61d90c27726faef8e6b1873e8b
...
git checkout 5e0843a5832e666596fc6803db31bfc3f6971245
...
git checkout 10bd92c7f21be835a091f21f3b4a230468c57560

cd $ANDROID_BUILD_TOP/packages/providers/DataUsageProvider/
git checkout 698166683cd74469d69fa5a627220122a0c9f2a8

cd $ANDROID_BUILD_TOP/packages/providers/DownloadProvider/
git checkout 4da45439d200114206b06453da59345458188ae7

cd $ANDROID_BUILD_TOP/packages/providers/MediaProvider/
git checkout a64c9b8fec26be72098863212c85b2e1a2273e66
...
git checkout 9484d1581074d142e781388c37b24df059538c0d

cd $ANDROID_BUILD_TOP/packages/providers/ThemesProvider/
git checkout 841405e52f0bb8ffd8a171fd84fdf194f295e819
...
git checkout 67824b6b059ba18198ce38ce1644a5b792ec5ec9

cd $ANDROID_BUILD_TOP/packages/resources/devicesettings/
git checkout 6bbc51e836bf1b44ff03f6cee0cebc8e0664c098
...
git checkout 6dad83dea2a0f7175bc5aaa964113d32fe702eff
...
git checkout e767bd9c1f6193951e3c58a3aad0e01a9359143c
...
git checkout 1369ae34dd0c7224923923ccb636af1073f7525e

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout 12ceaef19f6ee2b02881c5eee50f48fd225717c6

cd $ANDROID_BUILD_TOP/packages/services/ThemeManagerService/
git checkout d345819e586a20d63e95e2677e255539ea0e8f34

cd $ANDROID_BUILD_TOP/packages/services/WeatherService/
git checkout d3f16b2e8c61a88d1b107739d35d2e5fd38846d2
...
git checkout 5acf0e7789fed2945b35f6eab33588c2d58dbd5a
...
git checkout eed8b166ef55c21b187ee5438d938886d2e9a760
...
git checkout 4a427dfce617e1c3cc8b85b7196be24b495d9f4e
...
git checkout 57fc1b8289fbb2359f45ce4d156a74a4dc531709
...
git checkout 38e79bccd6091ea0b929183cc9d9167f41eb4a2c
...
git checkout 55478ee396a6dc2389d68cdb09297d3693a141de
...
git checkout 785cc958d35c21a1b4e3b91c5c1e941e2f8f354f
...
git checkout a6fc23316174b50de9ebb50f41b38188410f3157

cd $ANDROID_BUILD_TOP/vendor/cmsdk/samples/weatherproviderservice/YahooWeatherProvider/
git checkout 655b92ae7c5afd70362ebd9588a4678a14f149e9
...
git checkout af4ef43cbb625e7f6ac2d44139c705a579bcc99b

cd $ANDROID_BUILD_TOP/vendor/huawei/
git checkout e4bbaf3fdd0b966130d0fb8ff9f7b30f4bb2df19
...
git checkout 7e205808955f22c62ea31a9a9c9880da763e4112
...
git checkout a78a12099a259bd5c2cbc29b9072b9a1ec0a7dfc
...
git checkout c9eb12d7d04d790154116fa817f40986f29ff8a5

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 2cd4f825afc7ea59e71060ec96ec8aa3cb067006

cd $ANDROID_BUILD_TOP/vendor/to/product/
git checkout e07386696e0d7f9af109f2f62103843ffa52c812
