...
#
# Time of this snapshot: 20160610-1925
#
...
git checkout 94fbe1ebdd7045eb8ced7c061384fb3785aa4cb2
...
git checkout c617c9f5879883ff4f47ced9129763e89668c37a
...
git checkout 4bd58bc1525001354777340ddafc906a71e82d0b
...
git checkout d05dd99e2ebd333531181c5c0c6f448e005e30bc
...
git checkout be16c316b365b8b1ab8856c9b7a559156a4a106a

cd $ANDROID_BUILD_TOP/device/moto/shamu/
git checkout 14eb847275dc9369673cbc0e0cbbf7e845fdd6eb
...
git checkout 8a8698a307cc7b3ca4541dae48c8f49a52e6e012

cd $ANDROID_BUILD_TOP/device/qcom/common/
git checkout 97aa119e8575c7774506564bac8ea1350f1141e8

cd $ANDROID_BUILD_TOP/device/qcom/sepolicy/
git checkout 236f12d99df65838d85861da1d845b66a0723047
...
git checkout 5eea57f14e790b391406aad48ceaab8fe3ab0ed9

cd $ANDROID_BUILD_TOP/device/samsung/qcom-common/
git checkout 2ceefc282f2477112c00a9816cb6ed8570374948

cd $ANDROID_BUILD_TOP/device/samsung/serrano-common/
git checkout 1b854cd5e0da51cfb770206a8162ce19a0af6f4a
...
git checkout 0d39368afba7346983f8d6c046b62c41c45fd6be

cd $ANDROID_BUILD_TOP/device/xiaomi/cancro/
git checkout 33767814249ae233bae16153e23bc30f33ae80d5
...
git checkout 9db7a9ca88860d08c135997891a43af8a37a7d10
...
git checkout ebe26733ecb29374e606ef67c9d0f2ec6e044318
...
git checkout 508eb7749a4ce988d4d1a97377254add24b9bc40
...
git checkout 6cf20496b3e12bb66525cebc0c7c2106cf890d1c
...
git checkout 07f11ee826098b2a33b31a33e26de0c707f0ecea
...
git checkout d92e6d93098f36ef2a24eee69af884bde378b4d3
...
git checkout 9b1b6d4fd79e4bb6c0575bc0dea716ea33f8c593
...
git checkout 1e61c117f7461c4bd3d7015d9e8959ee34b60c9e

cd $ANDROID_BUILD_TOP/kernel/samsung/smdk4412/
git checkout d37f93f0308351614ce5bf06a2eb9fd655f96c5a

cd $ANDROID_BUILD_TOP/kernel/xiaomi/armani/
git checkout fa35f26c15c73b913aab3408c1b3f6d9cd24a20e

cd $ANDROID_BUILD_TOP/kernel/xiaomi/cancro/
git checkout 3b8a3efd5cef5ef99582ec841462ec77aa89e43a
...
git checkout 544e51e75123c03a09b1d1a7cab9822eed977fd2
...
git checkout ef133b18578fd82dfd7abfb961acb783dfae2854

cd $ANDROID_BUILD_TOP/packages/apps/BluetoothExt/
git checkout 559f7830a612b8e6151250ba3281001c972b2aae
...
git checkout 0b8b02b5fe76263ae46f5ea71eca874f60d4c0e9
...
git checkout 53072882b050b0e2ecec5bd1de7caa5d6b365ae6

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout 939ed41657ab1d8463269a917bbc73d968765a8b
...
git checkout 49ee0372aa2018ff5ccf93b1595e589bd21553f7
...
git checkout e6b621910ee9453ce34e0bba4dcb839029a14023
...
git checkout 2c9893f05182bbc383964b64ad53b9836c9593ba
...
git checkout 325513bf3e5e24d6ef330547ec3cfda63b9a117b
...
git checkout 52034558a85e739058d350e820d4172180d37d5e
...
git checkout 8e21a141a5bcd4a058c6ec0ede38c92866a698ba

cd $ANDROID_BUILD_TOP/packages/apps/Profiles/
git checkout ea4e0f404b36afa8c37829dac0a8aea5b5a1a963
...
git checkout 3de1b3fb7dfb9f3d2371990a424c41194483afb8

cd $ANDROID_BUILD_TOP/packages/apps/Settings/
git checkout 6a5a8ed11277dd4cb7d635aa18d313fcf158d247

cd $ANDROID_BUILD_TOP/packages/apps/SetupWizard/
git checkout 73d56b4d76a5eacbb4205e3a1918176474fef1f9
...
git checkout 0213471ce0f735091a0f7a0376f6b6465c4815be

cd $ANDROID_BUILD_TOP/packages/apps/SoundRecorder/
git checkout 700fcdb7401e25bb442d4333c37b913b5f149eff
...
git checkout b95194df5bbf0558e00773e5d2682fa5d8815c22
...
git checkout ad02907435dc947bedd89f4ad4aed95d52730bd6
...
git checkout 32c8322a8479a614bd511f063014a182681069e0

cd $ANDROID_BUILD_TOP/packages/providers/ThemesProvider/
git checkout dafec22595920e1e20bac329096dc098dd5ae364
...
git checkout 09b9135d1f4cd58cb747cf1b42d9926a2955cd0f
...
git checkout c76119708155474eb2bd846a32d4c3b0eae842cf

cd $ANDROID_BUILD_TOP/packages/services/Telecomm/
git checkout fa02b4c8a37789b985883e0752864c6010fdeead

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout 0eacc88b294151108dca962148893cadc21b8697
...
git checkout 600e1a9d2a620de62476dfec140385d9233a1f7f
...
git checkout 9affd2b3bb63b630f01311a5aa17c0b5c0b36ed2
...
git checkout 3d757fc67b1dd916e8968cf9d4b08b04c7dfdaec
...
git checkout f721873f25629818d07ac041169911d108050874
...
git checkout 7bd8569fce18fc716f49b6758e8d9ebc7669435f
...
git checkout f73e2f0ed195cfb4fd1008f62ca559a5386dc5a4
...
git checkout 3918853dac8917f2f484c3e0950ffb9e0d9cfb6c

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 332100d499eddc5ebd718b7c51bcd88f8f1def71
...
git checkout 5e1e37a551dc6ff958f4bd5513c1920567af6e69
