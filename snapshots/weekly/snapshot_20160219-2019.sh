...
#
# Time of this snapshot: 20160219-2019
#
...
git checkout 49879342bc3ba7b7db7721678334c9aaf14dccbf

cd $ANDROID_BUILD_TOP/build/
git checkout e1bffa4f5523d0fc97665b282f1f57c63ec86b06
...
git checkout e8fc583d09edfb66937d55d22a699a9d66f151b3
...
git checkout c0ff691404213190207b21cc89108d624ce2e0fd
...
git checkout 01c8bfb0c4ab279ae836fe064bc37c84f333e42c
...
git checkout 6b02cdb74edafa1aa007d998417e0553e94dc0f6
...
git checkout 55efea60f9c6a8014d40855d1a4ab8bf56b13abb

cd $ANDROID_BUILD_TOP/packages/apps/BluetoothExt/
git checkout 86f64b79435c6226a47d7dbf1b2ba29669992bff
...
git checkout fe020bca108212b77e0c0b5a0dfbf04a5f18ea99
...
git checkout 577ec42bed8baaa38849cd3a2e161df96cbd5ec4

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout 847234f22b8a532b7207d10291b71c271c766f8e
...
git checkout a35c7cc01674aae358c7e08eb5aadb656aead9c2

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout 7038b16a49aa1b8c352dfa8f26820dab5c090bff
...
git checkout 166b1126b7f0a5e29b4291b3e1fd89d116ad31ce
...
git checkout 00577e626c48c77b6cd861c2317db504690e9ec8
...
git checkout c8e58bed86307687e1a37ee36dae32bc6e9c23c0
...
git checkout 8465b83ed5ad53e26523e91cdf32333816d7343a

cd $ANDROID_BUILD_TOP/packages/apps/Settings/
git checkout 1b8d529b95c07d378379408855435eb86511643a

cd $ANDROID_BUILD_TOP/packages/apps/SetupWizard/
git checkout 56bf4365cfefe5e7f476a4063a233f85a4c7fbfe
...
git checkout 28c3ed1b3e7770358359fba023848caa4200884b

cd $ANDROID_BUILD_TOP/packages/apps/SoundRecorder/
git checkout ebf074825de5a2bfcef3bcbf626c92b9f0020d1c
...
git checkout 1156039e85bf8a043773009bf93f6a7a7542dad3
...
git checkout 879b11891b0202687fb4e76ec0880906728dcd92
...
git checkout 22c32ad4f7f2d4d138e4197b7d581df10133d9e8

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout c32407918bf2e01a69e5c0b59aa2996a3cf7b38b
...
git checkout 4248ea7cd88e768333dd8a0ccd159957111bab29
...
git checkout 1bb1faa9611976365fdf716d3e368a12b020ab98
...
git checkout bda61ff34ca4cb7dea89b46ccdec900e01b36b09

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout aed1dc5a5a3ad40252067b09d1759a119538b2f0
