...
#
# Time of this snapshot: 20160325-2053
#
...
git checkout 722937bf77fb2a830132f566ff85de56a0d8bc63
...
git checkout 051ee81a7aca09803a13b6d4058e48f76e4f1cdc

cd $ANDROID_BUILD_TOP/device/lge/bullhead/
git checkout eaddddf11c35061d172cec4ca9cd1ea4761268cd
...
git checkout c0bdce1e662ae5969344f3e6c87e498a23b2df4c
...
git checkout 02d5349671b631166c7ebe3b174076ebf583d55b

cd $ANDROID_BUILD_TOP/device/qcom/common/
git checkout 30d3220cf1aa0cee444a25a694622f706526d185
...
git checkout 89b32ece33bb476ed15b90505c881ae5ccbe089d
...
git checkout 538b627a054c027a4c9b10db52373f80ab37eef9
...
git checkout 7a4eac6ba3d7ddbb1dbe2467a48453ea9b549cfe

cd $ANDROID_BUILD_TOP/device/xiaomi/cancro/
git checkout bd8943ca21f0d583532b41e23f31a2b42ef50a40
...
git checkout 0dbf44c94a9f74089c5960648f503f9865a546ba
...
git checkout 9ac291bad6edb745d68aab9baf0465c3323d8e4e
...
git checkout b1bfaea3600734f2afda3be581fe3ab721292522
...
git checkout cc48856905ab4d9e6407b13a2016c6413005e018
...
git checkout f77ba6bbe3348dc60fee56e234d32f03e4b2efad
...
git checkout 98f10c05c251648e1aac6638b8509c7ca031b543
...
git checkout 9c476e7a971f284cdd66e41fb8edfb5baffa509a
...
git checkout 0fc0548f98b6a525087caae453835a9ace22f447
...
git checkout 95e3fd2fe077286f9c8a279cc4e63289e37519e9
...
git checkout 4967330ae58d81082bf87076586fe59bec4f9e5d
...
git checkout 3f68bb7908dcb8eebe1db5e493de481619063716

cd $ANDROID_BUILD_TOP/packages/apps/BluetoothExt/
git checkout 6a14c96b71d76c021f63b46e6730ecb06ef1e4c7
...
git checkout 49c80e719b28c23fe18983e127787b4c40d52c5a
...
git checkout 9791b6374855156403090c2b59c2268febe1c4b0

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout 765b78272064dddae09290e07f3fd0ec9a1cbdb1
...
git checkout 4271c5b86ae9d794a8bffc74c3a3a23120f8526c

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout 14ad1d769fd111eab09e0695d02ded3174128fa4
...
git checkout 96194b6e8377c65d658b0ef689d2828cc6bc793a
...
git checkout 66e21a224e81ef7df438ecf096716086a03ce3c7
...
git checkout 252ac72f1007c7742392eb34c6e2278321674898
...
git checkout e4eb6ed1ced1fd5c86042ba362949ca083500b0a

cd $ANDROID_BUILD_TOP/packages/apps/Profiles/
git checkout dda77c66ef26546d05d5f6fecc3ad0389dfc5d35
...
git checkout 968b4dc88e5ee9129dbb901462921b626b5582e8

cd $ANDROID_BUILD_TOP/packages/apps/Screencast/
git checkout d5b17502bb6366cab4a5abb99b7a8fe075eaa126

cd $ANDROID_BUILD_TOP/packages/apps/Settings/
git checkout c0f8e06bf8ac2a5f361c07bc53a1efbc6b14fcf8

cd $ANDROID_BUILD_TOP/packages/apps/SetupWizard/
git checkout 0410f846bb351fee1b322809154858472f05df52
...
git checkout 5dcd941c45206bf6f226db95cef515be31478855

cd $ANDROID_BUILD_TOP/packages/apps/SoundRecorder/
git checkout c41ee5c2586ccdaf416ca860b13a2481d985c52d
...
git checkout 86ba1a74cf1cd12931b36c6321e4ee605c2ef829
...
git checkout 945d181450b44016ef1f3b7fd0787b751bc7cdb7
...
git checkout d2e61d4500a2eb08445abac249909b15897a09b3
...
git checkout baef728b73f2b7cb518a70f66a294a8be3d638c7

cd $ANDROID_BUILD_TOP/packages/providers/ContactsProvider/
git checkout e5d4dc75cb479c070d9381ac5d0fabf62cf2c8ea

cd $ANDROID_BUILD_TOP/packages/providers/DownloadProvider/
git checkout 150e9a28647632a59daff9d93a5b06a628b04a22
...
git checkout 9fa9b69ea65efcc415cef935e387120e098d1919
...
git checkout f2fadbdd816a7f705c7599fbf3fe1c5ef1913972
...
git checkout f26269a3b5259275c513bb8549066a353a083144

cd $ANDROID_BUILD_TOP/packages/services/Telecomm/
git checkout 02b1cb2f81ba6b1e2a73817222251d577eb4f57c

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout 9e61b99584511ea94e0bb6c022f28d1c5917c9ad
...
git checkout 38b2af7226409140f564ff0f83794603554b6a46
...
git checkout 26bc3e918e79909fed67ddca66045b9faf888c84
...
git checkout 115cca34064fc38e59ed052bd464d6a7eb4aa107
...
git checkout cdc485110ec906dc18f405335eab84009405582e
...
git checkout 9ef467b303f54ef38efd177b764a2deef98b93a5
...
git checkout 50f9e7fac9187a95427d3c3b3e4804147ed5c376
...
git checkout 75e446c080589fce38c47d244284f2f809019631
