...
#
# Time of this snapshot: 20170119-2136
#
...
git checkout 5bafc142da040dd4f92938f4ea3721154f62e392
...
git checkout 83a2c6553bf925a2caa9b6f81fb7d7f672955b58
...
git checkout 5141967860f3aad53475ddbaed745e7b38e4d3f7
...
git checkout eca3ccc2970a44bb8f4e017b8900f3b079ff1027

cd $ANDROID_BUILD_TOP/device/samsung/msm8960-common/
git checkout e69775ca8c915e6484502af3bca186523936266a

cd $ANDROID_BUILD_TOP/device/samsung/qcom-common/
git checkout 3b6019e82735e0a65242f2ef1e5847a7f7cbfeb1

cd $ANDROID_BUILD_TOP/device/samsung/serrano-common/
git checkout d3119ff5b3e424f66053e9e1e80379615351abe3
...
git checkout c75929acbbaa22d557ee17d337b327076205cd65
...
git checkout 5740894d251c12a2ddfb04c4a1dee640641e021c
...
git checkout 7b2cdc31b91e68ab9c73f97e8105c68e3d130272
...
git checkout 0e14f27f72948c610a37ed7c499ac442d76b4986
...
git checkout 86620b3929c44c5e1f457f17f64448ab246e00f5

cd $ANDROID_BUILD_TOP/kernel/asus/msm8916/
git checkout aa2af9fb2debec4ab278ed826c62c39102409bae

cd $ANDROID_BUILD_TOP/kernel/lge/g3/
git checkout 73670b66feb181565e637b9b198a6cc66f8569f3

cd $ANDROID_BUILD_TOP/kernel/motorola/msm8952/
git checkout a87f52c84c77706dc1451f98e1a683a739d395c8
...
git checkout 0650a729b3e41572925ccdfbb00ebf64f173740a
...
git checkout bc784074312f7e5a74d869d07c6fba53fc2b711c
...
git checkout 3b82d92c2467059f4a16eb0a2f26f7a457cc3069
...
git checkout b38afd47ee1f8bf70a6f2541f753811c6b61d489

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout 32825fcb82af7a0eff35be365b82da675b49c340
...
git checkout 844a256be7a30dbbf916326c832a486c892535fc
...
git checkout 73a2c76025b4e53e17fc75e225029b3b66dfb9e5
...
git checkout 6a2e6b5935f9128e9a7f00909089716fd7c160e0
...
git checkout ace6f2ec0d62fbaf85b2da8d4404c5600704137a

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 7f1bce06255be85d437608565cc8dd0f9789e263

cd $ANDROID_BUILD_TOP/vendor/to/product/
git checkout c800a6258f89f44966c84b6c25848ae5982216ce
