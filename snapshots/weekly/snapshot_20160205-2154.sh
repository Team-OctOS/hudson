...
#
# Time of this snapshot: 20160205-2154
#
...
git checkout cea50b7a2c400918f59d3cfaf9c380741383e07c

cd $ANDROID_BUILD_TOP/build/
git checkout c0a0cb48f77e1ec1a90c847809827d6230c0c568
...
git checkout 2afbc98ba63d7cdbd1f99df7bd53ec0cb70236ca
...
git checkout b90823e298988ff365cdf8e6d7c17687c3897d55
...
git checkout d741c69726ad9f00eaa0835b882b04eb52f9a2a4
...
git checkout 725b36ca1e7b89b013b65ef5414ebc6fa5fd6541
...
git checkout 22da313eb2b85f8c10d871e1a0322c3acfbd6136
...
git checkout 12fcb85790399e225674332148e257d76e3aec69
...
git checkout 68bba568948277aae609b05a5d853577a6abd7db
...
git checkout 19122281530e49072a274eaad67cce18377e5ce5
...
git checkout ef961d64b0592dbb0ca5dd674023a94216450767
...
git checkout 8f517b2c28cb29620fb32f1f8904b24528dde18d
...
git checkout 0b8ca16a21f0656d9a10a9e413b601780f439469
...
git checkout be097bf8a6e7c1d844469eb4d73aefcced27136a
...
git checkout 4ffc37c05c1c3318f5292079e25a29f26ebda8db

cd $ANDROID_BUILD_TOP/packages/apps/Settings/
git checkout 739b7e7c2b46522968a8d5ac135a9bd95c9b527e

cd $ANDROID_BUILD_TOP/packages/apps/SetupWizard/
git checkout d6b937a5676f6c1319f057d11bc7758c6c49aa2b
...
git checkout 6a64b859a4085c1fa50ee273497ba9f92feffd98
...
git checkout 9c5000555984ee211bd33cdc15ae9f4087658958
...
git checkout fbfb65e78e39fea579865b4cf3a5d6b1d0908338
...
git checkout 0d7937ab76d5880425b7c756dc4cbb441198a0a1
...
git checkout 8c6c2cf8741e7bbcbc298f293e225f290b48f9f5

cd $ANDROID_BUILD_TOP/vendor/motorola/
git checkout 7ffd553569780c02a8807059c9c588c4981661de
...
git checkout 350a08b49f39a131f76f7f7ebab6ec2258da42ca

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout d1f0ff75ea6871930a0d6d55e58377cfd0f863ac
