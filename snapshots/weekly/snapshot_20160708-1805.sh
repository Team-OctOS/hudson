...
#
# Time of this snapshot: 20160708-1805
#
...
git checkout 008eacaf5ca502fc886cae2c9e38f115eb1c7c54
...
git checkout 2a224a236405e2c9d4bdc4316f873aa794cf7ad0
...
git checkout c11299706c9b9813923e4cbc07f304933bde2f62
...
git checkout 94c7d1919a40e1e3ea0f0202f9633b4e97f2acb2
...
git checkout 03471a035a654d51eae813e31d3bcc634b74c578
...
git checkout 67adf4494e4a330d235ea6a872f7f45e3e04e5e7
...
git checkout 1e7c9d2c408b17fa14f897cfe8d1ae06fe944637

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout c69f93543e979a818648c544f54eb150e4150de4
...
git checkout 9c523d2be083d9b8588d8abaccd3b351574642f5
...
git checkout 43f190bddf374bd77da0524f82e5b6a4f9a41255
...
git checkout 202e9e07542df658b119b4242c127a23570938d3
...
git checkout b76e79447c5f25e7fa6f1d070ef9f10d17a91a49
...
git checkout a586a527284048c57a724630866eac6aa61b75c0
...
git checkout dfa4d5fbfc000660d108d6fc4590781166d725c1
...
git checkout 13cad1727e28e3da6795865d859e33b00cf15626
...
git checkout 7cb3472a4c7f31a3cbf70bbca8f79e2d3cabedad
...
git checkout 60f300d726b2274a3a1575d5333c9c400d995af6
...
git checkout aca0818e0e308e44af7be3997127e222916a99a7

cd $ANDROID_BUILD_TOP/packages/apps/SoundRecorder/
git checkout 77399f4212bfbb6e3d902f378acc6a8aaa9e17f5
...
git checkout a154eed09d48c339c4c38854ddde8886ea995246

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout 8d6bff0e3c9f66ee5527374d1a846a8ba1c6c9e7
...
git checkout 5d90c85e977df6dd34443b6050db5c994570f410

cd $ANDROID_BUILD_TOP/system/extras/
git checkout 5c269b848564c7e86ba4651f6dca7dd2922921a7
...
git checkout 9f19c79875a3ad548a97a7a0600690504b8b721e
...
git checkout e2a1ff1967be7ec8ec1fb2807c51fec23b1c8490
...
git checkout bad29cbf3092e17fea8aa412945120f6799d8d91

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 35090e7e1f80dc2b0487e0b8b25958969eb96500
