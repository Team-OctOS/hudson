...
#
# Time of this snapshot: 20170802-1631
#
...
git checkout c17fd67021d3d4487f62026208af160ac6403700
...
git checkout 378f1b274bab613e43a3a96b336cfc9a1ac0e22b
...
git checkout 6624f57d53d7beef4b78e5db5a6d93e74501970a

cd $ANDROID_BUILD_TOP/device/lenovo/a6000/
git checkout 391e30c35e2970a74b19249a2e0fdd9ced75272d
...
git checkout 88ddddc0ec12c489b6af750d8df21ef34abe23cf
...
git checkout 43c411aed2d4f940daec3f7c9f1d1b68b5fc42d0
...
git checkout 7e027bc4fb34cc34ca67fab32e1cd8853c2ec1a5
...
git checkout fb5669e851ba8e534fcf59ae36cd6228edaed35b
...
git checkout 041069bf7b89f26d452ab7361aba43d0ef49f30a
...
git checkout d49f87dfdd6c2718708d5f9bcacc110461b6a717
...
git checkout aac0d52fab2bbaec7e6141e44b498a666f190dc5
...
git checkout d3ee68b03f8e6c9ede8bbb7cf4120b5b6bbbdda5
...
git checkout 1b4e110748cb0fd1ca4949008ae47bddea42d80f
...
git checkout a6559034728d39323d6f4b5e5269c16af06a07a0

cd $ANDROID_BUILD_TOP/packages/apps/Calendar/
git checkout c7912b55f9a219d8413a2b12e5173c2c9a826995

cd $ANDROID_BUILD_TOP/packages/apps/Camera2/
git checkout c8ce5eff0b172a8189d9ca02a52367bfb3adaf32
...
git checkout 19f777a4e744c1df96e6c62cb345fb3c19fd87e4
...
git checkout 9bb422a3d57409c7ca5bacab1529366fcf4e863c
...
git checkout ffd4233e85c43827bf5ddf3ac61a158db42bfcc3

cd $ANDROID_BUILD_TOP/packages/apps/Dialer/
git checkout 38f500abd27334b4855dbc438defc26abae7a394

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout 1cc8b9e402769a0894220d8872c57fe749012b19

cd $ANDROID_BUILD_TOP/packages/apps/Email/
git checkout 7bf040aadfb0dfb2287ee8ece58d46aacf148a8f
...
git checkout 3b11d2a588591277ba66b75d338efd3a20a86a4b
...
git checkout 083e5038f88ba721ae85702def6efd83fbb1cc12
...
git checkout 7a0cdc8ed6a902661ecaecc967e4501649978cf0
...
git checkout 268befa35ac72344c89d454935e8a5cb48d08af9
...
git checkout 759f978e1356da48861f713086e5aa1b7d29cd3f

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout a206d756543b2c1ea9544966c33edb09bad0c65a
...
git checkout 48bf259290e204b6f358144154e63f8363661b14
...
git checkout 1550893adf7fb99a776a1227a4aafb9af802e6be
...
git checkout b7247d87d2a4640184b8c75a818b3a1b08fd7e71
...
git checkout 6b3c52083d780dd6203bce50e0c93b5428f84bfc
...
git checkout b30e393e03d2cf58b05257d4bdae5c6f910fa20d
...
git checkout c81058fa9d3ea1324eae026fd5fbb52668d0cc22

cd $ANDROID_BUILD_TOP/vendor/lge/
git checkout 0558e885a5973c6299bfe82b8773b7fd3b85fa28
...
git checkout 77bad5446c4201a0ba9a0779215412dd08942ea3
...
git checkout 4c388203fa5485df5cc3db342dba80b06eb41c53

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 100bce2a99f41766614889fcafe499874350bb4b
