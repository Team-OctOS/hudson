...
#
# Time of this snapshot: 20160506-1821
#
...
git checkout f3b721bbc8e0d54c27d7efdcb85349f2285ae22e

cd $ANDROID_BUILD_TOP/cts/
git checkout b359c22ee41c366d1284a83caba0ef044d124ff9
...
git checkout c205a7fdce5954f1e41662612e9f672d5fef10dd
...
git checkout 90de73fb39a0c5f366bcc4a283f4f3c81f2958ad
...
git checkout 26c78e1c49a3b82fff15d5abcb607e4880728b1f

cd $ANDROID_BUILD_TOP/device/qcom/common/
git checkout 2d717c85a8bdbae8cfdeee31cdaf044b9c228dfd
...
git checkout 4a0827fba6ff33c91459b84dcc38f5e41d5f3340
...
git checkout 6332cecf588e5e6e10f6cc602bcaf1ea4c8c4f1c
...
git checkout ee3031055a7c8082bcd4fe7ffca52c240836231f
...
git checkout 9c5a1d3fd2a838a44f0d5c524cc074e19bea0cb5
...
git checkout e79e6f14a66bb59396e1a2c39a6e8d379d1e5fc3
...
git checkout e67a2babcccf11e5209afc39d368eb79b1d35c21

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout bd93f034dfb12d1da808d1511526c71e981e7342
...
git checkout 134fddb97d5fb257d57db438ca64f0692e794876
...
git checkout eb9c90d1c8f48f2620804b79444674c8f35f1dda
...
git checkout aefd8ec5453bdc154654c1b228582dbdf4d309f6
...
git checkout 4bbcbac32b4c598ef0cd2257235c8cbb31d36feb
...
git checkout c2a55621b68f06284a6a5990771e31e1df7bfd05
...
git checkout 8f10396c79c011a0eb2cf2f126452250030942a8
...
git checkout 9ca0eea7199759ce5e4f20bf028a9f3833304388
...
git checkout 38137aaf8c2a2178436e9c3f5ccca6442910a594
...
git checkout 15d098dc7abd8b0c5b4bdb8f6c4dba8f037b2cc2
...
git checkout f3bad54455dde6aad5ec62bbb115be8120173f7e
...
git checkout c12504658364bb9b55384c1a747a841478b92f16
...
git checkout f4546b1366358c829cb4862d036528075c82af04
...
git checkout 6b230e5f1491814a75eb365b7f07b0ebc6446a9e
...
git checkout 58dc89ae9578490e957e30651410b4500ef3a4f8

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout b4f8bc2648691722fc7998d7b394ddfe849d7b08
...
git checkout e962bf5c52fe54403eb6a70a9f68f19c73e0ac65
...
git checkout 5b02acacc349b742415a9710e5a7086b1948887d
...
git checkout 4ec3df1ab97dae49d7994515930ec3a91ef31781
...
git checkout 24250966360cb48fc8ed64224ea67a03f34454b6
...
git checkout c8e4f26a7697d05b60cc63d540b96107a925db8b
...
git checkout d845463c3eec254a5fcac9c9dc49e6e0ae50f615
...
git checkout 8fe0bae59f4aae0f55e81c9d9b5018c383ebf113
...
git checkout 5f1fb3439d16356b6c956a1e86308a1b04483c5c
...
git checkout 9bec890de772f20efd605c0a4fa77fbe4f7ef5ec

cd $ANDROID_BUILD_TOP/packages/apps/Settings/
git checkout aa61a439045d11d89a1effa43cc0b3f1fd33454f

cd $ANDROID_BUILD_TOP/packages/apps/SetupWizard/
git checkout d35618baef39a017250a1d6bfcecd5e107915c49
...
git checkout a788cdda0fd29d9c0b672ce1a7ae839fdd4aa4d3

cd $ANDROID_BUILD_TOP/packages/apps/SoundRecorder/
git checkout 2b9afca5438107704e8cfa88bb4706b628bd68dd
...
git checkout a245d3b2fc53111a8c565c0430864c03cab81226
...
git checkout 609aa137f7436ba033f7d077c1328bb4d26f447b

cd $ANDROID_BUILD_TOP/packages/providers/DownloadProvider/
git checkout d94d7f8f4f72ac7e827493f3e1fefca780b53097
...
git checkout 0153b37ac9360e2ea555bf634d10b976bea99efe
...
git checkout dd4a8623449ad4a4d569d4c2b2a8b56979b282b3
...
git checkout 9ddcdb42587619b72019d5117b19b7df75d981be
...
git checkout 41b96a97cd4806b7076fa5b6a5353150efb18c7c
...
git checkout f2c8d868354f57d1859fcf45f1f6b6b08b38b6e2
...
git checkout 57f993955b864add430b61839193abbfbae0e348

cd $ANDROID_BUILD_TOP/vendor/asus/
git checkout db1d5f5e349dbbb0ae7bab95bdd759bab40e74d3
...
git checkout af783217e2c37fe47a5bbf33e6f407c368094f8d
...
git checkout 08bd87ab25a73e57ac0d0ca33bec827286ef01e5
...
git checkout 2ba90629b8984c3b7abf7fb682d486c596043a4c
...
git checkout 75377abac7c3de7b8bff26992029ff7cc2c01da3

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 9b950d0e7925585de2239f7d7e05d932d61f5dc9
