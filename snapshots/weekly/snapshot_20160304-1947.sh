...
#
# Time of this snapshot: 20160304-1947
#
...
git checkout a647aa1dbe61e896aa9b62d6e6a068b4d6597348
...
git checkout 808632f7bf0a897fb55cc38170ad6c1b2fd86ba2

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout 24a621c2ef71663b11cfdaccf5aed5ff309d82e3
...
git checkout 2eeb0cea19cd3cf9f022f7cb0c54b07b3eef1f11
...
git checkout 438a27e268c5de282863a350e9caad2818e317cb
...
git checkout 8cbabd4e53fcdf49076bf938fa7052a78fd8342b
...
git checkout 98e71bf047f0ff311a47e57a1566926b86af794c
...
git checkout 42a60b273e2d4188a0895fa2b0d463cda8b06b54
...
git checkout b91511ee4dce6c2e6b98bf777506252aadd0a759
...
git checkout d50cc00a135deff76edb60b01c37da9002f84d7f
...
git checkout fec6c6a0f223bfb6999fc48841c58fcec492b159
...
git checkout 5bd46bab778ad10a5b9a4f26ec1c9c8e9868bd6a
...
git checkout 7aff8c29f1f954e4a4b794cbc0e81b2b8b4afe1c

cd $ANDROID_BUILD_TOP/packages/apps/Settings/
git checkout 92fb1d66df033cabbd79bc557bded08c7a7e95f5

cd $ANDROID_BUILD_TOP/packages/apps/SetupWizard/
git checkout ca63326151df341831cf95c2ffb910c7232c401d
...
git checkout 999362513572e79d3be971a8ba4a214a18b0485b
...
git checkout 4417d18292bf81fa013242919ae41a9fd5a008cf
...
git checkout 73e251e0ddec3009538f4ede8ad7dc9d1ecb3782
...
git checkout 8564af3680b97049a0019c0579afd40347c4c4f2
...
git checkout 7a589849e359e27ae2b644fc68f7af07bfbfbbf0

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout da302dcaa3b4e02b207244c833d932546730769a
