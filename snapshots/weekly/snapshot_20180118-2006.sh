...
#
# Time of this snapshot: 20180118-2006
#
...
git checkout cb3aeb98f2ce49b21f04db3d3bced4860b7d190c

cd $ANDROID_BUILD_TOP/build/
git checkout d3fb203cfb1ea656729f1240dadbdec11a0df8c9
...
git checkout bc772237bc5740821e32172860b7db04bb13d3df

cd $ANDROID_BUILD_TOP/device/asus/mofd-common/
git checkout 159edf8f8b4dd1b1c1e59bd5021233a7c6d48281

cd $ANDROID_BUILD_TOP/device/asus/msm8916-common/
git checkout c27afc40ba61d4ffbdf947944341c1b17ffe3c33
...
git checkout 363da28a8ed3a8a8f5644f1df8e58fed597bb407
...
git checkout 21ef8ff87bfc83eb063628f5e239282d4af162af
...
git checkout 7bf6be6e79942fd767aeb8a708a9a999b71e996c
...
git checkout fef86bb683872b5e2632b3ac76c35155c98e2a02
...
git checkout d807ebc78cb0b27fbb83a2a4ef7484cb5885286a
...
git checkout ea18916ffc0b2e03edc337d301e29cb9197113dc
...
git checkout 09900a452e7fcd864d0a445345a7ae10291400ef
...
git checkout 2a44132cd0d9e9593859abd670ff74d12c86b584
...
git checkout d00e1f442dbcd6d277737ecd856e824ce20b97a4
...
git checkout 7aacdba41f9be39fcb1bc8543208ec650de9ea96
...
git checkout cb33b28bfd2f946f7f5bcc918b87feeb225c7c70

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout fa1e66fb6cee5a3091d5b5ee02248868ed3c8729
...
git checkout 61e42c38dea46a171d5c782e8a9875a607e83748
...
git checkout 28ef2896bfb00889aa51e63d67a5c24266a3dba7
...
git checkout f66b300c312a57d42fa65f9c23c9a761c5ebaa92
...
git checkout 08f9388800fb3c2bd5f2da3bd179639a148a2241
...
git checkout 4be649f1cb0da0bd25931ea6dc3ec4ddfb175019
...
git checkout 11c0881df4dffb01fbf247ed94aa47e7fb992d1c
...
git checkout d92d0487f17033bb157d912d629b0940b7b244e0
...
git checkout 1633dd56a30027f64e9920d39fb05517e38cc467
...
git checkout 801c4faa411f5260a94d585b1f04dfad5a3bf926
...
git checkout c04881d152fcc24ae35e3d8afdbcba07531435a2
...
git checkout c1bf3f101b7dfc99dfc62b45dbaed8e865153875

cd $ANDROID_BUILD_TOP/kernel/asus/moorefield/
git checkout c3eae894ce8092c2a9a51f9a4924c8df714d6b3c

cd $ANDROID_BUILD_TOP/kernel/asus/msm8916/
git checkout 029985adc9138813173aef7dec421064e34ee9a4
...
git checkout 853158b4241aea14f95377cee4491d5d37bbd54f
...
git checkout 39319a7fd544b1e79b22ad5b2575ff5039d6c2a6
...
git checkout 012e1b79202248309a253f87354bc4f1efb1d449
...
git checkout e957800ee07807e4c46073d8805b4e1373dae9c4
...
git checkout 8a61c77a02b374062021b93dd0b34f43c69752bd
...
git checkout 9031ecbb053d0c59c07d8adfe80cb3759136e8d5

cd $ANDROID_BUILD_TOP/packages/apps/CMParts/
git checkout 3de4f44933ad36e82f83e04511cef258c40b9859

cd $ANDROID_BUILD_TOP/packages/apps/Calendar/
git checkout 7b0e72c80c87ba38c00db9ddf9f11d071e778f61

cd $ANDROID_BUILD_TOP/packages/apps/Camera2/
git checkout 510f8d5d4bbde5a65e10ef64fe0d3aece5f91061
...
git checkout c490f0ae5bd648209753e42f880f3dedb09bb8c3

cd $ANDROID_BUILD_TOP/packages/apps/CertInstaller/
git checkout d78955d8e10ba7c82edfb58a2d005581791e8ac6

cd $ANDROID_BUILD_TOP/packages/apps/Contacts/
git checkout 21b42d6e7bdc0f44e8cb5bf5baeba813a7fab798

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout 1303d0111c915ec824dceb7b738ed82a6643e1dc
...
git checkout 965514169b360ee291366b461fa4ba74d7cd58dd

cd $ANDROID_BUILD_TOP/packages/apps/Dialer/
git checkout 9ac620bac226998a561d0dc2821b29315c11c764

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout f02a09b9763dbb4a6756d937e3d83fedc222a37b

cd $ANDROID_BUILD_TOP/packages/apps/Email/
git checkout ad797a07e5a30ba95147f9f537f97900419efc26

cd $ANDROID_BUILD_TOP/packages/apps/EmergencyInfo/
git checkout 6315e2a213c5dc1b29693bb1e19e49d955a5e831

cd $ANDROID_BUILD_TOP/packages/apps/ExactCalculator/
git checkout f468e17573712914d08e9f275cfcd2685e9479e7

cd $ANDROID_BUILD_TOP/packages/apps/Exchange/
git checkout 58289b04ae57d2fed67984b47ae0b36a38e445e6

cd $ANDROID_BUILD_TOP/packages/apps/FMRadio/
git checkout 94418e49994b6f2227a5041b384061e0004afbf0

cd $ANDROID_BUILD_TOP/packages/apps/FlipFlap/
git checkout 8a328d6011c9a5b2498224800fffbc807fb76e39

cd $ANDROID_BUILD_TOP/packages/apps/Gallery2/
git checkout fa60f2f0e9727cf318a584ee6b4d9aca4d9f84d1

cd $ANDROID_BUILD_TOP/packages/apps/HTMLViewer/
git checkout 5fa849ffcea0ee1311825eba4380ca705373aca5

cd $ANDROID_BUILD_TOP/packages/apps/Jelly/
git checkout 1bca7e8c9fbf1e9407f309125ca60497fea2b39b

cd $ANDROID_BUILD_TOP/packages/apps/KeyChain/
git checkout 6eb827dd39c06b12f1511214aefa342242c34cf2
...
git checkout a5e1ce4dcbe723dab23bd98204a7a75ce8467f34

cd $ANDROID_BUILD_TOP/packages/apps/ManagedProvisioning/
git checkout 856860f606fc0dc4607cff7f4f17f22b928c001e
...
git checkout c21160cae99a3961475d0dfbb2821ef57d5d0c3a
...
git checkout 4c4345c2d78f697a2a18d3eb40e28323bb6dbc68

cd $ANDROID_BUILD_TOP/packages/apps/PhoneCommon/
git checkout 69f7e49de8a45023900fd4e7dcd9739b70124741

cd $ANDROID_BUILD_TOP/packages/apps/Profiles/
git checkout 2daea4c46a2178c58669828c9152fd83d9ee375d
...
git checkout 00854bfe6cd0224c34c7f556fa20e4520aac521e
...
git checkout 137ed3d264d14e434210f6b7785aa8563ae9c838

cd $ANDROID_BUILD_TOP/packages/apps/Settings/
git checkout d12aec992499354481e3a22f60dc3ac3f109ef11

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout b9f3a75179e4fe9d1c6ee7692b178eadf05e1ff5

cd $ANDROID_BUILD_TOP/packages/apps/Stk/
git checkout 53b1bdbf502d517807d541591d345367707ee84f
...
git checkout 0cd80ff76eb9fb8dce44181e14de66a0c567be50
...
git checkout 313ca94f201a4fbb0607b4c2e3d4c50b5dc16cb9
...
git checkout 920a0c0a82a7c1ece50857034093331d2f7aa0ac

cd $ANDROID_BUILD_TOP/packages/apps/UnifiedEmail/
git checkout 48b95b4dc8f4f21ec780a4077d2a9a2d15cbd900

cd $ANDROID_BUILD_TOP/packages/apps/WallpaperPicker/
git checkout d958d0704e758842a3f6ab9d8e7bdc3bf08d3066
...
git checkout 93ed851884a75b1974fd60810a1e02eb19f50691
...
git checkout dc340ad12e7b6ef3416404f91ea75f0d046cc352

cd $ANDROID_BUILD_TOP/packages/providers/CalendarProvider/
git checkout 47ac2eb08e4632086b9f0e2b5945bc73bb45bcc5

cd $ANDROID_BUILD_TOP/packages/providers/CallLogProvider/
git checkout 4c5005c57607781716604727f804582c1f63caf3

cd $ANDROID_BUILD_TOP/packages/providers/ContactsProvider/
git checkout 56c9b195b9ba4b179480a3fdd43d88094b609052

cd $ANDROID_BUILD_TOP/packages/providers/DataUsageProvider/
git checkout 2b23134acf1f49af39197e383f7d57d2c6f83e72
...
git checkout eb69d25a32cee88f9c26656f5217c46f06f4bae6
...
git checkout 6b8d93ac8fe9438d93b53c52041a6c7d18ba6627
...
git checkout ed2c2b6d4de5fd78b873d2a0219d5c792c1dc08f

cd $ANDROID_BUILD_TOP/packages/providers/WeatherProvider/
git checkout e176b4f6293b713b364815ea0a6cd75a900ff9f7

cd $ANDROID_BUILD_TOP/packages/resources/devicesettings/
git checkout 1f490df4dcd857009c6a7c30531c2e304782ae50

cd $ANDROID_BUILD_TOP/packages/screensavers/Basic/
git checkout fc3ce69d7db777b0beaf5c779139a0b3d4bc3ef6

cd $ANDROID_BUILD_TOP/packages/screensavers/PhotoTable/
git checkout 27283e11b1f607b87fd914d1e1237ebeb8137d30
...
git checkout 4f17600509c186d6a03eeded078545b518cd4830
...
git checkout 215150b698835b46b8aaa888e0ebf19f271f1a5c

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout b54d17c69f27575a0e68dc79b99a9222164d41a4

cd $ANDROID_BUILD_TOP/packages/services/WeatherService/
git checkout a0c8c93aa5158784abea35fbef7199f9a4347f82

cd $ANDROID_BUILD_TOP/packages/wallpapers/LivePicker/
git checkout c705d957696691325d004f92d75e6f161a4a08cd
...
git checkout c9cc5425c91385e9356540eadd674eb72daa4c1d
...
git checkout 526995393ca037af0859a11706ef78ea35a9524a
...
git checkout f902c0838bb579c24ce480a90a05dc23e4e55634
...
git checkout c6bc15afa19abd43bf026b4c15324da54c89e8f0
...
git checkout 91c51e689c51d145d069dc33e8328041c6ba375f

cd $ANDROID_BUILD_TOP/vendor/cmsdk/samples/weatherproviderservice/YahooWeatherProvider/
git checkout 5a1dea102f058ef1e8a194a39d43f7131312bfac
...
git checkout b7d5047b17f7eb858299c948ce6e970d33089903
...
git checkout c735d677555ecfc50486340fc89d2dc4c87388f0

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 30183a5bfc97559b919b51cb13a7730493552a81
