...
#
# Time of this snapshot: 20160715-1359
#
...
git checkout f188be6085f835ffbd1f872c924fd4d536db0fac
...
git checkout 599011d44ae3368d6f745b8ef2418de0be5b52a4

cd $ANDROID_BUILD_TOP/device/lge/bullhead/
git checkout 9d2efb9229e33c95f428d15d5be33bc0f9babd86
...
git checkout 67911e5fef7717b8684b2414300fb61c8bab85c3
...
git checkout 03ff1a9928010d3f4c962122f108980335176896
...
git checkout b80081c99e1648054230774c7cc5431c36551b37

cd $ANDROID_BUILD_TOP/device/qcom/sepolicy/
git checkout e46016c096d7be0ddda3aa221bb3a36f325b10a6
...
git checkout dcad21c08e61f439e348248a04dbf27b19e73244
...
git checkout b7fa70df69e8d54b8ec72750989e7a9eda67f573
...
git checkout 5647935fe54d14280d03e4a54c827b8a2a4d246c
...
git checkout a581a574d6e76b7737bbc83190ad3ad2ed126284
...
git checkout d8a7052baa47785c616774f8e2e9acea6246b23a
...
git checkout 23a27a257e03650a71372bfde036500c68a92861
...
git checkout a76695a86559023014f495c263b111ce2bd6b473
...
git checkout 0d2bc4350ad290c0f5bdf69dbbc5baa716889b0b
...
git checkout 940b28bc37f819c62386e393614354f55069e8f6

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout 0f4309e7197fabfa33b7d5f8bb966009b8d3aefe
...
git checkout cf27ee8089344479bdfd53568bd105d8d50e9275
...
git checkout 43d2a9a903ca94b79a1919c6c5491810dca71e07
...
git checkout 4b473858028ff1a8bd328a8e788b35c2caaff609
...
git checkout 77b82b847adba119fc6abbf3aa60b3483266a2ed
...
git checkout e61dfdc08621628a80f61dd9a1ad7b305cbfe8a3
...
git checkout 41acd92d53ac93f9daf12608ede5e54dfb8cb6eb
...
git checkout f56c2d548943d7dcaff92be5669cc7aac9cc02f6
...
git checkout 20a81a537c2891e3add9b05766295cdde50117f3

cd $ANDROID_BUILD_TOP/hardware/qcom/audio/default/
git checkout c6f3e593ff40ebcde58e23658755afa548d917b5
...
git checkout c3dffc0a45f18bc93488533e14287617f06e2ecb
...
git checkout 0bbc94947140f87e873f4d34e3819d4f83ff5c0e
...
git checkout b6fceabe9293920181bf8f28aa0bc202a769155d

cd $ANDROID_BUILD_TOP/hardware/qcom/media-caf/msm8937/
git checkout e0a2ec2947d950aa635e41bc903126d171d153de
...
git checkout 11122387d782d9d7b794f816822ab0569fe0c23d
...
git checkout 75628e6af1410a769476c8845dbdc444269a97ae

cd $ANDROID_BUILD_TOP/kernel/huawei/angler/
git checkout 43023fa2770d7856a48f70af36bce62a3f92478a

cd $ANDROID_BUILD_TOP/kernel/lge/bullhead/
git checkout 821092cbb95204fac1ea2703143fdc2f72a0a079
...
git checkout 70e6e113f1bed9f0d246ff8a1eadaa39b7250042
...
git checkout 6b285fb10b369cd8fe96a411c7a3ad1d5bfd6d51
...
git checkout ae09ea39761b4309122f3e975a7efc2477b587de

cd $ANDROID_BUILD_TOP/kernel/samsung/msm8930-common/
git checkout 459e9cda641371c669ab7be49b0dc9ce593ce784
...
git checkout 6a6860a29d033a74b27c05ed31cde88eb28dd973
...
git checkout 0b43fda34462f452a4acf5453ada58a8c7942fa9
...
git checkout 80bd5e6284f38e7e2ccdf8cb43481f627cbfdf10
...
git checkout 248b0a9811930a05f91956c87bd66ce3e02fcae6
...
git checkout 1e847a28e7c501abe86ddf323753452f4e16a4a6

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout b9ecf21e83c779a915b3e029279aa1fbe3b9e64e
...
git checkout e14b1077a0ae4fc38efdf7295369f49037f87b5d
...
git checkout 36aff522ed5fbf378a0eb5acfe575bb3cc71aacc
...
git checkout 5d62f58682caffe6e42d1693e03760d32ece354c
...
git checkout 0b4bbc6d732b434b2596326cf62608ae6b5dc64e
...
git checkout f7ea48ee445af7788ed0edac2857ffde63f244d0

cd $ANDROID_BUILD_TOP/packages/apps/OmniSwitch/
git checkout ec86b66b96f3595fba934d58e4b3791fdf9c6503
...
git checkout 5972fba8b16db0148d51beb82e5f37f888324276
...
git checkout 95cdd6a67956999b41ec3fb35932d4a9131615e0

cd $ANDROID_BUILD_TOP/packages/apps/Settings/
git checkout 24311fa123953ad96b5e464014c47dfacc7562f6

cd $ANDROID_BUILD_TOP/packages/apps/SetupWizard/
git checkout 7c1cf5a2324b1622a12afa115bedd7a9c2031b0a
...
git checkout 82254d7a359cf9a409b0caa0392a9f3e60ee4441

cd $ANDROID_BUILD_TOP/packages/apps/SoundRecorder/
git checkout 82fad2670956e5cb1a52045b31e63b11b4a6505b
...
git checkout ea7e6b95bd0bd3491536d1673bf5815a5ea8efd9
...
git checkout 057cbb3c443c389fff7c928405d324c23f81dbab
...
git checkout 2fed023b59ccbb99a982796aa2997f07719badd4
...
git checkout f1eada5b7e2bc10586381d5236e6abb814694d83

cd $ANDROID_BUILD_TOP/system/core/
git checkout 5b537bbac12ada45240f441d830bb94c42696230

cd $ANDROID_BUILD_TOP/system/extras/
git checkout cae0f79d77cdd1ef2853ce731c99b73f4fb7f2f8
...
git checkout e508c1bb5a25d3b12c918e664fef8353659b6cb7
...
git checkout 6b4d4fa9adba63c0093c3d9e7ccf94af5a6a22a4
...
git checkout 4647e4f656d16d2b9f9378734691e7488aca89e1
...
git checkout 7a0e117c19cc11fcdb9c8154f180bebb3ee9f5c9
...
git checkout f9ec03bb5884836d81ac29639122af130200b4aa
...
git checkout 5ba11aa87bf301ae8d5e5679e9ca314c39fe6763

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 0919119a674df15b62df843c885051f920d25683
