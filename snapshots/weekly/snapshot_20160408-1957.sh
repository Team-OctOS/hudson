...
#
# Time of this snapshot: 20160408-1957
#
...
git checkout 2598dea636319e633944ae8598e5327b97532a42
...
git checkout 090f45ec183bae328d82c13e04e0211070df740e
...
git checkout c9e993e8d44da65929448491e2524c4a901c4863
...
git checkout 4e917f3687e584b915e7820e456a6aa2bf94c4ef
...
git checkout 8b10f2a31d897c7ed81914f5da524cfd046a9cf3
...
git checkout fc0b187c19ba22bea1246f40e5c223a90a089dec
...
git checkout c33f1027d822fa96a346cbc75b9b577a4cb9370b
...
git checkout e13b58b988ab642d4ae5ca6d0a89013510714956

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout 213c833b55764318e44e24b7a9943f584836fe4e
...
git checkout 31d9cccf23017fa67532001e737a4660ec39febc
...
git checkout fb532f2623f082e5df86c6356157c944f1f1af03
...
git checkout 624f14f8f63e44357710b014ecae0571fbaf48b3
...
git checkout 5905f06894aa5050d04bc18a1c2ba6e13a175521
...
git checkout 975f0553c119f107453a9b72cfc8b04aafcebaf5
...
git checkout 4aeb76554720250716fe6003d8b7df853928422e
...
git checkout 595846872263c1567ccee375abae9b567b8388b0
...
git checkout 1e2ad0157e708d06728ef575aa556c1e0455d278

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout 375869a80975f133f1269e8f44abbae07b001218
...
git checkout a245d5701b0452145b2a813464fa2f1fec74fddd

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout 33f2164346d089a268f9abaca82efeebe194eea3
...
git checkout d69ce6c2a65c3d451dfb5837678221e56fef1880
...
git checkout 446181ce2286bb5690b8fcf495c15457dd1785b7
...
git checkout bdac5aa5af2de5aca946f9bc0caf58b5b38935a6
...
git checkout 07b6f13e0a113589e827bad009ecc299ecdbb81f

cd $ANDROID_BUILD_TOP/packages/apps/SetupWizard/
git checkout ac93a6765db36760995f102cc590435bac36f4d0
...
git checkout b7fd125136308928aa0f9cd71af940a187597150
...
git checkout edec4c11c704e9908f1d4f915a4ec2e0eefe54fe
...
git checkout 89e9807d6580b83e872511cbea27adda44ac1171
...
git checkout 64fda03f5db6977c018bdc718d6aa52974b2a676
...
git checkout 719ab7c5aed4baa32952c4be44c8ce24d333a130
...
git checkout 6aececd84d3872922a84101873886ca412569c99
...
git checkout c64071a6ac406d383aa016f6bb1434affe9321b2

cd $ANDROID_BUILD_TOP/system/core/
git checkout b952b460a7f7a738edf37a5998071dbc7a0bc0a8

cd $ANDROID_BUILD_TOP/system/extras/
git checkout 95085beeace4cc3c67ca7b66d74c3f1a5c2e678b
...
git checkout 1f36abf4e69903e0d291eb948722eebf9a5812aa

cd $ANDROID_BUILD_TOP/vendor/asus/
git checkout 7216b1dd986510803fa3da605f18aa9d7d0a072c
...
git checkout 87a540aa0805bfd9bfb28a48dfa482ec00e132ea
...
git checkout 6722b389416d702be0ac3177d6890d09cc0b4fdf

cd $ANDROID_BUILD_TOP/vendor/motorola/
git checkout 52a6964ccddc963abb2c5ea85d16f7c8710952ae
...
git checkout 826b3b47d91e00c63a3b65625c7bb64eb571fb8a

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout b813b8c5b357596824be1874d717e2ec5bb09464
