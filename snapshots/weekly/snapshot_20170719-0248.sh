...
#
# Time of this snapshot: 20170719-0248
#
...
git checkout 055b18372d39b9816d0f04efaf35f816e16c32ab
...
git checkout 6ff6b9f04ded9a5c6d793590eb9c6be84b45009f
...
git checkout 6e325ba82d5bdc550e505ee3df941d2dd0416402
...
git checkout 203341701a34984973f31bd27b038bb67ad5dd2d
...
git checkout de6f4be881a9ae887b891faac19bcb663ccd4b21

cd $ANDROID_BUILD_TOP/kernel/zte/msm8996/
git checkout f1be4d3ad1a7bf850c402adc4bb12c324e17a47a
...
git checkout d9f145130fcba2226d0d6713bbe498597cce259d
...
git checkout 4d40bf71a33325923a91f6ebd86ac8105819ca86
...
git checkout 5c51d47c10a5af0a9c1b0c8649173eaadc53f93b
...
git checkout f43adfb12f26a353e8db378a611814e22fd373b4
...
git checkout 54728d5fda9fdc74e2e8e61ef608fe19d064dccd

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout ccd3b851872d32b38d706bd489c19cef3bdde540

cd $ANDROID_BUILD_TOP/vendor/to/product/
git checkout 380ae88af68d400335e924d01cb30d3393de2f82
