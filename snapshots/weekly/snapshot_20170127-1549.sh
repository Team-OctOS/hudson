...
#
# Time of this snapshot: 20170127-1549
#
...
git checkout 6722de5b30a624dc4bd59051217a48ad4fcf26dc

cd $ANDROID_BUILD_TOP/device/asus/msm8916-common/
git checkout 7f85af1cec7b39b12e6aaf0f6282a9ebf9b1abdc
...
git checkout 290aedcc992caba04640b0548146ed2c5b561af9

cd $ANDROID_BUILD_TOP/device/oppo/common/
git checkout 7473b8fe0290411453d0d3687801eb0900a1a780

cd $ANDROID_BUILD_TOP/device/oppo/msm8974-common/
git checkout 7f06faff57a5ac5ecb6b195847caf6b3ee903fb3

cd $ANDROID_BUILD_TOP/device/qcom/common/
git checkout 4d5a288c0f3ab6d3c9c83b25e2790e9188efda4d
...
git checkout fbad2aae61cb3fbc404caf5257c5c281683ce709
...
git checkout 234bd3a27e39f64b0228585aa7d9f2de3e29a974
...
git checkout 6faf050a6b30927f5e97cf332417700e45fc9bc7
...
git checkout 00a823eda6c0e1faa6eb66dfc3740e309ea99079

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout da11f46a6402284ca756dc2635c022f722e30afa
...
git checkout 4ec7517902f38ad740434900d894ba70e51c171a
...
git checkout 50db0bed3274f5fb8acc2dca06de0dbeab377f44
...
git checkout 61970b6e50bca9598ff5a1ab93a77a51e8d43b77

cd $ANDROID_BUILD_TOP/hardware/qcom/audio-caf/msm8996/
git checkout ff84df68eacd258b6049ef44cd6d084f843d1592
...
git checkout 982bdf13067ca8d41ab8ddfe63fc1ec396122023
...
git checkout 41cab354f13cafe48ca8576c8b181ce90064f9e8
...
git checkout cef7defc0830591d9bcb392bc089898b7d2294fa
...
git checkout 524aefed0100036183afdda6319f98b883f74f51

cd $ANDROID_BUILD_TOP/kernel/oneplus/msm8974/
git checkout 4869a1084924e884edf993460376993b285557eb

cd $ANDROID_BUILD_TOP/kernel/oneplus/msm8996/
git checkout c9d2fb5e713814576f96a25e6ec285921574fec3
...
git checkout 6a3375b17575716729a207b1331b3cbcb4686ac4
...
git checkout bdff96cf67bac2cb53dcb79550343412e1896d43
...
git checkout 2baaf7e6f183fbaaf7f892039a37e25e3b7a9945
...
git checkout cf8c96dfeb917465107560d72a0dec1d8613176a
...
git checkout 94ff9c7a48d321d9f819d60afa784a557cb4fbbd

cd $ANDROID_BUILD_TOP/packages/apps/CMFileManager/
git checkout 8cf2b73d6f274425f3f816dd68872a0774dcf792

cd $ANDROID_BUILD_TOP/packages/apps/CMParts/
git checkout 04d30eefb791a637d141ee48ca3d95460367af03

cd $ANDROID_BUILD_TOP/packages/apps/Calendar/
git checkout 1ffaf69425500718066e006a23d5ec17053666d3
...
git checkout 982f013b371ad4682a604efe3ee38ca09d6fcf50
...
git checkout 2e6ed44be492ea408f7e23f8da4c088a2ab8384f
...
git checkout 6b532c8640b3487f83f870b4b44ab56ab63e7b90

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout 4feae4e27e7310bdfaf307a45a60e42f5e43d61b
...
git checkout dcc76743660c8873fe242599e184937b5e349ee7

cd $ANDROID_BUILD_TOP/packages/apps/Gallery2/
git checkout 581c0bd6a552aeb4953240ac3e9717a87166b5d2
...
git checkout b642154c0afbd5e497c254c4111fbdec6859984f
...
git checkout 3cdd329c7ef8ab7a1d3a68be27c0a8656967d823
...
git checkout d333d12c4c3622eb04c1ae9245773cddda4a01de
...
git checkout 23c2162942a2bf20c8113e479ff206914d267339

cd $ANDROID_BUILD_TOP/packages/apps/Settings/
git checkout 5378a721849652a9e2d8327bbba399b4bf187adf

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout 166d4dff828902d31767d9a7f43de3dd5d7e356c

cd $ANDROID_BUILD_TOP/packages/apps/SoundRecorder/
git checkout c2b50b0cd8529b41a26f9122c32ed3d8a6ed2058
...
git checkout 1d0e048b9a5646d9ef5cb693396148361530bafe
...
git checkout 3e714b23e6c67becab1a3bb7457eb3a60982fa90
...
git checkout 479fd88fa3f7f88dceb0d3e850119ab6d30feefc

cd $ANDROID_BUILD_TOP/packages/providers/DownloadProvider/
git checkout ae28f35ff1bbd6ef435d4112698fa83c26c5374c
...
git checkout c5a0f790e0697976d3117977964beadb75471ae6

cd $ANDROID_BUILD_TOP/packages/resources/devicesettings/
git checkout 21da045e33a25003ccd4760bd3f1e39b99161487
...
git checkout 904c90cf99d06b05f6530bff78d1102d89f3c9a8
...
git checkout c2ed09b59edf95548299f1219f76c4da4f85d75f

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout a5a13d1df61b4cd363d598cd2f485c274ea218e1

cd $ANDROID_BUILD_TOP/packages/services/ThemeManagerService/
git checkout aa8afb9851081b58efd70051f5f95f81541effc8

cd $ANDROID_BUILD_TOP/packages/services/WeatherService/
git checkout 12ace37b558d69a781bb0a95d8ab73b9c857bf9a
...
git checkout cc99880ca95edea3c9712a58ec3c843994bb6ea5
...
git checkout b6d3b4d4cbe516a2fe6f08a48c99b94a1e09cfdc
...
git checkout 56db5e5c7be0e5de82f23b8ce2169c3c5e61637c
...
git checkout 12c7f69edd5d0eef49f15fcc39927ecd5af9211b

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 0f0d7f3f7591d67750ac72516a18ec0002c2a23c

cd $ANDROID_BUILD_TOP/vendor/to/product/
git checkout 93089f68f64347b12a1ac5714ce5ee1e6051add0
