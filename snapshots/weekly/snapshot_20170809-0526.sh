...
#
# Time of this snapshot: 20170809-0526
#
...
git checkout ccf8932732fe04a97d2802beaee087e203feac56
...
git checkout 39fe0473162b6ccdaec9976a4a5d8da557609cde
...
git checkout 1c4f138c16310f57038d0c45f3f0d1b97baf9e13
...
git checkout 4ccea9234fb8a47f7ea1c08489a03f26a4ed5fd5
...
git checkout 4b826a7ad0302250dd0f1fb0cf096eb01216fca5
...
git checkout 249118f92a20e42462af6d813ccd97e08e40e4a7
...
git checkout 72006009e0f3e431aedec470d25b131049267ae3
...
git checkout 7734c4031fd8242fc773d7a193fa1b5b342b6b76
...
git checkout 415717e1ff5df3528401621022566ca5b26cc587
...
git checkout e56f9ed3f6b80c12d9d1878738a7e8c26e98174b
...
git checkout 5617e09ed03a3b81f83b3909ef6a0f0d3e74926c
...
git checkout 14b23250c2732b9996dfdb3ddc75516640d5f588
...
git checkout 6c5dc9084245bcc33985da9e892c86df9698a4fb
...
git checkout f84f2651f97b8da8775f434c908622eccce505ba
...
git checkout e205b2a0cda073ec655281f4b7f98ea8592b4d17
...
git checkout 2ccdc697b344e4eef33defb41b6f343a1d54c759
...
git checkout 5c1729d6069480fe2da9c24bcbab1f9e18f3773a
...
git checkout 22d79cb51963fdc645d09ed09dc7c9574c2207e1
...
git checkout 751411caf13afb9241260297a00978a4caa18527
...
git checkout da4a326d8195e39647dc47b4b383c8a7cd2ee73c
...
git checkout 6529b279f2c94935423d244236e4196de84c9cdd

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout 49e58d9758d5741249b31271e6a6e3f825c73a86
...
git checkout 16f7c5fc79051ae7bcb6e725779456ca89156ffc
...
git checkout 935b70fc2cfeba9308ed2834117f07ba7fff2edb
...
git checkout 7fcca3ecd19b33a59346d5f60e23597cf2dc17dc

cd $ANDROID_BUILD_TOP/hardware/qcom/audio-caf/msm8937/
git checkout 9dbd0629b4a1f779351b59e6e27fbab068f01da2

cd $ANDROID_BUILD_TOP/hardware/qcom/audio-caf/msm8952/
git checkout 34f4914d6e0e0acf7cc43b0c603f15dcb415ec27

cd $ANDROID_BUILD_TOP/hardware/qcom/audio-caf/msm8960/
git checkout e248666743849434622f601c3ea2f863354f37a7

cd $ANDROID_BUILD_TOP/hardware/qcom/audio-caf/msm8974/
git checkout 0d8579c53d367a78bcb1f61ef6712708e00acb52

cd $ANDROID_BUILD_TOP/hardware/qcom/audio-caf/msm8994/
git checkout 9dcddd7c22b08c4dda72be93d59eb85bcaf595f4

cd $ANDROID_BUILD_TOP/hardware/qcom/audio-caf/msm8996/
git checkout 5b1254761f150940e38bb6e70d0fd15dcf076f28

cd $ANDROID_BUILD_TOP/hardware/qcom/audio-caf/msm8998/
git checkout c519e1ad003d76b2af20176a560a760eb507ce8a

cd $ANDROID_BUILD_TOP/hardware/qcom/audio/default/
git checkout a4f1bc5833568a547366ab8fc9c154b7bf1f0774
...
git checkout dcad703cbcb090e4d73b52ff4bf069861a346feb
...
git checkout 02e57500c95a1c8f415c45d41751a3dddc96ae3c

cd $ANDROID_BUILD_TOP/hardware/qcom/media-caf/msm8916/
git checkout ec789248f3ea62ab6449feab36ddc0f43d5c537a
...
git checkout 1afe59f2c64a8ada01cee675efe88d23a201956b
...
git checkout 2c868b183c81f46dc110caa53050d0a14686d902
...
git checkout 1f8a9dbac1d16ca4172ddca87a53553792891c29

cd $ANDROID_BUILD_TOP/kernel/asus/msm8916/
git checkout 1639ebaf23d94063b008e6eb5d4625c0157b78e7
...
git checkout daf94e61123e9143270a5933a6db0ceeacf9b278
...
git checkout 736842f300567f7adc5f141dde97e1803beeebf3

cd $ANDROID_BUILD_TOP/kernel/lenovo/msm8916/
git checkout 861555b14be81e1f5a0bbf4c2bb1e0e5099f81ca
...
git checkout 7e68e0de5517a9292c7b2f40846f33e42be98b84

cd $ANDROID_BUILD_TOP/kernel/lge/g3/
git checkout d6891398ebd3363ff419125c3f48c453097043f4

cd $ANDROID_BUILD_TOP/kernel/lge/hammerhead/
git checkout dbd1c672c8b3adc37bd2fd353b11dd513c780f4b

cd $ANDROID_BUILD_TOP/kernel/moto/shamu/
git checkout 518881a8b5e6a2446cef379b54c9fb5d6bd754f4
...
git checkout 550fa32d5805eeeb2c6e17a1d75ebea5a2d8ccc0
...
git checkout dfd2780c2b48d2b927fd0a4bd5b1058f839a3edb

cd $ANDROID_BUILD_TOP/kernel/oneplus/msm8996/
git checkout 069a9ee29ae243881c0b31b222f8ad329f6bcf2c

cd $ANDROID_BUILD_TOP/kernel/samsung/d2/
git checkout 5e1bc6902f7a1de1a647a5c623fd4dad98a4e5a1
...
git checkout aeb9d3a5b42cd981af4c2a0b8651cef2325422ff
...
git checkout 911559f9b307be548b8b0d086246d40c817aac66

cd $ANDROID_BUILD_TOP/kernel/zte/msm8996/
git checkout 9248fac8908d4a8ac824a23390befbd6fae231a6
...
git checkout ae9c1c4ea5665bf796a1db32b35c6e8c7360abfd
...
git checkout 97f5e594fbe3f2e2853d0aae4220c73ca5f883dd
...
git checkout c129b6ce20e055b0c7be9d6bff30b3bf1affe470

cd $ANDROID_BUILD_TOP/packages/apps/CMBugReport/
git checkout 1c87436a722de9e12ed754a345bb832ffa6fd2a1

cd $ANDROID_BUILD_TOP/packages/apps/CMParts/
git checkout 4cbdbe7f297953858ce667bb3f9f811165388263

cd $ANDROID_BUILD_TOP/packages/apps/Calendar/
git checkout edb28f5239787b90a792f3a96ab670a9bd7bd4a4

cd $ANDROID_BUILD_TOP/packages/apps/Camera2/
git checkout 867064c06291ad6f93d6354187121dbc0a414730
...
git checkout d5411182421ff5771905fec6f936cd267c01ae07
...
git checkout a1bf0fbf7958c980c6112ae3a4833c9ebbb88c8a

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout 7c3fe77c44908ec876629d9a0478d13557f076ba
...
git checkout 33a443d546ef9f97f0957cd31db41a70882b9e8a

cd $ANDROID_BUILD_TOP/packages/apps/Dialer/
git checkout 66fb95311e2acc43bb1f5aa4c460346b0290ecd0

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout 153a2a1437ba8c6a1ac8fbaa5fa24926f05ef702

cd $ANDROID_BUILD_TOP/packages/apps/Email/
git checkout c44eaf097989ccb76fb160c176f642ce38f6dc91

cd $ANDROID_BUILD_TOP/packages/apps/EmergencyInfo/
git checkout de00e09b8263d8cdd6e2bd1de28cef355f558ba1
...
git checkout b17bee6d994e6bbfd157f4250af0de96a31f27e5
...
git checkout 6a766909e4fce90407522b9f7dd192e21be434af

cd $ANDROID_BUILD_TOP/packages/apps/Gallery2/
git checkout 50cdda79a0ea6c5c7d8700f8d8221dba28ebd1cc
...
git checkout f8793e82f6f3cd2dc2fd0cc6a9e94f28e336f312
...
git checkout c6d8d03287377462df93c3b75361db40acb02390

cd $ANDROID_BUILD_TOP/packages/apps/ManagedProvisioning/
git checkout 886e7ceae84fc0caac46167a138180d4f0cd1934

cd $ANDROID_BUILD_TOP/packages/apps/Messaging/
git checkout ec0369358d04e2c25bc4f9f69cc90194b1b25789
...
git checkout 8a2c7febbc32c9c404c88fe15b713709f9dbf0e4
...
git checkout ff20ad42d5bd42f5cb276119e4c29171a2eec782

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout 0eed7503d2e3afeefccc0b753167a1a273605cb2
...
git checkout 25ee4c574bb11874f7c2607429857e503c333d8b
...
git checkout 4e5fd56f9d641661be15a732e0adbca97b84127d
...
git checkout dcc2f12ae02e119a5ef9c8241b4c1d40917d035e
...
git checkout 213a2caa1b52e829549edc21499bc9fd308b3ae9

cd $ANDROID_BUILD_TOP/packages/apps/UnifiedEmail/
git checkout 12b89061f1d0ff7a615b7f808bbbb643afb1b8d2
...
git checkout 1891d5d13b0dba99ed4f1842eaf9f7d8f437a375
...
git checkout 0bfe0b616f8f12706897666241b257a73ab8ea6a
...
git checkout 581eab3e713f9a7454d2b3464420dd92a9e0bf41
...
git checkout 34a12f1a9dac9491feaf6b1c606fdb3ef0d00089
...
git checkout 5f8e16d7befd5fdadcbff69c4eb94edd64b18a28

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout 4fdd8d824c8f8e1fbac91e2f925e02d05d745ee6
...
git checkout b1f27993cf98fbcff59fdce501e18c0e2e023283
...
git checkout 562be181e1a459ca5d419d60f176bc17ab74a6b9
...
git checkout 80cca318ae3474691e1885ac2cbe32c26444740c
...
git checkout b2d5c79be85102296325e77d757d7aa6e0bbf805
...
git checkout 86bf0bd51b1e2bfe5666341b58d892dbc544aa21
...
git checkout 656b9c4fefbf5d85d5b477e79b5a21707f8fc864
...
git checkout e025aed765e94d66ed4df157d97f1e1562ff4412

cd $ANDROID_BUILD_TOP/vendor/motorola/
git checkout 0c91324bc2f74f5e584e06fcf4daaeaa6fbf4cbd
...
git checkout efdb0a62b47f86764aae0cbab76dd58eda3f8707
...
git checkout 353fbc338dd26943b047ec1a094cec7cac0aa651

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 8c29fefa38ee81b5d80e717be7a42592a3b04f1a

cd $ANDROID_BUILD_TOP/vendor/to/product/
git checkout 8087a16d316f8d413d773ef64a33f6da2df83265
...
git checkout 65cc3e6afe8d9751cbb4738b24a0bb5c769e7692
