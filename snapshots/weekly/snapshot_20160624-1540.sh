...
#
# Time of this snapshot: 20160624-1540
#
...
git checkout 26069ffe1c6f06a630c1cd06e20f8af815fdb8da
...
git checkout d7272bca4c05a6ca306ed49c175321b159c5527e
...
git checkout c30fa579d9a83864186eabd4a281a2b6273aad33

cd $ANDROID_BUILD_TOP/device/qcom/common/
git checkout e1dbc22b31d69c2557551f96e69ab22bd47b16a1

cd $ANDROID_BUILD_TOP/device/qcom/sepolicy/
git checkout 2805e633b490c37d0284e8beaf8a6a2c4ad9272b
...
git checkout 663c7de95ddf710754c6caf8e0e8656bab2c2a2c
...
git checkout f13de0faf389a74b7a9881b4603ace41d6cb008c
...
git checkout 88db18ef62513cd7d9199cbb28b3ee3a169d143a
...
git checkout d7e7ece4a0ca6ed5eba18f3451ffe2db18afdfdf
...
git checkout 36aec39a52e9bbf9100e909e2b8f5583d5adac3f
...
git checkout 00cd10b11d1123bd4aee1f8845a11e7d0b662bcc
...
git checkout 8fed12de2c471c04c11d6a4b5f65bc06f1aef8a0
...
git checkout 7223f7033c774a5cf9cf885edaf36f906fa83d5a
...
git checkout 00ae48abce9581983c50dfd72116348bad4f34e5
...
git checkout a907708c19a2a333fdcc7ac425f12694e4e98694
...
git checkout 4da63b534eecadab856bf4e39d74aa208798dca1
...
git checkout 9fc0dae9fa225463383ff28454d706c65bc28041
...
git checkout 9af90965d9332fd204891d569c6c616f14246752
...
git checkout 932b0cc7b50f962e637a60aab1d0d82d2cf64e36
...
git checkout 9986c0dec9c682f2adaa023dfb1845ed91431fb3
...
git checkout 6115331cf74fa1d40ba7d2dd6c6c6498a8fc16cb
...
git checkout 441d92ca3b9ad7639d665ad9cd17da3fcb8055fa

cd $ANDROID_BUILD_TOP/packages/apps/SetupWizard/
git checkout b62056b3545aabc66071a46b43cc0a578ef5f8f5
...
git checkout cd37b99feab5851b4d3cf155c9a54c3f6ffca164

cd $ANDROID_BUILD_TOP/packages/apps/SoundRecorder/
git checkout d22f0a1a7b3f8015a5e5f183662197225204349c
...
git checkout 6cfca71787e1267c1fa9a7c921fa18fdf960bfc4
...
git checkout 884ca0dedc7d1130bb8f5fb0963e082bac6b7bf8
...
git checkout 260c7dc670b4d5ae58f0b1c4cfbee158397da090
...
git checkout c8df0f0bde3db5701871dcd62161dac40fb9da73
...
git checkout e027f686a677bb335ec6a3d7cbcd492b01e03c48
...
git checkout 4389f87c0dcf035475dfa695f0f3c9968e4a820c
...
git checkout dda0deb64cabaf73b2258e0f1090260e6c51a14c
...
git checkout 9facaa7dd59f42ae47ea2b244895498d938948ee
...
git checkout f2898b6585338ff0ed104b12b0affd8555307e93

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 3245fa5723451e3dbc71890074ffba9a09560260
