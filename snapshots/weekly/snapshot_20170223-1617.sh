...
#
# Time of this snapshot: 20170223-1617
#
...
git checkout ed00bb159a0ba00eae8386de40914ecbd06eebde
...
git checkout c4441e23da776bbbc12b5856e2ec2c22c79d9db0
...
git checkout 2f412a443011ad7e19a3d2c9cf0cd1a73ae1a344
...
git checkout cf5d457b6e91bb571cf57d7bc40c36e5946f8794
...
git checkout a3daed9933fa1529bfe6e8b238a216e15d0140be

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout 579b5a8200fbf2ca6aa0b580c5e36724da1768db
...
git checkout 5eda55f20adda211d96359cace7a9a9d8bbfa8ea
...
git checkout 5159a963583acd22a458165715f44aa439091435
...
git checkout b22a958486a38a149161cd4f6d2f85a3b40036c6
...
git checkout e40fc05ece3853c62bc90424307207e8423a7eb7
...
git checkout eb3c609d0346aadae444e513b6319f0d825efb32

cd $ANDROID_BUILD_TOP/packages/apps/CMParts/
git checkout 8ff1388b21e50bb0ebb1ae3bc25ae3a7891d7609

cd $ANDROID_BUILD_TOP/packages/apps/Calendar/
git checkout d4d47fff17a055acc02fcb1c9b6ea2070d0d4545
...
git checkout 08117b81553b1b2e2090ce1ed59676e15d50599f
...
git checkout 77959051eb1ddf2e3cd8461d9e8f5c2c1b02c9ba

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout 3490e6c08cbda1f811518d33d91f3d7826e755a9
...
git checkout c0c6e3bc319fe600e964fc7809119e3d75d5b236
...
git checkout bc9f7818edecde0dbda5b8914b9ca0c04b6f512b
...
git checkout 26ae64dd8388015b6a9951eff5e870faefe12bbe
...
git checkout 9b6af0a9196d30542c5897e09b33a52fb52f9d78
...
git checkout 2992e3fa564e6d9467b18dd1e7fd9bae1d1ce688
...
git checkout 3d92b8504a703b83383f9eb166cfb50dfa724b0e
...
git checkout f293d0393371ee1ce27a716c114da3217754e55a

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout b2f33fadfdcfb6cbe76d8e644dc0f145b02144b7
...
git checkout 72900fa5400651ba212cca2a1e4d8b57f66623c7
...
git checkout b9788554f7bdb7a02f1fa9691f0697d236d50fc5
...
git checkout e84d46c518554a77e806c61578a9de9b7ee022ea

cd $ANDROID_BUILD_TOP/packages/resources/devicesettings/
git checkout 1e11ba5f42fe7390a6d5e2c758b0e314c5a4b5e7
...
git checkout 83729e0b49c050c49d0e10a1d1769df1302ce822
...
git checkout 01c3940cdf562709e3a6dcc9f70f8545ff14ce50
...
git checkout e541b2f6ff447ff5f8237951f8134112951f2bd2

cd $ANDROID_BUILD_TOP/packages/services/ThemeManagerService/
git checkout 32b32a443129fb1f25d4ad8bca272455ca021515

cd $ANDROID_BUILD_TOP/packages/services/WeatherService/
git checkout 6b4875ac16bd173e4164682b254fa53e195b9d74
...
git checkout 070fdb759170816233d55e5f36dcc68e41afd163
...
git checkout 7e1dd7c05f7a3e8ffb39e8564b8a989e34dc9976

cd $ANDROID_BUILD_TOP/vendor/cmsdk/samples/weatherproviderservice/YahooWeatherProvider/
git checkout 2badf2fe82a6e56bfb18e67b83aa9bedd8780c02
...
git checkout a98cea4e4285858fc86146546857e708d6a02feb
...
git checkout 2966112efb769805e3de827af96bfa11dd3b3418

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout fa5d9fd4058ec33bcf4e6b249bf8add089833ae0

cd $ANDROID_BUILD_TOP/vendor/to/product/
git checkout 8cb8f1180064180f36218e7b0c863367d3dea493
