...
#
# Time of this snapshot: 20170628-1244
#
...
git checkout 6a3f34a65b3abb3a08d66b53216d18ff84fad7c4
...
git checkout 60f2b4b77616e857dd9b105b6cc5d10f477b044a
...
git checkout 7bf79051855750b5d7f81e30d63da78de4c1a0b9
...
git checkout 4c2e39ecf08b15932f455e7a8a67502cc54d26fb
...
git checkout d462ad5c138ad461bd7288f4db61c7543732db8e
...
git checkout ff84dccd1caf571bcce2c9d31d08935b684b7443
...
git checkout cec8962646009989bf37a147e45f33f7d8a03352
...
git checkout ebf9e978fac4c50c274f6e68a539d141407b96e7
...
git checkout 1d1ccb2a88eb8017126cbfeca71654b8495ca21c

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout 44657431e50f6ca700c70ad92081d0686178df31

cd $ANDROID_BUILD_TOP/packages/apps/CustomTiles/
git checkout 560ef4061f3700f0f9824b7b0320cd82fd0a659b
...
git checkout 9edf96755b0ef3936ad94a457df8cdc1dd380317

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout 38c5aea32136fd98194224c3f436905cf50b24fb
...
git checkout f45c2bfbefac543cff374b67110232d0b42f9bce

cd $ANDROID_BUILD_TOP/packages/apps/Gallery2/
git checkout e988d6ab7b28cc5536df5a5aec3d65b8be145c5c
...
git checkout 9a5fcdd9e54d4fa21e3564fedbfee90d9e4ce4f2
...
git checkout b41c0d7f2a26544e03876687b28349b741d44dda
...
git checkout 2503db514bdeb9ce012633833a55474d2fbbc611
...
git checkout 67d5b07bc7ca4aa0a79b711fc783c29e1d3055ae
...
git checkout 1171a27a0037b8f6b7a6d63964794fe015b52f12

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout 7e76c83a44e2acc1d96aecf4703f8f1efe050d6e
...
git checkout a2a05d2fedaa5c0abb8d06aea7ba7370cbbdf105
...
git checkout 75498f74a173a391a9f5f6985abea866a0324290
...
git checkout a55be958315a3ebea519779d0e7bbc8f182a76ec
...
git checkout 164634bf964dc9bffedd903c41664c244be383fa
...
git checkout 37e893a130393530f9d276819956879cd8eee12a

cd $ANDROID_BUILD_TOP/vendor/cmsdk/samples/weatherproviderservice/YahooWeatherProvider/
git checkout dd1766a55f56e1b3299fc7edf061eae4bf97fd58
...
git checkout 7ea4a2e0541761682b2c8db482e9943cb06e901a

cd $ANDROID_BUILD_TOP/vendor/motorola/cedric/
git checkout fe65ddaa7eac500b740864c044cb74a0d275f383
...
git checkout 13e36de059d4bd7f7534637a7230513debda272f

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 04155673ff5c9567ef34f7660b2d83c5d837eef5
