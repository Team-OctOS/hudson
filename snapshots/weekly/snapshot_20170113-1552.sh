...
#
# Time of this snapshot: 20170113-1552
#
...
git checkout 46164c603d15dda7176ed6cfd7f773e3ac6fb586
...
git checkout 008e952a197b1fd4943ec252ebc629ce04db8bd3

cd $ANDROID_BUILD_TOP/device/oneplus/oneplus3/
git checkout 136bea960610667945d0144032ce45c4cfd8cf85
...
git checkout f666741efc92da71b62d78de98af77f8fd73e935
...
git checkout 68b26bbf96c8e85c0ff800d3771016337b072721
...
git checkout c0929488fad02fb46d445bc123056897e18d249a

cd $ANDROID_BUILD_TOP/device/samsung/msm8930-common/
git checkout b2683cadd35e23aaa1caa5b1d124fe0530c1b803
...
git checkout 8cd28f3bce5612d35c4b6196554c7e2846057310

cd $ANDROID_BUILD_TOP/device/samsung/serrano-common/
git checkout 06f2d1a968bfc7cc1a415b8e0057b35194d8cb79
...
git checkout 6fb0d7cdb68143dad5d50c04ecd3364da9936468
...
git checkout 2eab42c9cd8fd96ce29e88e3ebd6bb02b3609acb
...
git checkout 28bf1cc9195121add79e88f2f8a811786701b9a9
...
git checkout e1f122f12d50c399aff83162a8b0369680253489

cd $ANDROID_BUILD_TOP/kernel/oneplus/msm8996/
git checkout 0102613a5fd261d182c4b6315139942d79119093
...
git checkout 1aed39902c65e043a3a97534f1488c39f3e17ce8

cd $ANDROID_BUILD_TOP/kernel/samsung/msm8930-common/
git checkout ba797be45f18d48c341968ee788879ecd95c96e6
...
git checkout 1416d0d45aa5c9e4146199d17a8834682c627b02
...
git checkout ace0b5b751d1b3c1d7580d9d81ce91ad0f841e42
...
git checkout 5d962bc602134a67ed37c5850745336b56e5252c
...
git checkout 20a0311f1a3769b99d22e089efc37d0e660c529e
...
git checkout 6f5e579bef4b1fe7ca320947610171030c666540

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout 69b66d262465a1551d06f5d0c320370fbd98f411
...
git checkout 42da7d4fed6d6bbbdab19f615e6dfd0d549ba4cf
...
git checkout ebdfcc3ad4f47c251582f9a9288f661cf4470224
...
git checkout f47cacde5040cb2160ab3dd48a0f6984139c6042
...
git checkout 696bc6ade2ccb67bcab1535e2891e91729578e66
...
git checkout dde8facb6f4389852839cf90dc59a967ea7c10a4
...
git checkout d834dd7d25fd88b7d14a5c69c5ec6e6f6a08fa38
...
git checkout 6eec9b305f0849240c5850abd91df88bd1b549c1
