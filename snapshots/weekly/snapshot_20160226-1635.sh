...
#
# Time of this snapshot: 20160226-1635
#
...
git checkout 02b1d48d51ffed14442390c80e773f3ac89396ff

cd $ANDROID_BUILD_TOP/bootable/recovery/
git checkout d66f66eb72fc72c17d1a292cfbeaf2ec08721327

cd $ANDROID_BUILD_TOP/build/
git checkout e6a46f802d3865e8219fdfc03a5ceb2dea64aeed
...
git checkout 83fd4f19fd8ca528c78747abb92aece07ae07a09
...
git checkout 5ef0d4125c4a614591d06b6e734a2ca4312f4981
...
git checkout b3fde2dd7032bc838fc7ecc25499506b8f4413ee
...
git checkout 32e5c387d32882012f775566e166fd468ef8743c
...
git checkout c5fa90a809c9e7a98e32373a4dea6b3e46a0e92c

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout 45ac3df877ce33d5beaa3f76cfe86b71b1e230b8
...
git checkout b0cda680c2aaa3cbc0ae080c51f8c21a3e93adb0
...
git checkout 464a80ef8bb5c971c22282ae7de18da696cd110a
...
git checkout 41fd9b0b64988ff1a23f5db8026313c3425c2141

cd $ANDROID_BUILD_TOP/hardware/qcom/audio-caf/msm8994/
git checkout 24c39c0d3734f99d8cf5ea4b925908e5303dd538
...
git checkout 9fa4c99a9644ee2678c20812f576a76baad57872
...
git checkout 8346ecd73ec03891c4f287cae4b8c7d8166e404d

cd $ANDROID_BUILD_TOP/hardware/qcom/media-caf/msm8996/
git checkout 63166051c5711bb4f30d2815ae947ac0a6676979
...
git checkout 1f58ecac5e8781a5c1097d56316c988a525a5108
...
git checkout 63489bea04df98a191f4a528ceb646fbbffa36c4
...
git checkout a9df64608d3c6b935cca5039004f559f605e67e1
...
git checkout 4146cd3983e61926bd44b950307d1bee6cd6f774

cd $ANDROID_BUILD_TOP/packages/apps/BluetoothExt/
git checkout 78b36b107858f3cae0e09ff2afb0d3afa69d4968
...
git checkout 706c0f82bbc966907c7c9aa5448e2a616fba763a
...
git checkout 13a402ec86fdd11fc8eb86be83c6dbdf0c901c0a

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout 38d016c81fcb94fbc523490e736d7de032c09bca
...
git checkout b2381ef710b52c0685def300b8c9140c780881f5

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout 640067b0c7089036f3063cd1435d10fc44ecc415
...
git checkout c4799b40c4b83274d13f152d403bbb160fae8ede
...
git checkout d560be6b8559d96271f172bbcaf2229671c79541
...
git checkout 60ba9b62ac79f6cf5443b0a8cb6a71cf1b66dd12
...
git checkout 51ac86bd5cff9ed412a14e15b117f4ef91282cea
...
git checkout 7f49ab53672dacb2650e846fb3588908eeb5f47c

cd $ANDROID_BUILD_TOP/packages/apps/Profiles/
git checkout 9d7bfc36d5d6684910196f232ebe5504cde4d980
...
git checkout 2fc265b534f7cd83c5c7b7e8e33c8262f45d8476

cd $ANDROID_BUILD_TOP/packages/apps/Settings/
git checkout e60f6bb3dc4847c24b3812e9b2aa8380b01da83b

cd $ANDROID_BUILD_TOP/packages/apps/SetupWizard/
git checkout 01e57cdf28511c93c7c3f39505689aba03be5791
...
git checkout 1d957349aa4a487572af492cde85d2f7cea5204f

cd $ANDROID_BUILD_TOP/packages/apps/SoundRecorder/
git checkout ae8048271b4c000b95c3b80edc71a7ca5a6cd7f9
...
git checkout 6a06140b1a42bdfbd408e89332df0e9b2b9d4e7f
...
git checkout 8c1cd30cea634b6bda394cfbf0047853f7e8201c
...
git checkout c9f3201ded82b0c6d2e76342888ca8e80a072a25
...
git checkout a163818d70f14ec08766aa1bfbeee770ed7a4ef1
...
git checkout 74cdb9e934f494a6f747b2a712ec7f664f30fb82
...
git checkout c35dc89acffcb7cddc1942b684d8a90fd1abb73f

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout 0b3b6e9dfaf20f6219ac17d8f64a1a62ebe78336
...
git checkout 5db0f54e83ff3e399539aea0a985248dcb4e9317

cd $ANDROID_BUILD_TOP/system/core/
git checkout f81fd9a408d3c5d10dcb9fee12612e1672c574dc
...
git checkout 73ed08e3393ec6bc2597ec5d7980694c086be23b
...
git checkout 5ce397c1aacd9d091d170e0d7a44d249040d7ba3

cd $ANDROID_BUILD_TOP/vendor/motorola/
git checkout c52503e37022efa27eb191fa2719ed28f861018f
...
git checkout bb24bea5d259271fe269c4f4902c1dc5312598ae

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 168fe23f23b0ddf6ce31a54493468db76794aaa5
