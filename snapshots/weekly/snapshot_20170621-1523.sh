...
#
# Time of this snapshot: 20170621-1523
#
...
git checkout a1145cc684c449d7c75f7ffade22843221ce3b2d
...
git checkout 8d13f7061fffc5d42bf4a479278f3dc606adea54

cd $ANDROID_BUILD_TOP/device/lenovo/a6000/
git checkout 3de6e2390e1e45c37d8b967fc6a1523740063f97
...
git checkout 96602ebb494d998f5c5cd982282039d029313735
...
git checkout 8e94f7b8d233a195c7e93f9c4e46259fba507e12
...
git checkout 15e22cdd7490b730091981c5895264f682ec96a8
...
git checkout 49aabf84c9ba94ec2195b42383cf85b05818340e
...
git checkout 4f8222cccca46d05539aee409f2c0135d8391541
...
git checkout 4f754eb0bb0d1488b1e093dee6404eab6a7ffe59
...
git checkout 421306ea9026ca32157aaee1c7739ccd372c6943
...
git checkout e95e9c31a11cdbaba5589190d8cd9cd4099a4fea
...
git checkout 173832901f1a100b6f799826ce1301263021a5c7
...
git checkout cb597d4cf6095d3f04681f10a3c0eb6e1c23a66e
...
git checkout c4cbef8e0825fedf564832b36acf9c2eefca424c
...
git checkout 59ed959aeb1650ca56cd58c4255ae1c16bfb78ea
...
git checkout 176451ccf93ecfcf590d0a05e7fae403dad22d6e

cd $ANDROID_BUILD_TOP/kernel/oneplus/msm8994/
git checkout d86d5763e6121bd2299d26d1c2d35f939b4a324c
...
git checkout 700dc7751b7789f5605fab77b8a4e4acc50e91d2

cd $ANDROID_BUILD_TOP/kernel/samsung/smdk4412/
git checkout a1d94e9230acc394dedc083ae6d81c39c5389443

cd $ANDROID_BUILD_TOP/kernel/wingtech/msm8916/
git checkout 017a32dfcbf65cc9043e88a827a74f7e208d956e
...
git checkout 4684700294af55f8363cb150e92b7c46386d614a
...
git checkout 4690835b6b071d7145a9597e5af5009f816bf05c
...
git checkout 5d38fd6f7d94212ac54c56243314f0e564862c3a
...
git checkout 89fce76f528449f42abfc5280d994838c9b44d7a
...
git checkout 6665277cd168faf1af10c9db806e73db4f700bea
...
git checkout 93bcb4cd8a0a7f27b58bd4e73fc647c5ef517798
...
git checkout 22cb5657c457d665d4d6afb4f60a7f59edacc69b
...
git checkout 718f9da3b8a198757812116859e8cfb885581a44

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout 0f83363c62dc02a3e350f0ee7e1b63438bccc324
...
git checkout 5856a606d1fe2fce934328e8548231c3d7aa6ce7
...
git checkout 5b272921dff3307dd9cd1dd0c765fd08eb7d5d80
...
git checkout d5f9aa35e7631f7e40a070720aa1e6baabfe4a04
...
git checkout 5f33cd5207f1ed5977feee9caee92c3c8da217c0
...
git checkout 3e9b1c1745bb8c37999fc4a956ef7cd8d3520ab7

cd $ANDROID_BUILD_TOP/vendor/cmsdk/samples/weatherproviderservice/YahooWeatherProvider/
git checkout bf4c5a3f9477cbf54ee691303d1ba9b7344cc24f
...
git checkout cbd6456407391e0ba97e20bf9ef45d9ce3bdc731

cd $ANDROID_BUILD_TOP/vendor/motorola/
git checkout 0af25d2f0db766a5e3436422f48d41f88c9220d0

cd $ANDROID_BUILD_TOP/vendor/motorola/cedric/
git checkout b8d07ebb4608aac5bf88dbd7bd1d1e657cb1b84e
...
git checkout d2fcc8db9d415f5c0304bc0b0287679cdd1b0654

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout dc65368fdf2f63942e93c3eb20812de100d57edd

cd $ANDROID_BUILD_TOP/vendor/to/product/
git checkout f9c44e0b837b938ae2736ff8b18c79208cd4f888

cd $ANDROID_BUILD_TOP/vendor/wingtech/
git checkout 6eb2309fbfdaea14c969a64e77a6550342e311f4
