...
git checkout f61ad66985ffd3813ed44daeb0613e80ab25aec5
...
git checkout 864f63432a94f100b29dd0ff5e6d941f362acbc5
...
git checkout d1715020ee05f4bad2febbe7b08d2215e66c2b82
...
git checkout 9e1a0c956be4b4b4c3d0708cb33aa8f75cffd5a3
...
git checkout 841aa96d08d712c523c3cedf91674fabfbb59f24
...
git checkout 40898770dd66b011b0a7653e1cd5750f176be038
...
git checkout 5db4a07ff7d7fc64d43fb927808c2d6378b5cd97
...
git checkout d81a0a3b062b8504b6780edc4ddc80e08c907c99
...
git checkout cfc1fe0efb6c9ae5f8e3b8b7429a8434c5a3fb25
...
git checkout 6daeff9f494cb4d0d0efabf7637c5fcba5e28b7e
...
git checkout acfd3ea60e8e2c16258cc356ee9c2dd81d0f5591
...
git checkout 795fa068c74085a839e82eb96b51871274218f0f
...
git checkout 8c8e728c0657d90731ebd115d33772b75903c039
...
git checkout 5eedbe9b7f897e4d4eae390848c951776c648144
...
git checkout ad0c195c0ba011b7e811a3e518c91fc711952f84
...
git checkout c642120011d2cc2aaa4c39df128f9507bc1b3e2e
...
git checkout 0ce06eb24b82e61b7cedc6e882a41296f9209159

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout f68cddc15c628574322d56d02653983dad2bc62e
...
git checkout ea38cbf38f8fa3c8308e901a790d8950639443b9

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout 031246dd31cf4794241aabaa36c9f1c22f96bc51
...
git checkout 986a46ca213ce73f8cf6a31377893d542f19e910
...
git checkout bf263b001375d1de989182edcc312b641f37d7be
...
git checkout ae7c9cd09fc6ce6b205a0d7cee58f83a4a0da093
