...
#
# Time of this snapshot: 20161104-1950
#
...
git checkout 4b1323db99f9c7aa44f041930d34ee4d11b95ef6

cd $ANDROID_BUILD_TOP/bionic/
git checkout dabdd30cca8e94f9711801716e79741a0c978993

cd $ANDROID_BUILD_TOP/bootable/recovery/
git checkout 461ed46ccf68c0f52992667c26a1410c1762f94b

cd $ANDROID_BUILD_TOP/build/
git checkout 13c0db5090bfde16cecaf25e5f9eed655b2057ae
...
git checkout 81098b7776b5719ed34a35428308aa8cbf8b951d
...
git checkout 74685648048591aeba389180ff47a2edca8b4d4b

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout 9e25c6d501104f4af40c5c28dbb6554eac38e2f7
...
git checkout 926c9690406cb3f52902753a59ed94567b8c4f4a
...
git checkout 8590a9440bbef5c7b70a9e59ea7a37451884d17b
...
git checkout 4fb8f921aaeb90bd234103deccee9c654f15f4c5
...
git checkout 56a2d4e565bcab3d516d3fc44df5de749e3421eb
...
git checkout 05a2077fbdfd0874ad9f08f4a87255b5594d8282
...
git checkout 05008f72f945b5463b9a8a6f6e73be7fb9e670b1

cd $ANDROID_BUILD_TOP/hardware/qcom/gps/
git checkout b7e3cc97d6ce892c3dfeebb55c3c4b7101ba63ff

cd $ANDROID_BUILD_TOP/hardware/qcom/keymaster/
git checkout ec6c129ca948a88b42dde8f60bf6f0b4d746adf9

cd $ANDROID_BUILD_TOP/hardware/qcom/media/
git checkout c834124049adbe89fc306c6ec0a2b5b80932b270
...
git checkout 52aba20ecda16405fb71e86d41f84db830af33a0
...
git checkout fa4355f655d02b077810b3141739a5b49b489273
...
git checkout eb73b41b8d3e960372c8b03efadab39987097286
...
git checkout 7490cc57f746331dd890730aab2128f784f861b5
...
git checkout 5ba0eaf76d8c1cf861e14ea09904372304ec27c9
...
git checkout cc38184de329eac60241c563b0759e78d13a9e66
...
git checkout 789207b6134f0b3db799e7b677d957289690119c
...
git checkout a0cbcf8be808d0204ce4f42ba23452bf6134ad16
...
git checkout 204f49cd772b6c0cb8a66b0f38bf56eeb6606653
...
git checkout aab5cd7687c249cbb744e667f238aeb9cce80f2e

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 739c72abcb1fbfe2ec93b04233fd533fd7bfe854
