...
#
# Time of this snapshot: 20160102-0346
#
...
git checkout 875ffee6f23971466f3655a9e1e73ba6a1dc0393

cd $ANDROID_BUILD_TOP/bionic/
git checkout 51ad57b30d5cb808bca20e0a6d25139435069283

cd $ANDROID_BUILD_TOP/bootable/recovery/
git checkout 3010668acc5282de04be11541dab88eaa56683e6

cd $ANDROID_BUILD_TOP/build/
git checkout f502efc2d96a33c44bf3f3c1b105a19d5c60f8d0
...
git checkout 23936f4ae0261c36d1ac79c8991e786c5d52b99e
...
git checkout d795ff011a9fb4835faa3c14568d6cbf6362adaf
...
git checkout 89d4bc77253f8fb262489132f93128a25c8967fe
...
git checkout c771ff238dd21afe55eb7f837733eb0ecf4800a1
...
git checkout bd844ee3f2d4e991ab9aa72fac717bb397219e0a
...
git checkout 3f42617c5596c7d26a8c09e7c148842f2f657269
...
git checkout 49f9b96255588932ee6d0c33e4c546d7475e5898
...
git checkout 6bb7e47aa7324bb7e80ab12bf7a1de49884ff208
...
git checkout e13ea55991d22e547b57a420daf4c5c9c71c80e9
...
git checkout 0f882f6661334f22e03f69a9b8f0ce2830aaca80
...
git checkout dc3f47033d31bbda63917e1cefa839aeccc047e8
...
git checkout c39941d529da893a8581ec55e004a7ce44ef3237

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout d9a0e31224b54d524f8bcde50cf6776d75533d78
...
git checkout 4055ec7d38073b5cf93864ba25e6f12cb8720917
...
git checkout b17c928090764a0bdefefa17ae31326e02b55d62
...
git checkout 158e9fd7ea3e04e0b855e09716f83be4de0cef82
...
git checkout 8b0fc72a293ded57f3aabd4aefba2540fa92b723
...
git checkout 767cc4e01cdf6ae1fa290a45b874b179061648c9
...
git checkout 18396d486dfc07119706370f6e3256bc6de88d30
...
git checkout 93979ccf5e66634b3b0ccb0a621f50da45ee72e0
...
git checkout 2d84ec706d3bf3a99dd8cf19248ceefd5e63df84
...
git checkout ecf9478f2a22b952c0763c94d2f6b527ad4fc302
...
git checkout ef9af05db59d198e76d735fcbb787813bcbf1ad4
...
git checkout b8400a23f559563a5b652dfc88bd951cd6a2e7ae

cd $ANDROID_BUILD_TOP/hardware/samsung_slsi/exynos5/
git checkout bb99f0edf0273f061bbd9ca7765a727b2ccaab64
...
git checkout 1905f15c8ecfdab8e053a684aa9093e66421cd58
...
git checkout ecb21fb1ad24e532aea7f4e12501e172540322d9
...
git checkout ad614da6fd8a6c85ac98bd27d92e2801098e2bf6
...
git checkout 960b8502623d7b1ec5e089ae70675ded37d9e688
...
git checkout 811f84370c21cc3dfeb6785a86b8cd6c3581aaa3

cd $ANDROID_BUILD_TOP/packages/apps/Dialer/
git checkout 3edb6490bc4757d5fdac3e37a75e3bd22173f82f

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout 281ddcba41e4138a65bc7f433b0b25487be52e73
...
git checkout 9000d115a8c23d81711cf4b22e5d6373c32edfad
...
git checkout c756ca4a761f735885c9903c701583844d7cc969

cd $ANDROID_BUILD_TOP/packages/apps/SetupWizard/
git checkout 8c472fc564e78afacc46bb2ebbe7fae335fe5688
...
git checkout b6618aeb0db349313d018840034f2e414530f403
...
git checkout 4c26e4ea87eaf1420c3b343953ac0fc7794a67b9
...
git checkout 8562735d8910d23523fb79eabd2f66354835776f

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout e85077267af27b5e92532049580d1e09dca80137
...
git checkout bc32aeb1d4e9797cf2ba8d305a30f5cda68e967d

cd $ANDROID_BUILD_TOP/system/core/
git checkout f517c972b04902a5afbeaa1cc84490afd25f22aa

cd $ANDROID_BUILD_TOP/system/extras/
git checkout 476c59b685b6e76486c2622bc7a60c585af8142e
...
git checkout 3b01dda6d0201e63b05db231e7746e1118eb4fae
...
git checkout 844020d93d2bdfc295ac7d472f533f239eae149e
...
git checkout dac05cd3c3888a110dbfc6ff7975aef1ee0cd2c1

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 5b230011744f82057268a3970a9d7e76ccc476d3
