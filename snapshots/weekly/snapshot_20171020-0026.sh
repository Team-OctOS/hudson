...
#
# Time of this snapshot: 20171020-0026
#
...
git checkout 120ea4e28b7f560e464a38648ae4da97a313d1e1
...
git checkout b46ad9571455a560714acccaa29c72febc6b6d0e
...
git checkout 2b25ce781ee984da622c1c774c7cd03f8880bdfa

cd $ANDROID_BUILD_TOP/device/lge/hammerhead/
git checkout f126d24c55e26610ccaac25411489927316ab4dc
...
git checkout 8c461961e91d65c1aa6a2678e36e4d369508f88e

cd $ANDROID_BUILD_TOP/device/motorola/athene/
git checkout f32974d97c426027aea31eb88e81202a31b72488
...
git checkout 96615af72ebc7074d3a939c8f257a38132cfec7b
...
git checkout d8d41e95086f3a5620c8c4718e1c3f0ca62b7159
...
git checkout 783867235eba2bfd24db34c4f3c997705c3d9f93
...
git checkout 812038eb04c3efb0f0b96a91bd9335d2e3530812

cd $ANDROID_BUILD_TOP/device/xiaomi/gemini/
git checkout e1c192c095dd9621b4cf31241290124b5cb5bdc2
...
git checkout cd2a37f79a337bbfcbcc5c07bc9a4eba7450a41d
...
git checkout 2170933bdb958f45dbe9690bb2f4545bfd787be4
...
git checkout 42469df88d84f80ac4c88ddfd5a129c32b3dbb79
...
git checkout c1edfa4c27302d89a574de85e2f9292d110edbbc
...
git checkout 257864acc5ced9ccc634ca107580254bd91a8ade
...
git checkout c6e270ada02c002a47ef8dea120e5f6fb2898be2
...
git checkout 019e77c6e18faa6574432f8a0e372e5fb4bae390

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout 113f37382140b20356f2fcd8ba50ce3316b5c504
...
git checkout 440e10ab02d3248130d2f5ae08c69b7191482e2e
...
git checkout e571ca9ec7621861b7ef67c54016f83336fa1469
...
git checkout 88c036171c65e6720acfbd1d4850bebeec963aee
...
git checkout 71b070f309220be2af6316e3d48a069759b0f33d
...
git checkout 512197fc544e4521663b75aa80605844d3b35657
...
git checkout 2d2b4b07fb0426ed80db92eec8b088ea65b5805c
...
git checkout 21d80dff866c5bdf8b717a8a674a4a2fc0ba44af
...
git checkout aa98f7ab7df38c40ad294c445bdff15fae99fa2f
...
git checkout 344a19b5a852192e35337d1092900c9d925bc8f5

cd $ANDROID_BUILD_TOP/kernel/asus/msm8916/
git checkout 37b7d09bba2df7272159b369a70eaa86e9a17b9b
...
git checkout 47e5a2ecccdd65806065c1cd6e24c6ac96530a73
...
git checkout dff489b0fc1a5fae8d63a3a3361eeff44f4e2159
...
git checkout aa09ecf37ae7fbd1d0d00fd645b566c2ddd732d8

cd $ANDROID_BUILD_TOP/kernel/lge/g3/
git checkout c87b474a158b2c2f9066e636f1453e0b4a8e2cbb

cd $ANDROID_BUILD_TOP/kernel/lge/hammerhead/
git checkout c9665f7e7377654388d31d98a0d1cab92cffd296

cd $ANDROID_BUILD_TOP/kernel/moto/shamu/
git checkout 9cf07518f6a6a13bc712960a3d590ed47162f2c0
...
git checkout d5a4349bef1677abd285c816eb210852f444039a
...
git checkout bbb7a1e0911f63c4065f8f043e1a99207f3633a1
...
git checkout a39909f97905ee7371e92ba9f75982ddbb5ad220

cd $ANDROID_BUILD_TOP/kernel/samsung/msm8930-common/
git checkout 3c40aa310f511eb2b33da0d121d578eaa41ba02d
...
git checkout bd858fff68cd07196b4a945eea25943559a6d2a6
...
git checkout 342c2c8df040fcb674585eb44394b69cf2d209a9
...
git checkout 1cc2af6ff869a7783a98c57c48e73bd3dfdb9a24
...
git checkout bad97995e0f9c289c0b847a8d1b27ddd460afbad

cd $ANDROID_BUILD_TOP/packages/apps/Calendar/
git checkout 56dc4a824bcfd970b4b9717ba6b84654437dd75c
...
git checkout 4f7f030e7d2dfb36a77cba8aa59b23eb1d9f1e45
...
git checkout 947a3203486c1afbb9159aaf27883b1fd61d6be5
...
git checkout 82b6dc42e7b0d66d572193549abeb8542161b932
...
git checkout 9896cb1794b11c133d880c5a8eadac21c4e182ed
...
git checkout 0ca59490aa7a4f9dfcb3fea70c44cf4d1e3ef7c7
...
git checkout cf038be9d0f9ac2a7c9ac4031b27d8a138214b79

cd $ANDROID_BUILD_TOP/packages/apps/PhoneCommon/
git checkout c99251480c2363e1d24d89b8f9d36e3a1ca50a0e
...
git checkout 084c5a0e86bafa8d3a86f1ebd85106241d912ccc
...
git checkout 5cf4b7dab368b255dbbfc520adb17b44bf13c117

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout 50d00c0c0599c561fae7f4e00606362d06cdf065
...
git checkout 6c579a58fc9a0d731092c5dba6ce4f68b85e8fa1
...
git checkout e6525bcd165264920081cd32324dad6d209400ef

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout 21a161adfc3c0200c49cb4584c35ce482fa28fac
...
git checkout b882eee2da11673ff71193948d6b789d441d430d
...
git checkout f18ef5166accccd0042bf825101f5542fb8e3891
...
git checkout b0f1e0c9a478d4c8aa4ff5891b4be2ecf4a413dc

cd $ANDROID_BUILD_TOP/vendor/motorola/
git checkout 582f97a5f4ea43d0e1c080a6933d9c1c3bd12e62
...
git checkout a5346c8874d5186c967b74291c2055d902f7a928

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 3f1567cd26ffe4730d8313d684c5598f3fc6294e

cd $ANDROID_BUILD_TOP/vendor/to/product/
git checkout bd91f78b6c9b7ab96e9041203908c54f94aa830d
