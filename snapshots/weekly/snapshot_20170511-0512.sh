...
#
# Time of this snapshot: 20170511-0512
#
...
git checkout 6a000d0032e990d6b52dbfdca6a1a91a3996b098
...
git checkout d14260fd2bf295a50133ecfc1ca51aeefda84167
...
git checkout de81909d28cab15aaa2ea7dcea4b3927042a0f83
...
git checkout 7c70e761a831900fd938f81be70797e21b492cec
...
git checkout 74878b682ba4ab3e6749f0257826891edb45ac16
...
git checkout dff3be71cd330a9363a240a82aa73be9c6be0cd1

cd $ANDROID_BUILD_TOP/device/xiaomi/msm8956-common/
git checkout 400201b8493a6cb701cc58e01fe3760c2dfd4570

cd $ANDROID_BUILD_TOP/device/xiaomi/msm8996-common/
git checkout db4ba5554d134603faff6d084de3fdce062a1102
...
git checkout c0363606c905fddbf63f83b479f2ea30fdfefe09
...
git checkout 5eca5aa5657712576864e2afeb0a8ece63448d34
...
git checkout 0629cfb9ec7645396c3b7b7631e18b3d7300a208
...
git checkout 723a556d3d3ba4c9d8e75c5d4696c6a3c139fce2
...
git checkout 82aa67c5b9bd5d2a6c6f5eb4ed44b533034433fb

cd $ANDROID_BUILD_TOP/kernel/oneplus/msm8974/
git checkout d4508e462fbf0925cedf8d4f615b812e18cfc5f4
...
git checkout f37a9d57cce78f5f6311f1e387c28eefb5d0a995
...
git checkout ee296aa15c868a2d103cafa97d9063dcd7d23b56
...
git checkout 7ebf8303ff52436542b0a7d73789c76b2868fe29

cd $ANDROID_BUILD_TOP/kernel/xiaomi/msm8996/
git checkout 4e4ce7d5845f259bead46d1e19888de3e53b79d7
...
git checkout 0ebf465dd13963f9d3c34b3cef7f7a8dd830248d
...
git checkout 3c313f51b589bc1a7f669dbf50c12e9bea708317
...
git checkout 1e1e343428adabc8716c0f7e339954644d107335
...
git checkout 5f8b3e6b43adb09fb4c943287d7d97fc3d3614d7
...
git checkout 2cbd9bb0da0f41174ce3ca09e836f71c0876fef9
...
git checkout da4e4f3efda470a228a9f6e35e510e3f52337df4

cd $ANDROID_BUILD_TOP/vendor/wingtech/
git checkout 8e1a03d96fbc05bf7c3760c1fc9650136d0bf527

cd $ANDROID_BUILD_TOP/vendor/xiaomi/
git checkout 08a917c54ee9094d03dedf0fdc1982196f6faf95
