...
#
# Time of this snapshot: 20170203-1909
#
...
git checkout 105bd010991d3d81ec110942d4903f7abcbcc50c
...
git checkout a573ec2a6047ba7e8e17d3443b0642da2cda49fb
...
git checkout 75376787dbee72f4fd4abff112d7d3b4b11b7b8f

cd $ANDROID_BUILD_TOP/device/oneplus/oneplus3/
git checkout b1313761211b48395d141564891a6454b161d07a

cd $ANDROID_BUILD_TOP/device/oppo/common/
git checkout ec7ae133c797d13cef530f4a3ff6ce07d151fcc6
...
git checkout dfe53d1ddf8bb869ee5e317bb015b40bd55356b8
...
git checkout ee2d1c5ee4d6dbeb8e530b78bcbef6836e63a76c
...
git checkout 13af64d1852b1bf0c55d7548d5351f8f26a12a7b
...
git checkout dc0e4e95729bbcae85872b8e77b0ff570909caa6
...
git checkout 13267d3739544b4489648bc8590c9ae03d62d930
...
git checkout 4ee210c91d1c711a67b032a1e48b0d7aa8d40ac7
...
git checkout e450f5403adda6d23462df62a8fa5680487fc78c
...
git checkout a02172a62ba0d12b8d65854f391690c8555d0357
...
git checkout 3b643835f94a8744ed6cb0db210741cd8a7c5c73
...
git checkout 5ccaad37472a61a11113cb11fe9086f5811c95b0

cd $ANDROID_BUILD_TOP/kernel/moto/shamu/
git checkout a79b1f2b142529ff65de53414dbcb598980c18bc
...
git checkout 34dce455db58c6e47bb43674b03e8449ec77b461

cd $ANDROID_BUILD_TOP/kernel/oneplus/msm8996/
git checkout b0bdd193f08aff4500fe3141ec42a6a0138644ac

cd $ANDROID_BUILD_TOP/kernel/samsung/d2/
git checkout 729643e95fa7df42689cce040236a59edf9d811c

cd $ANDROID_BUILD_TOP/kernel/samsung/jf/
git checkout 1d8a5ba349891f6b6d4c715cc70076ddff5a1800

cd $ANDROID_BUILD_TOP/kernel/samsung/msm8930-common/
git checkout 4a3022134530aa8508716b26f7d99d17904cbe8c
...
git checkout 127224fdd978e3318460679ab86c54acfd7548a9
...
git checkout 68476c64e96e188b5a57789e9cf84e434149dc1a
...
git checkout 8fc4ad33f059c87a7f533ef4de731ac1837cbb7e

cd $ANDROID_BUILD_TOP/packages/apps/Browser/
git checkout 99f5e4c31fd0acc4ed6e85c2def0645c8ac2de5f

cd $ANDROID_BUILD_TOP/packages/apps/CMBugReport/
git checkout b23a2ac7ae5fee5a575740b99d88902bace7a8e1

cd $ANDROID_BUILD_TOP/packages/apps/CMFileManager/
git checkout ff821d4c83971a868d2fb3582a14e35d014602e9

cd $ANDROID_BUILD_TOP/packages/apps/CMParts/
git checkout 2567b6169da612cb65a5ee364c30dfc38ede387b

cd $ANDROID_BUILD_TOP/packages/apps/Calendar/
git checkout e7899e8d7b3d9366959539b336fd8d787a4916b7
...
git checkout 7f56ce16a15f4ab145147c24db3209f8c5eaca1d
...
git checkout 3a48571552ddd08272920608d2a5922756de432a

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout 3894b40b1ba93f87a16ca7c12957e9a4db83cf67

cd $ANDROID_BUILD_TOP/packages/apps/DUI/
git checkout 7b2d81415297febc9be320fcd20360a3f24a6007
...
git checkout b2d42383f51c06d7f0bdcadf08022f8abcc65932

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout bb82223f7c4e7010f428cb1923f0c19784e20a38

cd $ANDROID_BUILD_TOP/packages/apps/Email/
git checkout bc8c771e66af2e394c3218608274065459e7b243
...
git checkout abf07eb23de4fcbca601dad02f19c517a7a30ef1

cd $ANDROID_BUILD_TOP/packages/apps/Gallery2/
git checkout e457e7e7523126e71df4c3767081967ed1500feb
...
git checkout 1cfcb29e2d55f19d14ef5c1ecd0e4fe50654c481
...
git checkout 8152fdcd84e5bc577d0391edadad097b9c947b40
...
git checkout f379f6f27a617f42ab769430e6592ecd30982f91
...
git checkout 5a38cbf0c8619b3b04c371c344b10ca28b922d75
...
git checkout 8e9a2874b3c63bcae9a76d9ad2ac57cfb2b53958
...
git checkout 2d684a761577b3d95306508d081f7373f11ccf56

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout 289e67784343233f191400252621df3af3fe7bd8
...
git checkout 70df46d1d4b6453aa7029c0b07b6689c2cc4af85
...
git checkout ed411640632a29525cbd3204c8d2ed4b54f8d8cf
...
git checkout 024599b2c3513c96a2ac3bd7a9643f9cb0346ee1
...
git checkout be55cf6755a7d526ae9326af5e3a843eb57977f7

cd $ANDROID_BUILD_TOP/packages/providers/DownloadProvider/
git checkout e346efc32053ea3a26eb656ffc22d4dc40313d29

cd $ANDROID_BUILD_TOP/packages/providers/MediaProvider/
git checkout ef3141116bd426eab499dde2088613b3bbb7c9e1
...
git checkout b857442b8421e8798e72015d301eff52931b0ef8
...
git checkout 9d998c15d42b387a9c06217aec276b3234ef5278
...
git checkout 51d6bb0a419f81c9f32679ce2c751247c3358f5a

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout 241eaf107f2530bfdff6c4bcc0b733b5f272b0ee

cd $ANDROID_BUILD_TOP/packages/services/ThemeManagerService/
git checkout 149b09d9827d545ff90b033f60dcd47207d71edf

cd $ANDROID_BUILD_TOP/packages/services/WeatherService/
git checkout dc3564accc5eb234bfe5c233272322cea40f61ec
...
git checkout effdc0f977eee64b6ab225735e2adb9e0fa82106
...
git checkout bce2976b211f5be5459985913aaf72bef8334886
...
git checkout 5c55995cc22fcff64b9032a18b9a0b736856da1c
...
git checkout 5d62d5230da5c0a52d12bce716dfb8c318cad614
...
git checkout edc1878d9e2bc911d642605010208b38d2765eff

cd $ANDROID_BUILD_TOP/vendor/motorola/
git checkout afdd23f378493edb4b31341d2901cd3e88e29cde
...
git checkout 5754c082176601a6b8fb2b2fd466776b0c182192

cd $ANDROID_BUILD_TOP/vendor/oppo/
git checkout 7afbe6938c76774205b58832cedec1c72bd34cbc
...
git checkout 39f7febdc8ee5f1bf4bc42b156a7c2732c1ab7c6

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 2a670c97390ddf56bc9c111b51a8a8e7ee202801

cd $ANDROID_BUILD_TOP/vendor/to/product/
git checkout a88f37611669d6380d037ab10bb9ac7befc85033
