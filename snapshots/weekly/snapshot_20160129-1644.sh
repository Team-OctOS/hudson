...
#
# Time of this snapshot: 20160129-1644
#
...
git checkout a6a4c8ae1775a9438df7612eca9ea935fc57c070

cd $ANDROID_BUILD_TOP/build/
git checkout ed80fd129681a22f9492ff7d9682d281699f9bdb
...
git checkout 03e59b85350731652cc8cb5fcd230a4936d16306
...
git checkout 8a5ae1db76bf51e455facce0d8bba4533360fa9a
...
git checkout 96ce7211f13f978a837c4b35f43a15d6f11d7d73
...
git checkout 554bc677837d05f5052592044f77e4de78520a04

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout b7f1426c3c5def55f4ab171670961292de2eff1f
...
git checkout b56a2b2fc76d9d7e69012efb1c4d7321726a5707
...
git checkout ccc0be99ff62829005104d499847ad5c377dcec9
...
git checkout 79a9b15147870de4a19afc449ab237eb3211cc1b
...
git checkout d3699e437cf0dd3ceca9fa640dda4b691b772031
...
git checkout 6b99703cce6bd49c5f18bbab54871e6d4e14e064
...
git checkout 78fbdf961981a225e9822106b94a2e8461ed310d
...
git checkout 6430f1ee701935cf0febde8d144a05eaa17f523d
...
git checkout c1cee5b9fc0e4c7035b9c98993f719f7b65cb4c7

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout 64f99f83b63c0607e22cfe747ec00137c443fff9
...
git checkout 4ca90e6ba31d1c38896cc8b4f4cfb8b12b2076e5
...
git checkout 627ffdd2e198fb9904a363cd552437f91b31e609
...
git checkout 14c46164a9a5f6193c4749685291da29c1f08a60
...
git checkout 7f5fbb72ace65139fddf91131305cefe29a790f4
...
git checkout a809cc0da8a24580eac0882844258b532df8741e

cd $ANDROID_BUILD_TOP/packages/apps/Profiles/
git checkout 6064f03794fbf969e03b9b3eb44f14fe66bbf3fd
...
git checkout c358f261b2347a2548aa2de8291c9847b68c8fb4

cd $ANDROID_BUILD_TOP/packages/apps/Screencast/
git checkout 5447314c682fb1d8ae8762874a61ce36d43fa345

cd $ANDROID_BUILD_TOP/packages/apps/Settings/
git checkout 990a6c0c028313e05810c088e80a42d891b89384

cd $ANDROID_BUILD_TOP/packages/apps/SetupWizard/
git checkout 95246f2063cefa2438db90076e10b138c8cd3efc
...
git checkout 59f0f0bb1da96cc2e8a578cead88e06fe9afde1b

cd $ANDROID_BUILD_TOP/packages/apps/SoundRecorder/
git checkout 3fa2c83588ac284e2e2f0b169c49bab6c9cb6fb1
...
git checkout f61ae6022e9c659a6b9086b061a00b7fce51ed08
...
git checkout a989ded05c4986420dc7e0ab845e1ad4532c70bc
...
git checkout e04900efcf22a9ecf74995072d6faef5a7de9ffe
...
git checkout 0bc8edadecaaabf6d132cd87c263ccf15eba575a
...
git checkout d36882ec2ebeb588ee36d9deaff6f91dbe7fcc9d
...
git checkout 4f7086f363a8d40596069dc9d7883b03fb1c5ec5

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout 48e714fcdb2f4200ff316eb4283a71cfb3a226c1
...
git checkout a53892047d75611f973d9539ec7c19b0a913dc8c
...
git checkout 4e25c92d9c10229103b6d821d2dfbe252abf655a
...
git checkout b6772ad6fc0617af3ecad510216539e2daf810ce

cd $ANDROID_BUILD_TOP/vendor/motorola/
git checkout 31afe9c71b2fbd919274a011b893c0ab931c644a
...
git checkout 3432fe21170460032dae405bd1c2e39e499b6684

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout bd31c03312eae5f1056d354e73a656237cc241d5
