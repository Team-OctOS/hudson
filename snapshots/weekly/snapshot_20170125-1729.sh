...
#
# Time of this snapshot: 20170125-1729
#
...
git checkout 1b1d9b41291ca7a9dd0029d2af6ce419a16c2067
...
git checkout d22fd8f9e213e562156260cfbc8b6abdbba20670
...
git checkout 8945a888e5f5e79b810191f30435935e83668c5c
...
git checkout 39a4c102d91fce8d2bcb5a88de2e0182950d44d5
...
git checkout f3fb5b4efd4b519819cf3b013a608e6999af8fd2
...
git checkout 758f485752758bd6972e3185bd529d5a288a2896
...
git checkout 42fd8b969813e8516970ed11c7b3119a9d7743e6

cd $ANDROID_BUILD_TOP/hardware/qcom/audio-caf/msm8937/
git checkout af95d62fc9d9ce2457d62a6fa5f43d570615c742
...
git checkout b516be3595d4f05e9029f85a2b892877b01e67ac
...
git checkout 4cd47df9a6ef0510df9859ed6f8664528341b15e
...
git checkout 0618343775188b0410fe5debd519ce0952dcba1c
...
git checkout e428eea9310be897cfb1455a782affcfba222a88

cd $ANDROID_BUILD_TOP/kernel/oneplus/msm8996/
git checkout 9d884277e3dadd2d1a89ddb948f1a3cdac58474e
...
git checkout d51a0c0cfce7d0a9185d809a43abbfca501e4926
...
git checkout 086ffbd120d937fc021c816317070cdf9671a68a
...
git checkout 36ec67c220f4f3ec05b6fcf802f92044d866a9c4

cd $ANDROID_BUILD_TOP/packages/apps/Browser/
git checkout b565222578d8f2ce0b49b6170ce56213ad979c23
...
git checkout c68fac05925a9e78e86365c8df6fe21c6792c0dd

cd $ANDROID_BUILD_TOP/packages/apps/Calendar/
git checkout cdfc52962db782de8940d155b005a917055b023f
...
git checkout dd635111b57e221a5aaf48dc066e40a129fbf868
...
git checkout 592c2e3f2fc5c092c1dd6068a403d778c5a62b5a
...
git checkout f7abb24fa498047e264c658c378f7f6a16966e5f
...
git checkout f5b8d0f284f545dc57c59eb51841a06b7f779ed0
...
git checkout e0a3c03cf912c6b437dd2bf96f486b88c699fb9c
...
git checkout 2b6875722b3bec474ec389953c09ae0d3d202511
...
git checkout 8ec67401e658806ed8a27dd5519053a5d50ea335
...
git checkout 0245fca473a52df270bc7085718c18683363c097
...
git checkout 9874833aa9d2eda2addd5720e865201f7198691a
...
git checkout 6a1bd1386d4ef4024ed2ae674ea10034a0c73142
...
git checkout 945394dca8dbd5f1d8ef891e2e015799dafeb1b8

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 3360b64f86a2a346a4d2b52dc5a3883432f1034b
