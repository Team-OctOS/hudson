...
#
# Time of this snapshot: 20160729-1431
#
...
git checkout d1dfb8863f0f01164dcd474c1ba645a516b64d24
...
git checkout bdeb598af55b9a9bb5e3d6dd3cc3f36b3af9c5e6

cd $ANDROID_BUILD_TOP/device/qcom/common/
git checkout 9e40a0e0c47b38455d515df4900e24a547a6863f
...
git checkout 0d052564bc2096005b88a610f043c5c92845ecf4
...
git checkout 6e72600f9b053610abd8b18ae97d94edb63d5ed2
...
git checkout a4f870ec9be217690d83208380f93af9d58a5225
...
git checkout a92e467b07906ccc4d4a222d809d7a34b608f60e

cd $ANDROID_BUILD_TOP/device/samsung/qcom-common/
git checkout da0d9bbceb5d3fcdbfd61a2f58c271bdc7364a20

cd $ANDROID_BUILD_TOP/device/samsung/serrano-common/
git checkout 9e0571fb7bc071e64427f47c455c4b8833e5fd8f
...
git checkout 9b1cd8bcee19ab9fc1a0fe2e7b7c5ba88e3a698f
...
git checkout 908ba0035b1003aaa2acef9ee6392485f6c8055e
...
git checkout 4077e9611bf4948ecfb268f0e44b6e50106a12e0
...
git checkout 8cafa373aa14b21981627e0ba9ea96731254183d
...
git checkout c823234060dc35212310b191a95a9204aa3e921a
...
git checkout c2008ded18a1e470ad485553925af96d46455abb
...
git checkout bd19a479a0b1f56ef9ce34fc819daaac43827d71
...
git checkout 917be7c527353c0d1bdbd852429513fe4f59636e

cd $ANDROID_BUILD_TOP/kernel/samsung/msm8930-common/
git checkout 0cf5eb2c50ef9c54e8ecbd5dda7622e6bd0c88a0

cd $ANDROID_BUILD_TOP/kernel/samsung/smdk4412/
git checkout 98bce590f5d092d1436a80b43f6dbedd174cd9e0
...
git checkout 00f227676f3742f1e2b6d917bef033e8797c2d86
...
git checkout 18b192add67fb7186466eb894612daf6c5aa938a
...
git checkout f17d6eff0b78c9936f4d47caf58ccee2c6e1737d

cd $ANDROID_BUILD_TOP/packages/apps/Dialer/
git checkout 5848ab690426ff28356f480e81e574682e7c80c3

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout a6f204a76ba5336d2e651fcb608b79cc1826c64d
...
git checkout 34ad2775832409c7850e5405343eedf1582907b8
...
git checkout 19f931b341aee00525548ad5182cc9e8a353143c
...
git checkout 399acc13498b672765304a71926e3abc9d6772b2
...
git checkout d947141da235e5bb8314c5d664b51e503d1db872
...
git checkout 4123d86b8059d13c888702e58351469c5d176ecf
...
git checkout 3028097c54e80749fb450f0320a829101f7398f8
...
git checkout 5d1eb2c64a6ae6342e47b36ecca8e87fc28c7e1d
...
git checkout 3f5ea20cd704c3031956bebbf05f22753344a4ea
...
git checkout 46d0797c893385c7935d1b1060c9437debc1699e

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout e3f482c95f1430374affb75361d0b41ef2147024
