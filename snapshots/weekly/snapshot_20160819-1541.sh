...
#
# Time of this snapshot: 20160819-1541
#
...
git checkout a5a55ac57ca225b0818b87793c2a6100d2132346
...
git checkout 508db2b591e7e8345119799c0a76bfa380acf8e1

cd $ANDROID_BUILD_TOP/device/lge/bullhead/
git checkout 7e8e0434f05db5e0b0927a3ceabfa9946c2ef8ea
...
git checkout f65fcfb11a2ac18b30cfaa7ca5864d36dfc98dd4
...
git checkout 1121ad03de68492526f6caf42bba98c195f0891e
...
git checkout d48445de8685b52ce71500e1a10b862658241144
...
git checkout 19366f232fea31817be97e677decca37add02110

cd $ANDROID_BUILD_TOP/device/qcom/common/
git checkout 1a2515cb234de1eca1078eb32f34faa7baba0fee
...
git checkout 75e693a3e7f37ea3f2b61d85f91712df9b80039d
...
git checkout 5c8ef09d7215a4c87a4b0478981e43a8765af8f6
...
git checkout 6354bec2152329487f9511aa41c9f731f431def0

cd $ANDROID_BUILD_TOP/device/samsung/msm8930-common/
git checkout 472abee09c43e2357d54b2f5f74ae63594fa759e

cd $ANDROID_BUILD_TOP/device/samsung/msm8960-common/
git checkout 7c46a12857ace876cc2f36493d2002c016cca7e0

cd $ANDROID_BUILD_TOP/device/samsung/qcom-common/
git checkout cb1d6644c5d1369f55c1fc1cc6c2eaf77264acbe

cd $ANDROID_BUILD_TOP/device/samsung/serrano-common/
git checkout 6e1e9305fc172c42945a52cfea71c4008dfd8cdb
...
git checkout c6f5dbe7e259d8e9ce88770de3d8dfe9449e7d1a

cd $ANDROID_BUILD_TOP/device/xiaomi/cancro/
git checkout ccf5d66c32f47cd6b43fd18a8d5caf48b35a68d4
...
git checkout d8c8a353cecf77183b3f3d3e7561a3505dee2f64
...
git checkout 8d41a10e57903142b9daba6a31a47f101757130c

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout 3d28ed42d97c2750fce58f4419016e10f6e2f462
...
git checkout 60f8bdfb455f0c1ff61c32427cc7de0389517257
...
git checkout 36463a80fea73851fe4075b316eef0e2a71bf8a1
...
git checkout ec15025b00e200249af05813b9582eb8e6998e78
...
git checkout 087d27d965325e7c17ce1ed8d4ad8fd4e18c8264

cd $ANDROID_BUILD_TOP/hardware/qcom/audio-caf/msm8937/
git checkout bf8c1abdcc53b2ad7228eba42fbff798e81d7e24
...
git checkout f9e2a71f89be10076c5e60079ef938dac2c3a469
...
git checkout 5db70b13e1c2629f6d3d67dd07294db74ea25dfa

cd $ANDROID_BUILD_TOP/kernel/lge/bullhead/
git checkout 27be01d2414b1a4e9b9abfc65e1c58aa0158ac6d
...
git checkout 1070bba191db05064e7d38fd22a96c1ff5a080d3

cd $ANDROID_BUILD_TOP/kernel/lge/msm8992/
git checkout 2b46fca0dee9eaf92e2ab466a736e73675039a93
...
git checkout fb230e6eddb70a22c2c69812231beacfd6c7f07c
...
git checkout 6505bef5eb52fc012c722e48a601b51981437929

cd $ANDROID_BUILD_TOP/kernel/samsung/smdk4412/
git checkout 6112c4d4e3408cf2aea5a626a3e39ba3922094c5

cd $ANDROID_BUILD_TOP/kernel/xiaomi/armani/
git checkout 5c3cd55fb8e7ea4f5c80bd89108b65a18c48aea4

cd $ANDROID_BUILD_TOP/kernel/xiaomi/cancro/
git checkout 0fc301180d3619175beeae29fd8836726fa2e0b6
...
git checkout 1d776cb2469cfd2653fcde19a05c05243960b5ce
...
git checkout 21320841880408213e9797960c1378df16472d7a
...
git checkout f8fb93b68792e44e66e5cb133a21cbb5f92b7be4
...
git checkout b35b4591090c9f8b15ed6c37ba8287d7eb045eb2
...
git checkout a5730ba608653d92e17fc9cad7577bde6175fe9a

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout 60a394e091bea89416f8cb89047385df7da9f4d4

cd $ANDROID_BUILD_TOP/packages/apps/DeskClock/
git checkout 2412531d0549754f3939f5c1b4fd81cc031c4702

cd $ANDROID_BUILD_TOP/packages/apps/Dialer/
git checkout 7f23b877c669734c931811a79083e51b2e40b98b

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout c7f1f86ff59b739af1193df837b0aadf7a2386ce
...
git checkout 1f5e945878e9a590c0f531ccb4cad28a167382a2
...
git checkout a0ee49710369c26506deff779e04456a2ba489e2

cd $ANDROID_BUILD_TOP/packages/apps/Gello/
git checkout 8fb25f4ee9292964aa7809922e6fb0db71a769d2
...
git checkout 26c26a92bb220255a4d6eb01226e959671127404
...
git checkout fa73ab0b8a27f28bbea1b182a3bb626da045ebbb
...
git checkout 6086e51e7e16f1c1f7d17fd0546cafa3957b0b8b
...
git checkout 273da8c0525babcbb8cdf95ee91e138a286a5ce5
...
git checkout f3ceccc33edb9d6a5eaec6f2118e8983dabf93fd
...
git checkout fff111eda9bd6d77700dd8d14fc45639a1aa22cb

cd $ANDROID_BUILD_TOP/packages/apps/Settings/
git checkout c34d40a4f04794fcbcb3778cd6d9d2d862514594

cd $ANDROID_BUILD_TOP/packages/apps/SetupWizard/
git checkout 8331602e949ad95758f126fcac82b64c1249a3c2
...
git checkout 1532d76ec2ba6a0e50e6520ed6f4b75cd06a68f3

cd $ANDROID_BUILD_TOP/packages/apps/SoundRecorder/
git checkout 946fee3dfa4fbd64496affc2abb1694a7cad947a

cd $ANDROID_BUILD_TOP/packages/apps/Stk/
git checkout fb7ad2e7dc992dbf3ecefc63eb75f877247b9837
...
git checkout dd53b04beaaf1ed076e82e0e20e5912e1745e16e
...
git checkout eaad1d76225275d37caff334f5d93320ba62243e

cd $ANDROID_BUILD_TOP/packages/providers/BookmarkProvider/
git checkout be42e5383594397ef0e61de5f35a7a2595211ad5
...
git checkout ba2ea007e22f9c67065c9ccd78da30fb0f491629

cd $ANDROID_BUILD_TOP/packages/providers/ContactsProvider/
git checkout 4346f8ec42e9f5589e701c7a841af9b936897d0c

cd $ANDROID_BUILD_TOP/packages/providers/DataUsageProvider/
git checkout 51d9963bc2856712d5eb90be613e71cc99bb0029
...
git checkout 876ce082028e581841b9eafe7a757c32b6f42a12
...
git checkout 490a17711f6d75f4535320561cc708ddd9373a58
...
git checkout 4f029e0f4792c011aed1befc916d3e9fe850b159

cd $ANDROID_BUILD_TOP/packages/services/LiveLockScreenService/
git checkout 09b857ee3a49164d97ce892abec7e6e36d57aa21
...
git checkout 7ee39a5817f2120f16876f0034bf01369f44eb8c

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout c533b1d0b368ac72ad4c6f842dba401a6777adad

cd $ANDROID_BUILD_TOP/packages/services/ThemeManagerService/
git checkout 93d9504d20e152cf4e443a3b406d5aa1f87389d9

cd $ANDROID_BUILD_TOP/packages/services/WeatherService/
git checkout 5f53cda1971e09c4554de4ca7e232cda8f9c8665
...
git checkout 929e773e6095423bb42a2d55be09a8c36da999b1
...
git checkout da7d2aa8fee84ca2100b7f6293c784b539687dd1
...
git checkout b3c522dfd8ec6c6ebf17655c3481dc544fbec479
...
git checkout d77f8527865ebbd94dcba79574d78f25579013f6
...
git checkout b1c6f7631f70b7f7811e60a2f3f37162e3eed093
...
git checkout b2daa2483362d976441573bac5bf273cd06bc4c8

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 5d5f6fa3afa8ffac4d7b8eae0a2833a5656dd020
...
git checkout bfc40209dc8360baa31b4bd3508f4c7b8a4e6add
