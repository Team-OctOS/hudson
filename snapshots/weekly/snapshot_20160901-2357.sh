...
#
# Time of this snapshot: 20160901-2357
#
...
git checkout 40d0d921e956983b96287d587370f98a5e828dbf

cd $ANDROID_BUILD_TOP/device/lge/bullhead/
git checkout cea4c2f11785594d128cbfd0d9b749e37c0130e7
...
git checkout b5b9b9673cf318436e8bf7290f9a3a3132715722
...
git checkout 9575e6d4f1990b574a200cab5159a693300743da
...
git checkout 02496d5c2b7c2b32adf2effd1793c91e058f9f4c
...
git checkout ccd7af43fdb7f9145fd26082a98ec15f8afb1821
...
git checkout bdb54da9baf8349a1f030064c3af4ff7318f4771

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout 84032694c97575e65142135e17c169fbce1012cd
...
git checkout c63251457ec8943136f5438181a0ef7ab4b85bf4

cd $ANDROID_BUILD_TOP/kernel/samsung/msm8930-common/
git checkout 9e24bd330ceafd6c811290dd70f79e4f254a4a03
...
git checkout 92303e46a97944ada696dc4039c674e590790cd0
...
git checkout 423fdcfac7bbde3005e1f0e7dda7ccae435fd66c
...
git checkout 27ae3fd8e842fff336d624a6d42daff29e6956f8
...
git checkout 4574b5096932d25b3740e665ed355ecf9ab7d7ef

cd $ANDROID_BUILD_TOP/packages/apps/Dialer/
git checkout af82bdc27ce1b9bffa611545cbd6b934e5bc4162

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout 99370db71ab3e7f393408652c259d9ad2387dabc
...
git checkout b6d3a52fcf9e0ef173fabc387c084224bfe7de9f

cd $ANDROID_BUILD_TOP/packages/apps/Gello/
git checkout 4b503632b671ae8b61d8804029166890411ca06c
...
git checkout c443847d26b1d5bd6438dcc93d45e1c0835d9a50
...
git checkout 3279dd0f42cb54d0482a050e499922851a379535
...
git checkout eb678864eb0496a89a2b2b9d810d487f1a984c89
...
git checkout ae7bee32401ba572738509e277fde61c763d77a1

cd $ANDROID_BUILD_TOP/packages/apps/Settings/
git checkout 6515c56c52432f0341cb046c0e3080ee24200946

cd $ANDROID_BUILD_TOP/packages/apps/SetupWizard/
git checkout bf4e5531ce7b1341b2f3ad01f3aab6373e130bf3
...
git checkout 530f84259813ec74150404b62c5bc1b97ff10d31

cd $ANDROID_BUILD_TOP/packages/apps/SoundRecorder/
git checkout 1e32a30fb88d4644cc0cbf545967fa9152af1d8d
...
git checkout bcd90a38b28f7c57bce8057d855e4c276aab2776
...
git checkout 031f13180b0de4a6a2bbcd90a84c138a5258d845
...
git checkout 380e910f2b98e19ea3e94f42518f34b45fa28fa4
...
git checkout 16b4c4d27f3ff0c53cb2501bbd77b4d7bcee6e45

cd $ANDROID_BUILD_TOP/packages/services/LiveLockScreenService/
git checkout 03e5e4d7412f024344e704e2a9a7bb0beffadb97
...
git checkout c14ac71372e395ec72ad40fd2faff4dcb765ec3e

cd $ANDROID_BUILD_TOP/packages/services/ThemeManagerService/
git checkout 9279a70bdfd5ee2c56245768df0829b91556dcec

cd $ANDROID_BUILD_TOP/packages/services/WeatherService/
git checkout 70fb1ac3cd64eafcef7e358bd393a4941abbdd8b
...
git checkout c00328f99aad5f1e8e879557f142981f08146fe3
...
git checkout d1dec9621987e7fafdd251071344b735cf380b35
...
git checkout f661cd5c954cbc61e56160779aa61e529a7166a8
...
git checkout e4042b964f78a7a02c8b9e30ba8f7e52c2a1b9af
...
git checkout 8a5f746a06d663c595fa192e4ee94a6f7a918722
