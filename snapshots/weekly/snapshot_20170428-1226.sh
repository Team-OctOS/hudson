...
#
# Time of this snapshot: 20170428-1226
#
...
git checkout 3442967571bacf5fee6631ebb4eb268b8b610696

cd $ANDROID_BUILD_TOP/bionic/
git checkout 8cb6a7f9ae4f28a135dde65fec2331d656614b5d

cd $ANDROID_BUILD_TOP/bootable/recovery/
git checkout 7e517463e3a11c1e9f7ae8a735dd6d80deba9ff2

cd $ANDROID_BUILD_TOP/build/
git checkout 97b51f05380c313f94a9fee819b7a3720b1e4b0f
...
git checkout 06a4ee58cafd9ccfd0e98cb3f002703a375fc9e5
...
git checkout 078c25fbc98130347381120620ce6eddbf552ccd
...
git checkout 7d63f75c9e121947b6863a02e399eae4628c8d64
...
git checkout 24a7ef290f40258233404685e3c084fde73e7b8b
...
git checkout 12d06b751a8b68523631491d1c27b1105b5dadcf

cd $ANDROID_BUILD_TOP/device/lenovo/a6000/
git checkout 4dd0fd21ff4b9fa8236373a60a3eea23bf060229

cd $ANDROID_BUILD_TOP/device/lge/bullhead/
git checkout be49969d8eb42e724adfea34f30f0d2b8419c819
...
git checkout 5bc4adc9c0eac9c3e20aa62ad88726b3fa30e9bc
...
git checkout 4bc249c5ae3f41040796096df39d5d9f34e4c830
...
git checkout 0ce7e9ac2cb0c4fd3b9ec2f52db797ed160d3dc0
...
git checkout 5e75ef39b173afd35f9f4ce8caebb486a766dd8b
...
git checkout 3c2fcfc13bd0671c8a20e202399ed131931e4e11
...
git checkout c4ef8dfcea06c8a83eb00edfa154da16bf1d895e
...
git checkout 7b75841770ad3b811f049b82e68c3a578c9c175b

cd $ANDROID_BUILD_TOP/device/samsung/msm8960-common/
git checkout bfc83ba7b2f2744165fa148fb0ca3558eecdb124
...
git checkout 0af6c4b13682e63d3fcf0eb4bcfd45b518909c86
...
git checkout 341e37ff7a69ff629dadc62fea2cf6e1e05b138f
...
git checkout 747aa4c8d6ba0dbba626efab6ea1975571db8f9a

cd $ANDROID_BUILD_TOP/device/xiaomi/mido/
git checkout fe9af265e8d3d3f827e15bca6f0bd575473596af

cd $ANDROID_BUILD_TOP/device/xiaomi/msm8996-common/
git checkout 50b949f2e38a37118e4ebeff98bbe730163930d7
...
git checkout 84b70172b97741049c4d31358fe2a90ef46f7611
...
git checkout 9e011993f49389de7cb7daf3baffb2b37d85717c
...
git checkout 6d524288a403ba2280db104fdbe227934c95b341
...
git checkout 3f250dd3159fed1590ae7154395bf79c5ef1c1a9
...
git checkout b7c0507c9db65a455244e965bd7044edb6820172
...
git checkout 5d942744eff8899dbdfbf2117a54f2b8a87b181b
...
git checkout 6690f19b09a6bf47660a7d87b21860c5beaac8be
...
git checkout 4ca20f256ee4cd524df23a5b764ef441d5cbd8bc
...
git checkout 38460131570b5e60cb90271fdc5991438dd0a391
...
git checkout 4a9859015f3f8c9a875fd3ecabc870f93f518799

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout 76de6a964000c16df1664cb730be39c3a73b64ca
...
git checkout 50d3f3d1efef0842197674867d14c572c6182a6a
...
git checkout 372a36ec781e891ccc9c629029132717d7f63025
...
git checkout 41cd40d057f371a27ec61bfff6600253adc862d4
...
git checkout 6bace74de5374d4a78ab645868a508678e3651a0
...
git checkout 85ca03c5b5da546d451f6d9323877ad7c3d6f9a3
...
git checkout 09cce1b077fc0e5946f4ca2625d6bf48eeae1054
...
git checkout 51e71fd18eeedddbc2556302ddf2806b9c4295c0
...
git checkout 5e4fbe091dac9a8f07567f511f5ef50bef28addc
...
git checkout f011db4fc7b6d3e0db60fbbcd182047c95fd102d
...
git checkout 65a73810ac2fb25edc7688c42d558ca7cc45071e
...
git checkout a00c53a9605ac47d48438286f6f4b7d7d5b817a2

cd $ANDROID_BUILD_TOP/kernel/lge/g3/
git checkout a22c62275ff15bc3261a13f1adf6cad24c44d193

cd $ANDROID_BUILD_TOP/kernel/lge/hammerhead/
git checkout 4edc8cad06a95ec6e9ff90715679316c79ea4958
...
git checkout d1f9ee528048788e9d401a315c7673e10a0a288a

cd $ANDROID_BUILD_TOP/kernel/samsung/d2/
git checkout 5e38f60723f325151bcf453b8dc1624775914f8b
...
git checkout 006e82eabc4886cbf92c4d8a539177047a2614db
...
git checkout f567929733bd44ebb5225a29c55e715bb135b86d

cd $ANDROID_BUILD_TOP/packages/apps/Browser/
git checkout daa40d1183bbe56f539dcdb59da47a4a0e7cb7aa

cd $ANDROID_BUILD_TOP/packages/apps/CMBugReport/
git checkout 8a4fb413bd57ab6d5ac41b01db90380655a43c84

cd $ANDROID_BUILD_TOP/packages/apps/CMParts/
git checkout d495a3f7c48957daa1085e61590270c78b1cc6d3

cd $ANDROID_BUILD_TOP/packages/apps/Calendar/
git checkout cabf3f55a339f256bd3fa975b8d544173e097885

cd $ANDROID_BUILD_TOP/packages/apps/Camera2/
git checkout 19537ec3e81bfddc6b8bc38f748eb605632912f9
...
git checkout c5318ec43b9d524b0a09a62640dda0bf498fbd79
...
git checkout fd232e7d2962888efbcb34456c5c972c376288af

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout 1346aa3d8ff8b106a4c24cca70f34a169c498d81

cd $ANDROID_BUILD_TOP/packages/apps/CustomTiles/
git checkout 74c69435b44db17bfed9ce0a96ad37e702d25a1c
...
git checkout 9e20cdf3041084b59318ff5e8e1d071b2862dc27

cd $ANDROID_BUILD_TOP/packages/apps/Dialer/
git checkout 6098b33c13d6f0ca1167e652818abe0ec4a666fa

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout f4cab90ff7f92e66a73959b5779d7801b5410d87

cd $ANDROID_BUILD_TOP/packages/apps/Email/
git checkout 7c7d90c33f5e5677a1f649f4b6b2bce99325fd2a

cd $ANDROID_BUILD_TOP/packages/apps/EmergencyInfo/
git checkout 985550ce5c84eea29e678992da1d05974e7c894a

cd $ANDROID_BUILD_TOP/packages/apps/ExactCalculator/
git checkout 5e5eb20dcd7e959b8a035c07daa5b05e2fc5241c
...
git checkout f0d11a0508b76431a53062135bfbdcf9e643b5b5

cd $ANDROID_BUILD_TOP/packages/apps/FlipFlap/
git checkout 52090f51a2e84848bff78f5f40952328db5705dd

cd $ANDROID_BUILD_TOP/packages/apps/Gallery2/
git checkout 1f0ec6ea1a8004113280bbca99fd6f2c7e8380c9
...
git checkout e4680795e528da30a7e176f1144aa705cd5a186a
...
git checkout 552041ba4adb8deb251d9d8ce3741e6b822c5c6c

cd $ANDROID_BUILD_TOP/packages/apps/ManagedProvisioning/
git checkout 76743b7f5d3e4d11d68db717800810b0fcf66919

cd $ANDROID_BUILD_TOP/packages/apps/Messaging/
git checkout 698b0017a2fcf4c0a6e5eccad122a823f1484336
...
git checkout 2706acdc3e7c1149065abd56d9f7fef46446b18d

cd $ANDROID_BUILD_TOP/packages/apps/PhoneCommon/
git checkout e5f66597b13fb088c86d25860b7961cc0e07d924
...
git checkout 9ab032674a242df536206c36fa2a012ef0612017
...
git checkout b1e69eab9ed8fc39da2ab4dd19a5ecf58143c5fd

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout 58fa0bd2f88e2f01c0916c36c725e89c7533ddf0

cd $ANDROID_BUILD_TOP/packages/apps/Stk/
git checkout 726621f673d41b5c6be9d7601f24bd703ecaef7e
...
git checkout 7f08e5e47d9d40601c3e8ceddddf3d02bd9a4472
...
git checkout 3fa04c4f76f09798f691da4d9b4aed19be7b24da

cd $ANDROID_BUILD_TOP/packages/apps/ThemeInterfacer/
git checkout 9936dc3d5a564ba9d2cf82e96fe81119a3987890

cd $ANDROID_BUILD_TOP/packages/apps/TvSettings/
git checkout 86a50559a8e2b3fe647d1fc9fb3b105e9afc8ddd

cd $ANDROID_BUILD_TOP/packages/apps/UnifiedEmail/
git checkout fdb59c7399b112655a575595f4416d40a976e26e
...
git checkout ac25229b9adc164d7abefa1cf12a862923c9469c
...
git checkout 187ce37f500e6b783f6a4a78808f69aa6442913a

cd $ANDROID_BUILD_TOP/packages/resources/devicesettings/
git checkout dccf644aa786bdcd16bf11ab463abe2e3d657b62
...
git checkout 5d6b6ee89f44109b5dcf049e3db79a4e6be06fb5
...
git checkout 79ddc5ebdd5b70159acebd3d1f9c3fe40a6cc7c9

cd $ANDROID_BUILD_TOP/packages/services/Telecomm/
git checkout 99aef234bb5f1f81016121a0ef78193718bcf1ba

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout 9f8ec48bd2bc75dff9af1591fddd0d4048fdb6a2
...
git checkout d17396c201e58e20a883d80303fae100b90a98c1
...
git checkout 3faf3a85b3dd64312e14bac0f5261eee5236c184

cd $ANDROID_BUILD_TOP/system/extras/
git checkout b5332dfb0209553847a77fb9cc621f4f1392cbc3
...
git checkout bfd6d4a94ed145482880c3f61bece014cab39b8d
...
git checkout 3a1ef527831085eab111cc98bdecdc30e90e2724
...
git checkout 73286b827528a6b4438ee6145701e4762df42e8e
...
git checkout 04e0aece42f95ac32aedf21ebef8e5040e238583
...
git checkout 125dd919aaefb2b7ec7ad588b36d457c86915a93

cd $ANDROID_BUILD_TOP/vendor/cmsdk/samples/weatherproviderservice/YahooWeatherProvider/
git checkout d0d6665e77e91e981d66a00951f32429299011c9
...
git checkout 00558372c2aab87ef9f168ff6eb1790fd71d7033

cd $ANDROID_BUILD_TOP/vendor/leeco/
git checkout 639c2ea956bae15d14f2f4aa719034454ebd4bcf

cd $ANDROID_BUILD_TOP/vendor/lenovo/
git checkout 35a4a9e0d5b7f898df35bbd5cdaa884232f2866f

cd $ANDROID_BUILD_TOP/vendor/lge/
git checkout 8d210058b2f6711d179eb80b3133bd3577ee58ea

cd $ANDROID_BUILD_TOP/vendor/motorola/
git checkout 108aa97303c45b0b4360cf98760d87437a5f9296
...
git checkout 75652ecac9e2e7d6f033b7837e5c19d7d74e7e6f

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 69077311fd499e542f4f2c499a52903f5b67ee27

cd $ANDROID_BUILD_TOP/vendor/to/product/
git checkout 3454be6dffcc8fd0ef76af5e3bed5aaf2b4033c9

cd $ANDROID_BUILD_TOP/vendor/xiaomi/
git checkout a23b93127381d481d2a025c990716a81224c400d

cd $ANDROID_BUILD_TOP/vendor/yu/
git checkout f6b4c225a680657ca1e324bd4a7f921f2ae32a42
