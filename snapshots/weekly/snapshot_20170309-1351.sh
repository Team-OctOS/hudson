...
#
# Time of this snapshot: 20170309-1351
#
...
git checkout ffa949654be6e29f54ff5c2d783f5d53d6deb1df
...
git checkout c33675aa2c557a8cd022ca6ef1d9d6a71ab6f78b
...
git checkout 38b7c68ddddb7451a89b5b9e2edb620bf5b18db9
...
git checkout 407d4b1fd665b44854c00cb28783206971895ccb
...
git checkout c172656231430efe96f2ca12576d737bb2da2b4c
...
git checkout c96a54cfba827f8cd097e0c4929888bc02262e9a
...
git checkout 71a8e2f763e3c3a73ecf20a60fc1804281f921e6

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout f9e72df1559c1838267bbd97898c865f5fa7089e
...
git checkout 6a3e585e5832981692e40785ac6e25d563e7298f
...
git checkout acd2816d9e30c88e5679d8a45efa73f59554e2c1
...
git checkout 2c744acb067a6b7036232fbb2939fffa46ee54aa
...
git checkout fbc3a7b69a9c163254adc9e95e3ac9a7fac3f97a
...
git checkout 3c99507fb6b3af18cb24ae83997b690836d971ab
...
git checkout 499427b076548d13f3f46da5fc8c48921f51f582

cd $ANDROID_BUILD_TOP/kernel/lge/hammerhead/
git checkout b9a331c05b07b15902fe7c94d31a30438c55bf81
...
git checkout f7bd50e4c5e549fa100654dfedc085ea933646a5
...
git checkout 26c61aa0d2be27166aa334624a551e0cd2ac0205
...
git checkout 4c89dd1873a3d6e44c1fa81927643ea483122b5d

cd $ANDROID_BUILD_TOP/packages/apps/Browser/
git checkout 5b406e57fdd353adee4f45854b71550db56bc79c
...
git checkout 4ffbbe299b7fd73bdec982b067ffff7d574314f3

cd $ANDROID_BUILD_TOP/packages/apps/Calendar/
git checkout 1602c070e095ffdcf6bdc1272234392638949f83

cd $ANDROID_BUILD_TOP/packages/apps/Camera2/
git checkout 479d2935f6c3750d380cbb43003e33872a7c3d5e
...
git checkout c5515d22097c4bd0bc2a54608c84e83b90742493

cd $ANDROID_BUILD_TOP/packages/apps/CertInstaller/
git checkout 938f77db8aea1e2ad9023061708f023a95051d17

cd $ANDROID_BUILD_TOP/packages/apps/Contacts/
git checkout c39dfa534f55cbc869e223b2846d6e1968000091

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout 1288aea4091aa008cfc9d8c90aeca293a61d5bb3
...
git checkout 92a9eaaebf9d9827af5c35ae010a19dc0012d341

cd $ANDROID_BUILD_TOP/packages/apps/Dialer/
git checkout 38dc40af1facaf577e606fe5e136085142b29df6

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout 44f4f1e3accdfa9d0b0cc68f588d30bcda8510a0

cd $ANDROID_BUILD_TOP/packages/apps/Email/
git checkout 12eb636a656ccddb1602b8df9e849740d568e06b
...
git checkout fe8750cac4b6c2c18eace6dbe475e5c3a9f82b37
...
git checkout c59cab4dd81eb068bfb9174ea7c7b6ab3d145b61

cd $ANDROID_BUILD_TOP/packages/apps/Gallery2/
git checkout 841426662076da1cc6321fe71d0435d035cbfad0
...
git checkout 536dda9194791c7b50132666314ab2d37faf8e71

cd $ANDROID_BUILD_TOP/packages/apps/ManagedProvisioning/
git checkout 39d4bceb7478aa8b98e841c5189611b9db2aa18e

cd $ANDROID_BUILD_TOP/packages/apps/Messaging/
git checkout b5eade12c2664fc3536a65d2c3370c1d5322a8ff

cd $ANDROID_BUILD_TOP/packages/apps/Nfc/
git checkout e2790c8513d7b764c0dbfc9b646792cca5efddf0
...
git checkout a9cb1106b10121c7c51baa742b235d4224671a8c

cd $ANDROID_BUILD_TOP/packages/apps/PhoneCommon/
git checkout 77d8a3ec72ffd1b9b63ed55c157ff70b4896b48b
...
git checkout f5d35df2c56081c54e7d9119c312c20a97c2c305
...
git checkout 91d26a8a3f3533bef611660d963cd0ab33e8e7b5

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout 50b1a98e07062b432bfe58a7fab28427b454cd51

cd $ANDROID_BUILD_TOP/packages/apps/Stk/
git checkout 519080698adb55786264903ef8396b0be1f05b9c
...
git checkout 4adb045f8b4a366cea65b3b06f13e315ebf09d78
...
git checkout c8c264bfbbff80139d61b0b64d714cb114b8783f
...
git checkout 60d10081bd6faac0a4908aefbddbc4a2741f2fa3

cd $ANDROID_BUILD_TOP/packages/apps/UnifiedEmail/
git checkout 054b31cb74dcf21c6eb924709ded0136fc91f78e
...
git checkout 8a5417a0427846f8164aaa842871737dc3a367fb
...
git checkout 7b08a35d0a5160aa8138cddff253f571017e69c8

cd $ANDROID_BUILD_TOP/packages/providers/MediaProvider/
git checkout 262a1de687324fe0077094787df9b31386c9d35c
...
git checkout e683619cd2ef2bef13d8f96f92f25d344d47ded0
...
git checkout 5b6bf0def9b8f68556a0a3f8d43f06151fdbef2e

cd $ANDROID_BUILD_TOP/packages/resources/devicesettings/
git checkout d928045a323b912d69ad00faa3fa0d7aefa134c4

cd $ANDROID_BUILD_TOP/packages/screensavers/Basic/
git checkout fa7caf55cae4bc1986c06c12cc5eba6a078ea907
...
git checkout 6b1eac4a01b8fb25528408ca97b2d61bbd9c4c9c

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout 42031f7736cdd8f92b3e4d34265cc8043427b0ab
...
git checkout 546b021450c45384d3cf55a2cf07fc916fc2a8bc
...
git checkout 7bb810fa0836b0b04a9b100918e461cbbc6ecd9c
...
git checkout 6d79538bfa18358007065407964d882349c4be4a
...
git checkout fa13abfcc50bd2b33ab33f61f28497cfed01d1c4

cd $ANDROID_BUILD_TOP/vendor/cmsdk/samples/weatherproviderservice/YahooWeatherProvider/
git checkout 4d3a56b1f1e0e4d952bb3d5ae01aca020022f29f
...
git checkout 87137c9dc75e8ffb2ba48524778bac148f77b8c9
...
git checkout 4310579703c934222a0d54eaa79ac943950f0195
