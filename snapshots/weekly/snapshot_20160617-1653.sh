...
#
# Time of this snapshot: 20160617-1653
#
...
git checkout 7c8d0282ea96b992fe703a000443dbc02650e902

cd $ANDROID_BUILD_TOP/device/qcom/common/
git checkout 96e5ea40f512936a32a72690870eaa9b5b1d0123
...
git checkout ef92d2db68b4bd90ec03a4e1533f8ad6b891148c
...
git checkout afc6bd83906e04b939a1ed8c35b31d02cd631c48
...
git checkout b673b06095d6fe43cc3223b4fac8cab6db945e0a

cd $ANDROID_BUILD_TOP/device/xiaomi/cancro/
git checkout 641ba4a72bddd7a0161158b1d45017b0bd012bf5
...
git checkout 4f5b16294746824a856d1eef82f033ffbac24dce
...
git checkout c70d78ad1034820fdce66bb4759bf8a109298413
...
git checkout b1243a0fe9e0341cf0079a14b57e0c62c7b4cd41
...
git checkout bf210cc504e3f4eabd466583ce0b4dcdd1a2db4c

cd $ANDROID_BUILD_TOP/kernel/samsung/smdk4412/
git checkout df78ca6d63311df32fcb6594d4ddebee953919f7

cd $ANDROID_BUILD_TOP/kernel/xiaomi/armani/
git checkout bae6db12f67b5cc95c7b1c0247d428cc52e507f4
...
git checkout 1d6b13d0f74099b8f98d69e54a6d3973b9b8cb68
...
git checkout acfd7c325e23dfae2fab7006dc8f620f1401ea93
...
git checkout 1477e7055a7b8e9ab3b01a34285d38f389002611
...
git checkout d7cc36fbdbddb1f737c2d43d7fc7500135ff906c
...
git checkout 6877820d0118e844f483c1ca9fedf4536d938ad1
...
git checkout c7125487c1bd7ab684a12ac140e04285076d0550
...
git checkout 358c6adb6d6314d45aa8b7a955cd4246a6db8d21
...
git checkout 59574f3875747ebce0515bff9e0aa34c3725bc3b
...
git checkout c028bc5073ae524ac07132343579c9f67737fe0c
...
git checkout f2323e73ee828c61d267231438d033fb10b3dfde
...
git checkout 9f030e6860f40bea48c86d1d4cd7ae6120c1b930

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout ffac00966db6acaf9be05e3853975eb705a8630d
...
git checkout 5365992252898f1653a2977ae89702c992d4858f
...
git checkout 66878513c96ccb7169193d460bb4adb2ea1f2951
...
git checkout cb6b5d77ba151388584ba1291903c64d155373b3
...
git checkout b1a6aa9214c7066dc1b6b7787bce4936a67c653c
...
git checkout 1f94ed4907a6cfa646a58e5f619e84214939fdad
