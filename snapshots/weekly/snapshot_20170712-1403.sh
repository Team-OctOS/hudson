...
#
# Time of this snapshot: 20170712-1403
#
...
git checkout 93882495003b21954afe59db381ad42ff10cf949
...
git checkout 052379ed7ec965758b7c22e8c5f546993fd9633c
...
git checkout 76a56b717e9b0272e2d5a7ae3e09a3eff296b8d9
...
git checkout d7b8d133c62ba17584ae5beb8cd891713e3db724
...
git checkout 361375bdd43f6f1689ca8d9f80c9997a601a1d10
...
git checkout e1a911dd3377a9875dd418166d1ba7d0aa07f033
...
git checkout 4f189ee6c4b4c8e3f578b433104c191fbbabd1ef
...
git checkout ff86846e97f2d159cc98af80938246db0d53c39a
...
git checkout d5fa2a0df4252a67876dbcfbd8997bacf7b3c7a7
...
git checkout 0da521d856b9447c4d23077e111a803f6d9c1480
...
git checkout 8b7f2a9876344ef3c7fe9c45c96364ab12e00cc1
...
git checkout 9c1919a0272781195722e259f0ab26416376a007
...
git checkout 889876d93294d676d1b506d760c85ebd17fac9ff
...
git checkout df2012e4d1edec8eeb6d228098ba5467c188451d
...
git checkout 4273aee85e315708a4e4ede26f389eca73eca055
...
git checkout 6f7e21794376905d541daf3a0bad78b9234557f2
...
git checkout bd7c0d6d985457c02ecd110c79bf9f27ef05348f
...
git checkout 99c0a8b9d9435b9e18cf6a6f3d8beb198078ec75
...
git checkout e0810ea4e585759a0f258149d415c57b5dffbc43
...
git checkout fd08cb940a37a266700708580b1393a3cb3c0b3b
...
git checkout 2e009e8e1bbeafb23e7e29538e971392f1afc2b2
...
git checkout 37f067f61edfecf465552a69012ceb4a36ac7810
...
git checkout 17421d9b19ab1007db28e4001fcc39f7bcb1e69c
...
git checkout 8a9c801203f351ca1b67c573ce3a674d83199fbe
...
git checkout f2979e9ca3c429aa54f2c1279f8f990627a1ba02

cd $ANDROID_BUILD_TOP/vendor/motorola/
git checkout 186f3692d4e46d1d48c91640c19998933f3fc8f1
...
git checkout 4249ea8d15e896520033827e7ab5b6773e97915f
...
git checkout f826279fac135d93adf22c2faf9e5798540656c0

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 0de1584df3837301ee7a17240712145da2e44afc

cd $ANDROID_BUILD_TOP/vendor/to/product/
git checkout f37f515850bfa121a506559aa7d997ccffc7f275
...
git checkout fe6eeb1a465dadb0cd3eee1f79e70f72a79f0e75
