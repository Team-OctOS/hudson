...
#
# Time of this snapshot: 20160602-1146
#
...
git checkout a4642d38b2d191351ff0c619ccfa79d7d5d30eb3
...
git checkout 078c3f085e3e602b947deeaf640793fe6a4ba5e0
...
git checkout 43e5ee1d35c4a4338fa5453f3cc137829785dbbb
...
git checkout 7252a6a23007bcab174a81ec10f6611c90423a21
...
git checkout 04e2bfae05bf64388c40263b72331f5c5e275a8c
...
git checkout b8f2c701d2a4e7e30a5464b1009498527fa5c19c
...
git checkout 2d629d5177521c38b64db0e31316563f8306f717
...
git checkout 6500d428ce816ffa0ba099221a4987ad7bfcb4ab
...
git checkout a4f6084fbab3c9b64fc125e54d5df2cac3e1d495
...
git checkout 00bb29a9280b187626c61d15ca85f1b9618ab94f
...
git checkout bf638d091c788825dd34f0bc12d7682351ab8a9a

cd $ANDROID_BUILD_TOP/kernel/samsung/smdk4412/
git checkout 1b54924821bae6a41ae3c2ee6c7953b4270a8d53
...
git checkout 46f3e73bf956a26edfde5a15e7be1f33fbdf1366
...
git checkout 8a156bea7ed926c9f70e1c58f8d3fbfd7cceb966
...
git checkout 5e67b37a27a1c7fcc49e5b1aba3def3656754ae5
...
git checkout eb998df357e17e279cf0968431ef3f962f2d880b
...
git checkout 17df072087857ab12451f3ffa63caf5c06a149de

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout 3b240ec3be5b114dc2461833b80bfdda9cd74a7a
...
git checkout 61d4f8311d880d28bf4389ca92a050788f976dd3
...
git checkout 94aa05777a7537199f343b0bcd3a213924f7e9c9
...
git checkout 474aa4a1e722d8a96db4eb558386de8a79033e9a
...
git checkout fc8ea240f806aa9c16bc92056db3b158f1480755
...
git checkout 53661555c1e8292856dba67480c07eacebc704eb
...
git checkout 8a39ad1c9cde0e5fa23341cdd6a26c6b092cf110

cd $ANDROID_BUILD_TOP/packages/apps/Profiles/
git checkout 77051deca514b7eb045ee7be4328cdc5ce74e85f
...
git checkout 792608780e3dd7bb8ed4e7b3b2194dada21261ee

cd $ANDROID_BUILD_TOP/packages/apps/Settings/
git checkout 047c7a39b3b88faf5efbc7dbc24b69b7ac34f4aa
...
git checkout a3aea38963f1b47bdfc757d6bab08023c2837047

cd $ANDROID_BUILD_TOP/packages/apps/SoundRecorder/
git checkout dd0587239da8fd1afe2d9b1e3bbe063130059803
...
git checkout cd539460e2045931f089b66d10ed91d98ea375d9
...
git checkout e48baf22b2524191208db9f7df35d39d57c2c7dd
...
git checkout 38583d6c9f24aefe687320eb1a211b7413a84b31
...
git checkout e73a582b2bff4e26ce8e03afd40fe9cc43684627
...
git checkout 2a0279924b973308cb2a95cc92ab62b09b54cb3f
...
git checkout 0054bb5d49ac6c0923ac4ccebb3d5a61e1185a71
...
git checkout 5c7dfbc0f44d7566839d1facbd255980890f6001
...
git checkout b3b8bbb9233d46cded30bf41458e099087fa3eb6
...
git checkout d551f0f6bda572bbc05406d6d676242f4410e058
...
git checkout 62285efd6698f9fc26f6babb48db68f97e37df7c

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 9940338b4c2caac648028657be17f6a195cf71bd
