...
#
# Time of this snapshot: 20160122-1928
#
...
git checkout 0299788b7a974841aa3324a573fbf04f49a4f23c

cd $ANDROID_BUILD_TOP/bionic/
git checkout 51ad57b30d5cb808bca20e0a6d25139435069283

cd $ANDROID_BUILD_TOP/bootable/recovery/
git checkout cd60d87be3be8c284e9b8dd9b82da7ef8bcac96c

cd $ANDROID_BUILD_TOP/build/
git checkout 396636ec61cb4f8a87385367c9160f41b36ecd18

cd $ANDROID_BUILD_TOP/cts/
git checkout 3189f363d71a510c2cfe7fa94a39ce06f26e6e07
...
git checkout 8b1a9064c5b6ab2c7744316c70c0e14398bcc0e3
...
git checkout e62c71cc595c469158b485e0d4db2c060c3ebc16

cd $ANDROID_BUILD_TOP/device/lge/bullhead/
git checkout 6a613c5db836a7d6bbd591e9cd24b946e8360a22
...
git checkout 542ac971ebe9c8b9d93531f45ba0c5ee7e91345d
...
git checkout 3c6821002392b3b8c17129d76491e3fc436edbb4
...
git checkout 249a77ce13ddec347e54d99c9b16a0ec3812f5cb

cd $ANDROID_BUILD_TOP/device/samsung/qcom-common/
git checkout 82da0a1a58cba2e792df349b878d6fd7bf6b1c38
...
git checkout 24988a8942da9e734dfe996dd36e4b55d96f40b8
...
git checkout cb52bceb79a0739735353576885cfb034ba98c7d
...
git checkout 7d9ebd36aceddd6d1099d50e34de69f1413d5d0a
...
git checkout df1c503b9dac70cd9b1c433215eea7661b5925da

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout cf0d111039141c2d422f82416c0ed8ae9fa19a4a
...
git checkout 7c2be690f4949abc4d547627d8d856231e2fa4e7
...
git checkout 53cbe974863cee30372a098d7b873652e40a778b
...
git checkout 8942ed5118701013a490cea740be396e6c5a2387
...
git checkout a1ae079eb663ed7bc1d3c4b5ef07ce7dc81d66e1

cd $ANDROID_BUILD_TOP/hardware/intel/img/psb_headers/
git checkout 21817aa9fd851ea2555125c7f6e02c678ebf6e3b
...
git checkout 1c5250f63ad10cea19e6602365c4f288c766d30c
...
git checkout 14bd2314be6b10e74d91679437fdc4217f215934
...
git checkout 05673d3f440e8909b733771a530e6ee5b3b44040
...
git checkout 563759a6f237ee891aebc58cb0b22d83437651d6
...
git checkout f1b49f2495ff9b01883ecf6c703b4c06d13c8b4f

cd $ANDROID_BUILD_TOP/hardware/qcom/display-caf/msm8974/
git checkout f4051ae04fcf1c67ab81b4d8066c603f7432763e
...
git checkout 03e21e3b892bea58e699bca7552254c99a5b721d

cd $ANDROID_BUILD_TOP/hardware/qcom/fm/
git checkout 6e7eaa78b6fe52acf98b3e7b8152b79bf0156b72
...
git checkout de5e3c618df86154e236a53ba6e605d45460e310
...
git checkout 9ce39213f4e21a5b080a101245ec63893e3e3a14
...
git checkout 88148a8371acb88877bf1da78c292bfaffb8f066

cd $ANDROID_BUILD_TOP/kernel/huawei/angler/
git checkout 3a00398fd3b25ca1d20e4561fc4f8a416ae717d5

cd $ANDROID_BUILD_TOP/kernel/lge/bullhead/
git checkout e1b8c23518e2caeae4a1e66bb75290e79a7d053c
...
git checkout b9f0d6940336b8481e356930cd5f5a733c903811

cd $ANDROID_BUILD_TOP/packages/apps/BluetoothExt/
git checkout 9061adc25ed21e7842601251b9ee6ada1cdfb0c1
...
git checkout 5a019fc280a9c0cb8b5085293cf81e2908c192ab
...
git checkout 559573181f125718a929dfa40775ad35be2587e3

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout 60502a861a5fa7bc1f6ea7c4c8618ecfd310c18d
...
git checkout a1739cf58ca6685c9d198ed0f3361c144d48c105
...
git checkout 7107206931567ab1f60496549bc907dfabab24a2
...
git checkout 2b515af28c95443419ec721ff023b678600c75cc
...
git checkout 47f9c4b62a8a0d738422eef157370bceb61356b4

cd $ANDROID_BUILD_TOP/packages/apps/Profiles/
git checkout a53da5af185c68c56ea14011b2c07bd08307ef88
...
git checkout 25439bd41bad7d8f7dd07b0cdce3d0d8fa37250d

cd $ANDROID_BUILD_TOP/packages/apps/SetupWizard/
git checkout f8e4ab690f3961f2240601b0956c0e1931e6a8d0
...
git checkout bb800ac9bf961b9e53ec56a1a5ababf31b9d40a1

cd $ANDROID_BUILD_TOP/packages/apps/SoundRecorder/
git checkout 77e037cd0fd14f9124086194a840a496bf06894c
...
git checkout 1f10bf6cb5d959a03c746dabf9dfe312106a9ddf
...
git checkout 19981c2d94dca213919e1b4ef45caa42b66f79b6
...
git checkout 7593ae3e30f4cee5e88163798514d001eaf20616
...
git checkout da878690dee9a496530e14cc4e4700f9bcbf2e2b
...
git checkout 5756a992657acab8b3b990f1c3fd911f50f9f0e5
...
git checkout 271651a56d842efad68459065cb6ce5ab80e7252
...
git checkout 0b83525591e8fbc14790d4e36ed67f4332b1566a

cd $ANDROID_BUILD_TOP/packages/services/Telecomm/
git checkout 2ae26246606781034f2c7d886a424b4c10504fb3

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout f4ccdc155fa2929026de150e7666f9f1ed21ba35
...
git checkout 7aa9190f98d9dd4f84e5cb872aee388a21b9bf07
...
git checkout b2f946e4fff22604d638b24147534159d61b98af

cd $ANDROID_BUILD_TOP/system/core/
git checkout 09075954c83c01e41ec224d0e8a4a680c8d6b198
...
git checkout 30c6a385dad478a4bbee17907490df078039872e
...
git checkout be29aa23847e766e25246e00d5a134f2ab5a59d5
...
git checkout e87f457825186ea0eae202fc3779505131ecd05b

cd $ANDROID_BUILD_TOP/vendor/motorola/
git checkout d9753466b829de224dc253fd98f87e5b152e2a3d
...
git checkout f364c18de8ed69bbff8eb391b6a2cf1ba080b5f7
