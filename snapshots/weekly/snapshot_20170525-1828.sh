...
git checkout 3e60e0c6be927e097064bd1ab0bbaef1644d0628
...
git checkout b20733a05430e160d5b9fafa04479f77321b482e
...
git checkout 3ab99a15e15bedcb9e8947f52877cb8ef2022e14
...
git checkout 68e8f7d963e17bc9cdebb5f1f138a3a9a8155dc7
...
git checkout b1d4bcbaddfdb0337cfb55cbd3edb79f30380f27
...
git checkout c40c5cc17507d2d4735ebe02aa802787af95383f

cd $ANDROID_BUILD_TOP/kernel/asus/msm8916/
git checkout b2eac232661d305837d5937ddda8e243306c92a8
...
git checkout f0c5eaf46ea37f79f0d05e4cabcf974624a2ca7a
...
git checkout 11df62159d2a9061961d80870cad35fc90f84e2f
...
git checkout 2576e8b7e84300f6955f85f795dada0d1ab93ad8
...
git checkout 1dae34efb7d2399073ca371c953aafd2ed503849

cd $ANDROID_BUILD_TOP/kernel/moto/shamu/
git checkout d74374f8496090e6bc66e58eda28685cc7d31ff1
...
git checkout f57045e76d8efdb73ca10228954fe76a451588b6
...
git checkout 7935513f6267ff6a912c387e75161a7b10e50732
...
git checkout bdb852469366757976052037ad5549efcf7c063f

cd $ANDROID_BUILD_TOP/packages/apps/Calendar/
git checkout 57b015eba1b9b70cbe7a92be2a11db69c1c98df8

cd $ANDROID_BUILD_TOP/packages/apps/Camera2/
git checkout 206a9cd1116ff4e85eb34dfd6761ec331e3a528e
...
git checkout 45cead5fae08135f1586ec56436e907aa3f0d9d2
...
git checkout bbccecc72a9d95257b8313ae338db78e70c00d41

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout ffdc399c0665eb43bd9166162d21fe8f94537041

cd $ANDROID_BUILD_TOP/packages/apps/CustomTiles/
git checkout 0f02fb4d96641903e5842c28c9694435bf9a8c74
...
git checkout 89aae7601d0bc17bf5f6e89f5a0b919a184256ae

cd $ANDROID_BUILD_TOP/packages/apps/Dialer/
git checkout c915347d441fece81831f6c8d37b57dbf0df20f5
...
git checkout c0e5d54c041466ebc97b6279d717f8770dd36690
...
git checkout 5704c076556c043b19315df2c516bf3536428c45

cd $ANDROID_BUILD_TOP/packages/apps/FlipFlap/
git checkout 1d5c6207845833a67f61646f99623093983009c3

cd $ANDROID_BUILD_TOP/packages/apps/Gallery2/
git checkout 68f782bfdd33525567d10d5bc57134407f265e47
...
git checkout c23c01312850815697118794b4c4f1ea44854cf0
...
git checkout 5dcacf847012e10a39f3756595eb817103ddad5a
...
git checkout 85a167b9c2afa260671fd9064aaf3b2e5ffb7cb2
...
git checkout bd70ba5e3e9327a2f0b182d121c00c3f3348d439

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout 48e6c6d48e050255e49110cf49b549c3f2b406f2
...
git checkout dcc5072ace0e59d6e4d97acf4eb95e8352565338

cd $ANDROID_BUILD_TOP/packages/apps/UnifiedEmail/
git checkout 5462df5cde9b9fb0a60582715e11540faeb6af5f
...
git checkout bd3c549fbddb6ad3ea5bdde9d838d1fe86ad1258
...
git checkout 797975331409b6ca9b16df0eacf244c0f64d892e
...
git checkout 50473545908c3678aa1948bb5b77725c7024c48d
...
git checkout d275bf30979edddb1fbc376f76735b0ea6b98b04
...
git checkout a98b8094361fa1975aa577e592da550490d9c364
...
git checkout 7467be4755d4d8ad674ee701429014400d863f03

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 1a34725b802ba9f6420eb3fb0c9157fe2debb510
...
git checkout 49d0c083f93247e14254c84a0b3acbba8a5c3728
