...
#
# Time of this snapshot: 20161024-1704
#
...
git checkout 368bd2abab25c637a657d1fe4cef6b2222b29e82

cd $ANDROID_BUILD_TOP/build/
git checkout 96309a47f4b62a1911d393b1eeb3e4fa57c7569e

cd $ANDROID_BUILD_TOP/cts/
git checkout 025f27228dfcaf5981feec1ed1a4379ea458565f
...
git checkout 281582f350ce0f7eae9a11b52e6d380c9fd7fea0
...
git checkout a18a78290c25d2179caa9c9106fac8db82c99bc6

cd $ANDROID_BUILD_TOP/device/lge/bullhead/
git checkout 34cdcd17534e8e7c3cd5cc8dc18dac7d2471d2c0
...
git checkout 9fab82a8345ebf699fbc61caa1a8a044bb4e4687
...
git checkout 0b7ad6763aab22a66724dc93fd5fa86aab9be16f
...
git checkout 80ae88c94c8fc273b89c871b77d8f644fffa07b1

cd $ANDROID_BUILD_TOP/device/qcom/common/
git checkout d08df7b60be52867937fd02c92cbe6624a3c3ca7
...
git checkout 3c530a746be37ef4de22b3d8a62a30fb2218e3da
...
git checkout 5928ef9de9f94c417e50b32a45ed8c2cb3aa78df
...
git checkout 2f69c1d2d31e9cb011d0cabc482926930687b55b

cd $ANDROID_BUILD_TOP/device/samsung/msm8960-common/
git checkout e12723183f4d376558cb714558ca839c2f430c77
...
git checkout a9113a44a465887733168d2d4c360bc1ff7b2c97
...
git checkout 9f32b04b46cd63e39a8a13ed18398ef53f5ec474
...
git checkout 386ddfb52b66933dff2c8e35cfb32a2770801530
...
git checkout beba02073aedaf98ce6066f9c6fd166c653413b2
...
git checkout be255519f545b882abf564c9cd99d7b1e2703525
...
git checkout a858e84f1d84bae3d0767323a4d7ec7cd3d516f2
...
git checkout 130f76a5868449479de535f6485ddc571820515a
...
git checkout 22ab46526bb7175217c59e974ed8589b48c298df
...
git checkout 4d2a2d96ae259abf1310b1775ad6ff1498e581eb
...
git checkout cb1cdffd7dfae7db36ecd06ce058eba505fb1b9d

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout 7b2e6595081aa89aab89662e8a8141285bc014ca
...
git checkout b22bca465e55618a949d9cbdea665a1a3a831241
...
git checkout e9e7aedfb2b136b1576bd89d365704d5f76b8816
...
git checkout 6d0ad8dc728a02b83a41d7d1488eb5ec630fd2d4
...
git checkout 4d2257f7e2ee69a2f270cd8d2312370551c5a483
...
git checkout 2cd66eb4beb1e9cc397f9f129fc74f620205922d
...
git checkout f4fdc6ef828770406d939f21847e0c2a74806489
...
git checkout 65c89893ba772cc1bc0804365dd3efa16be58745
...
git checkout c2104657697740a9bee31dc03bf0c5134ff93e6c
...
git checkout 0681437b0a0eb33dc7c263f8e8f8a42c9dc40f2d
...
git checkout 669a494c05c283bf8b11be5b7523245b538b74a3

cd $ANDROID_BUILD_TOP/kernel/lge/g3/
git checkout 5996178d401a157fba2c1d763f968b5aafa1d6f9

cd $ANDROID_BUILD_TOP/kernel/lge/hammerhead/
git checkout 268a5f5254964f08de5b8e4f3a5c4bfb05bcda08

cd $ANDROID_BUILD_TOP/kernel/lge/msm8992/
git checkout ca200ef1e4ddffad2fce9b23b1871157aedd3ec1
...
git checkout 89e6f09c86b1eff42c4477a34775cf3642e733ca
...
git checkout f2fe24e1ad3254b8d792d4345f276c7526b0c41b

cd $ANDROID_BUILD_TOP/kernel/samsung/jf/
git checkout a78d1a04a0a000b3f9506f43507a650d70e15de5

cd $ANDROID_BUILD_TOP/kernel/samsung/msm8930-common/
git checkout 75d56bd8af63c547ab5922d00976749593224f97

cd $ANDROID_BUILD_TOP/kernel/samsung/smdk4412/
git checkout 9c988962c4d7ff230fbf83c601d8aaa5eaf0c990

cd $ANDROID_BUILD_TOP/kernel/xiaomi/armani/
git checkout 5920e31a6f3fd324290dacb151dd3d0b47b2f119

cd $ANDROID_BUILD_TOP/kernel/xiaomi/cancro/
git checkout aa2ad16d48be05cbe45831576bb7a290c85f9f11

cd $ANDROID_BUILD_TOP/libcore/
git checkout 436c54bf01a5f9168a5e91d241bc28f2256cd08c

cd $ANDROID_BUILD_TOP/libnativehelper/
git checkout b7a25286026b49f0f7d95b25f2d32c4f47f498ef

cd $ANDROID_BUILD_TOP/manifest/
git checkout 404f952488f1badc7bcfae5f7de55c0737b25b04
...
git checkout ca20d951d77b5cac96d0b04f51f70108cce7f21d

cd $ANDROID_BUILD_TOP/packages/apps/Bluetooth/
git checkout 0df71000e9edb685f6be00401f88d02cbb509cf2

cd $ANDROID_BUILD_TOP/packages/apps/BluetoothExt/
git checkout 865465dd36988f0f933d2a1935eac91e4c4448e6
...
git checkout d15bb87357d395ef64f2e31d377e25861f1230bf
...
git checkout 6fe76ed7ccfeff4dbed094172ca089ee2cb70581

cd $ANDROID_BUILD_TOP/packages/apps/CellBroadcastReceiver/
git checkout 60fd85ca6a06b9fdcc2ffcf120a692d90aa1d1ec
...
git checkout d7eedfae7950da592014939920e43789e5d6ad19

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout 7744f5ca537a1a1a12ebb5afeb2cd6c3b9fd4959

cd $ANDROID_BUILD_TOP/packages/apps/DeskClock/
git checkout 958482fbf6efa123fd4e1aa76946aacea4565c66

cd $ANDROID_BUILD_TOP/packages/apps/Dialer/
git checkout ba24a30348925078e75f138aae5dfa4d603d059e

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout f1daeeb7b9c7efe848d6859d3d17930e362c9048

cd $ANDROID_BUILD_TOP/packages/apps/Email/
git checkout a549245b2f1e6510c6a87a1f381437bae30ee51b
...
git checkout 6e58d26be1d420468f07ee62597469751aae2c5a
...
git checkout 2f766165a59dc730d264535b8dfa2db9818712d1

cd $ANDROID_BUILD_TOP/packages/apps/Gello/
git checkout 88555fa75ed8aa49ab5f438232872a2c3bf24fbf
...
git checkout 2f2c518cce8c1af9a46e7a0298a3ebd8ea893a78
...
git checkout 2674ad7724497782c96fba24d7d907525f59d8e8
...
git checkout 9599f79185426485723b597cf7091484b4932adc

cd $ANDROID_BUILD_TOP/packages/apps/ManagedProvisioning/
git checkout 5024c3561a2970964f755ae9306a1f33596ee38d

cd $ANDROID_BUILD_TOP/packages/apps/Messaging/
git checkout 7619c3c57f0e9cd41a26aa8170ecae05591ac466
...
git checkout dba33131a0d2f1d2cf6ab3f081ed07ec2198b0d4
...
git checkout 846011826a98c7f9093f5560e8d22a3290fe0504

cd $ANDROID_BUILD_TOP/packages/apps/Profiles/
git checkout 5385cd8c6f96f6e996ce259c375f73ac58890190
...
git checkout f10408ed0ff427680f24d21bc6f9e1d421104abc

cd $ANDROID_BUILD_TOP/packages/apps/Screencast/
git checkout f4f2ed60111382a6f7705e6a781a58bd2ecb8320

cd $ANDROID_BUILD_TOP/packages/apps/Settings/
git checkout 8a492d140fb79684ee774ea691749ba62afbf5d6

cd $ANDROID_BUILD_TOP/packages/apps/SetupWizard/
git checkout cca206faa1a057cbb75e1648339091d9ea81ff21
...
git checkout c84f5b63e94d8abbd8d61427bccb389be1a404cb

cd $ANDROID_BUILD_TOP/packages/apps/SoundRecorder/
git checkout 4c55ff0c752c34db53bbeff36e22c67efe0374bb

cd $ANDROID_BUILD_TOP/packages/apps/Stk/
git checkout 94041302a54827aba890f70a0c7cd4e246439bb2
...
git checkout 56b2153bb8e407d4b1b54fd6eefcc88245838500
...
git checkout d11a843729f03fbabb8911bc599ad03a59982c2b
...
git checkout 38756c83b237457db55d04472acd7a0330af89cc
...
git checkout 183a77036d5890f8aca3b7849c92a294dc3dbb95

cd $ANDROID_BUILD_TOP/packages/providers/DataUsageProvider/
git checkout ffd3c508f66a1ff76d0e4b9eb4882a6b1de47227

cd $ANDROID_BUILD_TOP/packages/providers/DownloadProvider/
git checkout b25fddceb712fc26f7b2eb67ef34e73935cc1182

cd $ANDROID_BUILD_TOP/packages/providers/MediaProvider/
git checkout 468cce61635cbcc1cdbe920948557cb8b75175ab
...
git checkout c3d8153bec08a97c9e0983e28d593de67e657672

cd $ANDROID_BUILD_TOP/packages/providers/ThemesProvider/
git checkout 6abe369faa49d1e219d2c0456428be9d73d8442c
...
git checkout 34d9c3e993ea4a7dc60189ef6822118a71707c77

cd $ANDROID_BUILD_TOP/packages/screensavers/Basic/
git checkout de1b4b4e556824f427dec51670d1d3925918b1be

cd $ANDROID_BUILD_TOP/packages/screensavers/PhotoTable/
git checkout fc5761b6e8ee2cdf6535fc5307f03900282e1968
...
git checkout aa1ccf09d64d52ffc3dd83ec93f1001758bda9e6

cd $ANDROID_BUILD_TOP/packages/services/LiveLockScreenService/
git checkout 40301ec5974c1fddeef1af964c8d9f8ed7ffad5b

cd $ANDROID_BUILD_TOP/packages/services/Mms/
git checkout 477457f40fa5d4938c182ca938f02229529280dc

cd $ANDROID_BUILD_TOP/packages/services/Telecomm/
git checkout 812605dcc76c1ab2855a1515d19d51ad33048a6a

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout a4fc5ba0bc0093df18132fc3cd9152f5c90bb705

cd $ANDROID_BUILD_TOP/packages/services/ThemeManagerService/
git checkout 7b296c5f08ec5aad18384e9def2295abcada49fd

cd $ANDROID_BUILD_TOP/packages/services/WeatherService/
git checkout 8859ec368e71cbd431ba84ef227e720f8f4da0e4
...
git checkout 7e1cf25bc3f0b5af9106bc09989d63e5c8c46c37
...
git checkout 69c4724d5c9f0335258d9219fe1bb285f887495d
...
git checkout 1ad30d2d6ba40a44f23d083def7d23aa96364b33
...
git checkout 956bdc56a099f6d09755526e0b4530d55a099c0c
...
git checkout ef0212e67f61cd34fc0e9fb1f55b7c3c560d181d
...
git checkout 15b8c339b7518d31837f4dc982ce1788db4a9369
...
git checkout 26959e233bba83850357ebe53b9c59380b874fd3

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 085d2e97ce051ff38997b2d6b9139c3393c7003d
