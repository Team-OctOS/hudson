...
#
# Time of this snapshot: 20170825-0259
#
...
git checkout 752aaf664ab079f4ce9cbdeae6978f615d39b783
...
git checkout 08fec7dbe16e792c7bb90142c24957f2ddae357c
...
git checkout e772579ee0357c44e2d6619264e7c6ddb4298129
...
git checkout d6a63d25372b5c2c6d70b52ce0c3b57d4e58c136
...
git checkout c6318194add6ad99a8feaaf11982711bf4c6381a
...
git checkout 3bba249693aba7cc5c91bfa640e05ac11d296c65
...
git checkout 43b0658611c1e027afbb8c1ed71fb2a54dd05507
...
git checkout 2b7a3aaf158c69953ee3f2387ca4c46bd0e2b940

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout e6c817ac7d70e655bebfc398874e725be56b6e02
...
git checkout 407a0c59ed021e1615be75798fd014cf8cd613ff
...
git checkout 5ef057d5a2fd029f0aabdec7389541c58d7057e1

cd $ANDROID_BUILD_TOP/hardware/cyanogen/
git checkout e2f8e45fc095877a95ab06859bf63dc575a15c04
...
git checkout d8290dde5638aca602d8316d55b0fb1b754f3c40

cd $ANDROID_BUILD_TOP/hardware/samsung/
git checkout 231dc651ab1ca082ba6d63559d79ae748b02eb1f
...
git checkout 04d1557af1259b211609fa41adbe852b5f9cf2da
...
git checkout 8e0996e7b0c9456ea81807fd51b27a09bd93dc9e
...
git checkout 829e9582d048d04cd165d7d30bdfed89350a5d92
...
git checkout e0ca6248a67c18a0309a02db02eca523bec6cabf
...
git checkout 195a0a5bb99921b70dd0250ec6335857d2fa6570
...
git checkout 47773120dd7804d8d2ba1bb9826eab46ad0a768c
...
git checkout 6a398831ebd7957d477addca89859a73ca35e90e
...
git checkout 39c6ce29002e44e03a93263380dfcc82bb490b45
...
git checkout da1c14ca80552546dca7c9375f137da0acafc291
...
git checkout ea0ad382b642c8ed8a63b08f707446c2bf9cca6c
...
git checkout a9df077d9b96f2fdec661127a8046711879f7600
...
git checkout 436ce6ae688568bbc89f80bfd5a46eca83575f96
...
git checkout c3fd3fdcad75c117ac65393b6bb2520879d45694
...
git checkout c2f96c2f349f960a4ffacf68b355f82e9710202e
...
git checkout b6ba24fa3c89cd2e5adadc828818cba82003f7f5
...
git checkout 52d5c765efd6cc7afba5a07c584ee9f5523ea476
...
git checkout 5e51e1f3122a6101a6d5dbf35ccd6c8f5a67441e
...
git checkout e4867870667ce2562e200d4e3d0796aef0719662

cd $ANDROID_BUILD_TOP/packages/apps/Snap/
git checkout e6ab3158d302f062e590cbd94d8186fa8429c87e
...
git checkout 3f239593a4decdd1c86a445056b109b1f759e48b
...
git checkout 8a9f67da8881ff9400aa71669cdbf04777e6de46
...
git checkout 9620e096f38c3d9c14d847fd27899b8d26bb22df
...
git checkout 2303eaddcf79a535b7bf096b9c176be526287d85
...
git checkout 9c045bce7ba8c255c36d0a365758426ad5a0838c
...
git checkout 5d2909b9d6a8d8aa714fb7c36ce993b123676cfd

cd $ANDROID_BUILD_TOP/vendor/motorola/
git checkout 9b2c9962e6abec30265e9368cdb149a29c0c0380
...
git checkout 8fc0e74db48e4c4598ac549caa7520f5213042c1
...
git checkout db18113e8454941a7cad73335e628c9d9bc97353

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout a17ff9a1d73a15c71fb84b75e1da02f001295e9b

cd $ANDROID_BUILD_TOP/vendor/to/product/
git checkout 9c2e7e79d84b813c6fe2797ee18c06f160156fd9
