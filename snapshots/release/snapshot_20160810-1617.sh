...
#
# Time of this snapshot: 20160810-1617
#
...
git checkout a3d1023723d97a6b7214634934fc214160c86a24
...
git checkout ce61a18fbed695b26f62d2c367f5a72f3d6f48d4
...
git checkout 26c12d10d729e9062ff855b73568a0eb227097bc
...
git checkout b6d2e170952a1d1649d7616d3fec6d7d5160f234
...
git checkout 72c510ee384e9f9c4b99ef0933447bc6ce2e92e1
...
git checkout ef2b25dd183445b940d6eb643fc8ea1331de6f62

cd $ANDROID_BUILD_TOP/device/samsung/serrano-common/
git checkout 8fc0a0e313e8453e37ef88c5baa178a681e0524f
...
git checkout b4f817f1244273dc7e6fe47137492116851657e5
...
git checkout a08fd9e9b66b23ceb7f14aaba3150e2146393b37
...
git checkout 02f551b925095747bf71e954c9536b0b6d7c65d3
...
git checkout 3b418d69a3e1b3594aec4ad065a47353da407e12
...
git checkout 5549630411fae5d1a41086a94a989b73acd45d54

cd $ANDROID_BUILD_TOP/kernel/huawei/angler/
git checkout e4620781cbc090f41f23d2d21eccdad05da92e6d

cd $ANDROID_BUILD_TOP/kernel/lge/bullhead/
git checkout bedd2e800405d59d572fac9651e4e70109ae9a63
...
git checkout 4651cfa2a55d2c8f153685c526e13dceec584a6a
...
git checkout e3962a8d6f6009655236aa63750c51a8d1593d96
...
git checkout 6ff7fb4e3e93da7267e927325365fe7a6687891c

cd $ANDROID_BUILD_TOP/kernel/samsung/msm8930-common/
git checkout 7d86066ac860f5891a6fc61011ef09f5be911a03

cd $ANDROID_BUILD_TOP/kernel/samsung/smdk4412/
git checkout 9271694bc414bfacdc0854164b08d9686dc50b9b
...
git checkout 052e30a231201be113bc29668db9cbb53e03597f
...
git checkout 94bf2d904d8520752add1798f0d65690596aa6f1
...
git checkout b7fdfd544b5123ed273c6be91f4781b3162bde41
...
git checkout 6063f78de3ae6cee052dc7b9d035445140319a3d
...
git checkout 0505c81defd7dc66795797dbea63c57ffdd2dc43

cd $ANDROID_BUILD_TOP/packages/apps/Dialer/
git checkout 863163b81ae86ea40c2d6982c8205e1f31d72da0
...
git checkout 1772b9859ac6381ec3b67fe4c09ee6d2c2fe80d6
...
git checkout 84d9f8271c2d6d5a65944d3b499d5f87e3839090
...
git checkout 3f4edf9792c5d6eb2923e4bbcf513fadc11abb29
...
git checkout 4fa4ac293fd3899ae1df3a752b136d20c7100eec

cd $ANDROID_BUILD_TOP/packages/apps/SetupWizard/
git checkout 3dce293b18fcf9ce526169ef7711a71b37759b3f
...
git checkout c5ce73372e206614c28c0c46064ded0230cfd5ab
...
git checkout 8ce29f069f74a2862bded55e76b8286ad6c425b5
...
git checkout 7130db321167e3dc6e0a2bf99a844e6233dd649a

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout 8a5b2c2fddc66f43dcc897ef1f61830734fd79cd

cd $ANDROID_BUILD_TOP/packages/services/ThemeManagerService/
git checkout cdfcad645c9d2bdb135cdcd18666ede0eee55f82
...
git checkout e5978c5ac14e358285f08ccf02e1394db8ca875e
...
git checkout bf4d7a20a3045da25c5d193bdf5c4fc87301a688
...
git checkout 1df1cf3f39316f8641d7d7339e9994b2f4c78630
...
git checkout b3d182174ea3f4f8bb5da00cdf49a73025b6f555
